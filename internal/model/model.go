...
type JobRun struct {
	...
	// It is free text for the operator: nothing parses it (ADR-070).
	Detail string `json:"detail,omitempty"`
	// EntityType/EntityID name the single entity this run acted on (ADR-070),
