...
key: KEY-NNN                 # the tracker key; must match the branch key regex
status: todo                 # todo | in-progress | in-review | done | released (coarse; mirrors Jira)
