...
* **browse:** remember each index page's filters across visits (SP5) ([#378](https://github.com/whoiskevinrich/holodex/issues/378)) ([4609a16](https://github.com/whoiskevinrich/holodex/commit/4609a165abfe1e18852fa7eac80b3f1137e16a40))
* **completeness:** required-band score, extras overfill, ring badge on cards (F65) ([#350](https://github.com/whoiskevinrich/holodex/issues/350)) ([e7e765e](https://github.com/whoiskevinrich/holodex/commit/e7e765eca51e745a556eb4842247c26b1bea8de6))
* **completeness:** ring badge is a button — click refreshes the one entity like the sweep (F65.8) ([#373](https://github.com/whoiskevinrich/holodex/issues/373)) ([7f8c067](https://github.com/whoiskevinrich/holodex/commit/7f8c067879efaee81cdc505c7f3d8ad2ed00216f))
...
* **enrich:** candidate thumbnail box follows the entity kind — media backdrop, studio logo ([#352](https://github.com/whoiskevinrich/holodex/issues/352)) ([66280fc](https://github.com/whoiskevinrich/holodex/commit/66280fc406b4c579032a59c18f044e7f5a84eda4))
* **enrich:** candidate thumbnail in the resolve picker (F64) ([#346](https://github.com/whoiskevinrich/holodex/issues/346)) ([faccc69](https://github.com/whoiskevinrich/holodex/commit/faccc69461f79535548c7eefdb7147ccfe3975ad))
* **enrichment:** entity refresh sweep (F66) — ADR-103 + implementation ([#367](https://github.com/whoiskevinrich/holodex/issues/367)) ([a9815b1](https://github.com/whoiskevinrich/holodex/commit/a9815b1dda5158ef6038ce2c8f078e4330eac816))
* **enrichment:** entity refresh sweep (F66) — refresh all people / studios from System Activity ([#360](https://github.com/whoiskevinrich/holodex/issues/360)) ([6fe1cf9](https://github.com/whoiskevinrich/holodex/commit/6fe1cf96957560831c6160c10a16f4deea2db791))
* **enrichment:** media header pill derives from the provider match, not only the file tag ([#363](https://github.com/whoiskevinrich/holodex/issues/363)) ([726b1a7](https://github.com/whoiskevinrich/holodex/commit/726b1a75470b4cadb36d529ac3a6425689579296))
* **enrichment:** provider link badge coverage — templates, _source_url fallback, film + media (F63) ([#344](https://github.com/whoiskevinrich/holodex/issues/344)) ([1bc88c8](https://github.com/whoiskevinrich/holodex/commit/1bc88c804ebdd748fdcd52d80e7ae649513b093b))
* **enrich:** structured resolve hints — opt-in fields/filename/query_source, residue rule, searched[] caption ([1a1d63a](https://github.com/whoiskevinrich/holodex/commit/1a1d63a2a8794e2ab7521a0afd808427b4664729))
...
* **films:** entity Films row matches video-card height and lifts on hover ([#336](https://github.com/whoiskevinrich/holodex/issues/336)) ([bc86939](https://github.com/whoiskevinrich/holodex/commit/bc86939ff1a8c037659605880665f2b00d4695cf))
...
* **films:** refuse a portrait image for the film banner role (landscape guard) ([#338](https://github.com/whoiskevinrich/holodex/issues/338)) ([6a8b875](https://github.com/whoiskevinrich/holodex/commit/6a8b875c49a8f8d15f2e80e159166d489f2a07f8))
* **identity:** entity identity card — reference handle, unified external ids, films in the spine, edition, display name (F60) ([#332](https://github.com/whoiskevinrich/holodex/issues/332)) ([28e2540](https://github.com/whoiskevinrich/holodex/commit/28e2540d9068c6ea461bb8d0f7980038b573ccc4))
...
* **media:** collapse empty Films/People sections and move the scene number onto the poster ([#308](https://github.com/whoiskevinrich/holodex/issues/308)) ([f458762](https://github.com/whoiskevinrich/holodex/commit/f4587621475af7fc52debe68feed7f00a2c23366))
* **media:** denote the parts of a multi-file media with a part field ([#340](https://github.com/whoiskevinrich/holodex/issues/340)) ([5bc1020](https://github.com/whoiskevinrich/holodex/commit/5bc10206c55e9e23cff29c3714a9ab62c214d0d4))
...
* **media:** move the file block and shelves, give visitors the field values back ([#321](https://github.com/whoiskevinrich/holodex/issues/321)) ([4f49d29](https://github.com/whoiskevinrich/holodex/commit/4f49d29acae4bd508c3e53e27cdafad40e574e9a))
...
* **people:** person hover card — headshot, age, counts, aliases and links beside every person link (F68) ([#369](https://github.com/whoiskevinrich/holodex/issues/369)) ([1468d29](https://github.com/whoiskevinrich/holodex/commit/1468d2916d66280ac99794cc99fe4298eb3029e3))
...
* **playlists:** video playlists — container + membership, two producers, next-up on a persistent player (F69) ([#375](https://github.com/whoiskevinrich/holodex/issues/375)) ([ce36cbb](https://github.com/whoiskevinrich/holodex/commit/ce36cbbe3ce9c5b7929affd0dcaa5b8421f39cb0))
...
* **status:** dismiss handled failures from the Recent failures callout ([#354](https://github.com/whoiskevinrich/holodex/issues/354)) ([f8e7e8a](https://github.com/whoiskevinrich/holodex/commit/f8e7e8affa742ebeb4dcbbc757739fc21b85b2e3))
...
* **studios:** list rows draw the studio logo; halo behind studio/film images, no plate ([#370](https://github.com/whoiskevinrich/holodex/issues/370)) ([26f6101](https://github.com/whoiskevinrich/holodex/commit/26f61018f9c6fb9fbee855ad8855dd5315f9d0d3))
* **studios:** show the studio logo on the Film and Media detail pages ([#342](https://github.com/whoiskevinrich/holodex/issues/342)) ([530a2d9](https://github.com/whoiskevinrich/holodex/commit/530a2d9141264091bd247c93afaaa1f3b02418b3))
* **theming:** instance skin — owner-set skin, Appearance tab, custom palette (F67) ([#365](https://github.com/whoiskevinrich/holodex/issues/365)) ([5eebfdc](https://github.com/whoiskevinrich/holodex/commit/5eebfdc7368f4e56a714ee5e8596f466bfd70cae))
...
* **web:** page-scoped hotkeys — e refresh enrichment, f file writeback, ? sheet (F62) ([#343](https://github.com/whoiskevinrich/holodex/issues/343)) ([ce1daaf](https://github.com/whoiskevinrich/holodex/commit/ce1daafda5208fb698645fbe31152e9c2b157425))
...
* **writeback:** dialog becomes the cockpit — applied vs. on file with a per-row source chooser ([#359](https://github.com/whoiskevinrich/holodex/issues/359)) ([4495698](https://github.com/whoiskevinrich/holodex/commit/4495698265c45208cb204064b780733d78aaab7c))
* **writeback:** dialog shows every chooser — no undecided fold, no change toggle, wider on desktop ([#372](https://github.com/whoiskevinrich/holodex/issues/372)) ([bdb1f9c](https://github.com/whoiskevinrich/holodex/commit/bdb1f9c5faf5073d1d348f98fd6eec62ef06d6e5))
* **writeback:** poster row as an image-tile chooser + ledger-witnessed image sync ([#364](https://github.com/whoiskevinrich/holodex/issues/364)) ([87a9e99](https://github.com/whoiskevinrich/holodex/commit/87a9e99deabbdaf843235eb6b764fc03198982ef))
...
* **curation:** keep Save/Cancel on screen in the long-text source editor ([#355](https://github.com/whoiskevinrich/holodex/issues/355)) ([7952df3](https://github.com/whoiskevinrich/holodex/commit/7952df309695a73362e209bb07d9323671e3b3bb))
* **curation:** let a long field value wrap instead of widening the page ([#316](https://github.com/whoiskevinrich/holodex/issues/316)) ([8cebb82](https://github.com/whoiskevinrich/holodex/commit/8cebb829055e3224b953efc191044234ec7ddd12))
* **enrichment:** never auto-apply on "Re-match…" — always show the picker list ([#356](https://github.com/whoiskevinrich/holodex/issues/356)) ([8735dc6](https://github.com/whoiskevinrich/holodex/commit/8735dc60bb00ef623de2f03fca3df27cdb0d7076))
...
* **enrich:** tell the owner when a cleared provider's values still live in the file ([#326](https://github.com/whoiskevinrich/holodex/issues/326)) ([8ee06ec](https://github.com/whoiskevinrich/holodex/commit/8ee06eca5261bd2d8ee79be8721df0d0c07a928e))
* **entities:** studios/people toolbar wraps at narrow widths instead of overflowing the viewport ([#374](https://github.com/whoiskevinrich/holodex/issues/374)) ([45fd3e9](https://github.com/whoiskevinrich/holodex/commit/45fd3e91202d46a67460cf07cc3b09c847bc080a))
...
* **films:** allow editing a scene number after attach ([#306](https://github.com/whoiskevinrich/holodex/issues/306)) ([656c58c](https://github.com/whoiskevinrich/holodex/commit/656c58c3b7c1e1815f30045f8a1ec5f405c404ae))
...
* **films:** make Remove clear a provider-sourced banner/poster too ([#339](https://github.com/whoiskevinrich/holodex/issues/339)) ([fc192f2](https://github.com/whoiskevinrich/holodex/commit/fc192f2f339b799a5166faa3ea9861a3e61c847d))
...
* **films:** move the description into the rail, one rendering for owner and visitor ([#324](https://github.com/whoiskevinrich/holodex/issues/324)) ([2c3092c](https://github.com/whoiskevinrich/holodex/commit/2c3092c18a907df45635b38f5584146a20f86a6b))
* **films:** show film posters in the person/studio/tag Films row ([#335](https://github.com/whoiskevinrich/holodex/issues/335)) ([de9f9be](https://github.com/whoiskevinrich/holodex/commit/de9f9be83a8709bcf431ac8c58383e75fbc7ed4a))
* **geometry:** stop at the first refused connection instead of scoring a dead server ([#334](https://github.com/whoiskevinrich/holodex/issues/334)) ([5cec9b0](https://github.com/whoiskevinrich/holodex/commit/5cec9b02f8c906d0210662d2c327e60fcef3f1c9))
...
* **images:** keep transparency — PNG for non-opaque entity images instead of flattening to JPEG ([#341](https://github.com/whoiskevinrich/holodex/issues/341)) ([0ebf20e](https://github.com/whoiskevinrich/holodex/commit/0ebf20ef371e90abdf586e444c56e774f724ac00))
* **layout:** guard entity headings and the header against overflow ([#315](https://github.com/whoiskevinrich/holodex/issues/315)) ([029d14e](https://github.com/whoiskevinrich/holodex/commit/029d14e3c2b4abfef35189b63b9df18a383f0f9f))
* **layout:** guard stage-grid's single-column branch with minmax(0, 1fr) ([#314](https://github.com/whoiskevinrich/holodex/issues/314)) ([9f322f3](https://github.com/whoiskevinrich/holodex/commit/9f322f3c177b0417247b3bdfe01da8b34b31dd71))
* **media:** keep polling a pending writeback until it settles instead of giving up at 120 s ([#357](https://github.com/whoiskevinrich/holodex/issues/357)) ([413a397](https://github.com/whoiskevinrich/holodex/commit/413a3970d726e492c2eb19e2707db67d21433248))
* **media:** render the owner's Overview like the visitor's, pencil opens the source editor ([#322](https://github.com/whoiskevinrich/holodex/issues/322)) ([4cd89a0](https://github.com/whoiskevinrich/holodex/commit/4cd89a040b378b8aaf1453a5512812347ea964f5))
* **media:** settle the writeback poll on an HTTP-status refusal instead of stranding the badge ([#358](https://github.com/whoiskevinrich/holodex/issues/358)) ([d073c45](https://github.com/whoiskevinrich/holodex/commit/d073c45603cfc8faf752132e69248ff6eb737df7))
...
* **people:** hover card stays below when it fits neither side instead of clipping off the top ([#376](https://github.com/whoiskevinrich/holodex/issues/376)) ([33e6607](https://github.com/whoiskevinrich/holodex/commit/33e66076ee6cede77a33899f62d50f1381ca00d6))
* **people:** link embedded person tags on first import and always split comma-joined names ([#348](https://github.com/whoiskevinrich/holodex/issues/348)) ([bb3a54b](https://github.com/whoiskevinrich/holodex/commit/bb3a54bd152b0392bfcf534d26b13749b9fd717a))
* **people:** version the Cast grid poster URL so a replaced poster is not pinned by the immutable cache ([#353](https://github.com/whoiskevinrich/holodex/issues/353)) ([63f376a](https://github.com/whoiskevinrich/holodex/commit/63f376a6f1d8f313a40d3cb171aa7eb9febf928b))
...
* **resolver:** report in_sync as unknown when nothing reads the written tag back ([#310](https://github.com/whoiskevinrich/holodex/issues/310)) ([fa4667a](https://github.com/whoiskevinrich/holodex/commit/fa4667a522e4c21b96d30b5bf54b352166159671))
...
* **studios:** draw the studio logo bare on the page and drop the caption beside a wordmark ([#349](https://github.com/whoiskevinrich/holodex/issues/349)) ([70577fd](https://github.com/whoiskevinrich/holodex/commit/70577fdada88441869039c9fee7c1ba00c56f7bd))
...
* **ui:** hide the expand chevron when the text does not clamp ([#319](https://github.com/whoiskevinrich/holodex/issues/319)) ([64d1a89](https://github.com/whoiskevinrich/holodex/commit/64d1a89151a82635daba9c7e0ee68f8de6a09444))
* **ui:** put permanent delete behind a menu instead of beside Move to Trash ([#320](https://github.com/whoiskevinrich/holodex/issues/320)) ([5f8d3c3](https://github.com/whoiskevinrich/holodex/commit/5f8d3c3d687aacefec396e4fb584179860af5852))
...
* **writeback:** label PNG covers image/png and replace the existing cover on ffmpeg remux ([#351](https://github.com/whoiskevinrich/holodex/issues/351)) ([d275b0a](https://github.com/whoiskevinrich/holodex/commit/d275b0ae7f19cd461b4e582ee2af9d53127d9563))
...
* **writeback:** undecided provider tile never wrote; poster tiles no longer crop ([#371](https://github.com/whoiskevinrich/holodex/issues/371)) ([51120c2](https://github.com/whoiskevinrich/holodex/commit/51120c26edda752ac06f68e304ba9e710ef34b1b))
...
* **entity:** extract shared PosterTile chip for the Films and People rows ([#366](https://github.com/whoiskevinrich/holodex/issues/366)) ([1e41b0e](https://github.com/whoiskevinrich/holodex/commit/1e41b0e0bbbe8f84223d1471684003fdacfa791b))
...
* **design:** film banner landscape-guard handoff + entity aspect-ratio rule ([#337](https://github.com/whoiskevinrich/holodex/issues/337)) ([40d6071](https://github.com/whoiskevinrich/holodex/commit/40d607194d2f40b4a07c6f63958d4335b356b32f))
* **reference:** add the UI vocabulary ([#323](https://github.com/whoiskevinrich/holodex/issues/323)) ([95b1087](https://github.com/whoiskevinrich/holodex/commit/95b10876f803f327b51a3eae4114da6099e30398))
...
* **specs:** F61 candidates[].detail — revealable per-candidate record summary ([#333](https://github.com/whoiskevinrich/holodex/issues/333)) ([b834893](https://github.com/whoiskevinrich/holodex/commit/b834893b58e9204ccb62a43498bf6f821d5a10f8))
...
* **specs:** state the never-your-own-page rule on the website/homepage field rows ([#345](https://github.com/whoiskevinrich/holodex/issues/345)) ([84010b1](https://github.com/whoiskevinrich/holodex/commit/84010b10422c115cf72b13f2d0b17d72dc3c2448))
...
* **geometry:** assert the Enrich picker's stressed "Searched" caption ([#328](https://github.com/whoiskevinrich/holodex/issues/328)) ([24b56aa](https://github.com/whoiskevinrich/holodex/commit/24b56aa97fc419e1ed3c2357e3529915e4cd4bcf))
