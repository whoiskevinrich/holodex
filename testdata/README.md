...
Three generators live here. `gen.sh` (below) builds the **media** corpus; `aliasseed/`
builds **database state** — the F58/ADR-088 alias states (provider badge, collision
review line, suppression) that are tedious to stage by hand; `stressseed/` builds the
**stress fixture** — a deliberately adversarial library for UX and layout QA
(HOLODEX-342). See [`aliasseed/README.md`](aliasseed/README.md) and
[`stressseed/README.md`](stressseed/README.md).
