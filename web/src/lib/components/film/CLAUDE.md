...
| `FilmImageSlot.svelte` | Owner upload/replace/remove control for one of a film's two self-hosted image roles (poster/thumb) — mirrors `person/StudioImageSlot.svelte` (F51, ADR-079) exactly, substituting the film endpoints (F56/HOLODEX-280, ADR-086). |
