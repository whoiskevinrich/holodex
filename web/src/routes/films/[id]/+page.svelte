...
<AsyncState {loading} {error}>
	{#if film}
		<section class="mx-auto max-w-stage space-y-6">
			<!-- Same `stage-grid` shell as the media detail page (HOLODEX-331), with the banner
			     playing the player's part. It stays in the subject column rather than spanning the
			     stage: an 8:3 band across the 2600px stage stands 975px tall, which on the 1440px-tall
			     screen that width implies is two thirds of the viewport before the title appears. The
			     1.4fr column gives a measured 401px at 1920 and 563px at 5120 -- a hero band, not a
			     wall. Banner and header must stay adjacent in the same zone, since the header
			     overlaps the band via `-mb-14`. -->
