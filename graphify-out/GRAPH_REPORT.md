...
## Corpus Check
- 986 files · ~1,476,435 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7589 nodes · 16329 edges · 643 communities (350 shown, 216 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1931 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `05f17121`
...
## Communities (643 total, 216 thin omitted)
...
Cohesion: 0.03
Nodes (45): resolve(), DismissableOptions, provider(), commitEdit(), draft, editing, isProvider, onEditKey() (+37 more)
...
### Community 11 - "JobRun"
Cohesion: 0.09
Nodes (13): recordingJobRecorder, JobRun, Repo, TrashItem, scanTrash(), LibraryCounts, Repo, jobRunCutoff() (+5 more)
...
### Community 14 - "svelte"
Cohesion: 0.09
Nodes (13): batchId(), revert(), i(), busy, cancelEdit(), closeEdit(), commit(), editing (+5 more)

### Community 15 - "Service"
Cohesion: 0.07
Nodes (23): refreshAllResult, assetFetcher, IconRef, ImageSink, Manifest, ProviderClient, SourceInfo, TestSanitizeFieldsCaps() (+15 more)

### Community 16 - "resolver.go"
Cohesion: 0.14
Nodes (32): Source, applyCasing(), baselineValue(), decidedItem(), filmNamespaces(), filmSourceValue(), firstNonEmpty(), gateImageDisplay() (+24 more)
...
Cohesion: 0.05
Nodes (25): Health, rescanner, scanStatusSource, searchMetrics, thumbnailer, WriteBatchFunc, net/http.ResponseWriter, sync/atomic.Bool (+17 more)
...
Cohesion: 0.09
Nodes (57): decide(), providerCandidate(), TestResolve_CandidatesListFileAndMatchedProviders(), TestResolve_DecisionAdoptProvider(), TestResolve_DecisionKeepFileOverridesMappingOrder(), TestResolve_DecisionManualLiteral(), TestResolve_DeclaredBaseline_StaysKnowable(), TestResolve_EmptyProviderYieldsNoCandidate() (+49 more)
...
Cohesion: 0.07
Nodes (19): web/src/lib/browse.svelte.ts — module-scoped browse-state cache, web/src/routes/+page.svelte — the browse grid, web/src/lib/theme.svelte.ts — established module-scoped singleton pattern, Client-side seeded shuffle for unpaged People/Tags lists (mulberry32 PRNG), activity, ActivityState, ADR-0030, ADR-0046 (+11 more)
...
Cohesion: 0.05
Nodes (48): bytes.Buffer, testing.T, attachFilmVideo(), resolvedValue(), seedFilm(), TestFilmSourceInjection_SceneVsFullFilm(), TestFilmFields_NameHasNoProviderSource(), TestFilmReleaseYear() (+40 more)
...
### Community 44 - "New"
Cohesion: 0.12
Nodes (55): net/http.Handler, TestMergeEndpoint_PropagatesWritebackToAffectedVideos(), NewAuth(), facetMap(), TestGetMedia_Completeness(), TestGetPerson_Completeness(), TestGetStudio_Completeness(), peopleDecisionServerWithFields() (+47 more)

### Community 45 - "tmdbClient"
Cohesion: 0.20
Nodes (10): net/url.Values, disambiguate(), rankConfidence(), splitID(), tmdbEntityURL(), tmdbMovieURL(), tmdbPersonURL(), candidate (+2 more)
...
### Community 63 - "Field"
Cohesion: 0.08
Nodes (33): filmField(), filmFieldByCanonical(), filmFields(), applyGenreWriteback(), genreWritebackFieldValues(), personField(), personFieldByCanonical(), personFields() (+25 more)
...
### Community 78 - "Video"
Cohesion: 0.06
Nodes (26): fakeVideoLookup, Handlers, ExtraMetadata, Studio, Video, ftsPrefixQuery(), FacetValue, RelatedShelf (+18 more)
...
Cohesion: 0.06
Nodes (20): categoryTagIDsBody, net/http.Cookie, net/http.Request, ttlForClass(), Handlers, chi.Router, parseCategoryName(), Handlers (+12 more)
...
### Community 85 - "Repo"
Cohesion: 0.32
Nodes (13): sync.Mutex, tagID(), patchTok(), seedGenreVideo(), tagWritebackSyncServer(), TestSetTagsWritebackBulk_AppliesRegardlessOfPriorState(), TestSetTagWriteback(), TestSyncTagWriteback_RecomputesFullUnion() (+5 more)
...
Cohesion: 0.07
Nodes (55): aliasList(), aliasServer(), sendTok(), TestAddAliasConflict409(), TestAliasEndpointsGatedAndValidated(), TestGetPersonIncludesAliases(), TestMergeEndpoint(), TestPersonDetail_AliasSourceAndSkipped() (+47 more)
...
Cohesion: 0.07
Nodes (20): decisionBody, filmStudioCascadeResult, Handlers, chi.Router, decodeDecisionBody(), writeCollisionConflict(), Handlers, chi.Router (+12 more)
...
Cohesion: 0.13
Nodes (28): TestEnrichZeroRungStoresNothing(), TestNoOtherDimensionIsEnriched(), addressable(), countRows(), overviewRows(), paletteValue(), seed(), seedInto() (+20 more)
...
Cohesion: 0.26
Nodes (14): actionableCandidate(), classifyTier(), Complete(), criticalityWeight(), ResolvedField, FacetScore, fld(), TestComplete_AllExcludedYieldsZeroScore() (+6 more)
...
Cohesion: 0.03
Nodes (31): Noop, recordingSink, storedAsset, countingResolver, fakeVideoLister, recordingReviewStore, context.Context, fakePersonRepo (+23 more)
...
Cohesion: 0.10
Nodes (11): Category, EntityRef, PersonImageSet, Tag, HasThumbnailImage(), Repo, nameCollidesInTable(), Repo (+3 more)
...
Cohesion: 0.06
Nodes (26): enrichRoute, relinkContext, FieldCandidate, FieldDecision, Handlers, injectSyntheticFacet(), firstResolvedValue(), resolvedValues() (+18 more)
...
Cohesion: 0.12
Nodes (16): ADR-0039, ADR-0082, ALL_ENTITY_TYPES, BY_SLUG, candidatesFor(), crc32(), CRC_TABLE, describeFor() (+8 more)
...
Cohesion: 0.25
Nodes (8): image.Image, Backfill(), discardLog(), TestBackfillHashesAndRemoves(), downscale(), Hash(), Remove(), BackfillRepo
...
### Community 220 - "Design handoff: In-app promote / override affordance for auto-registered fields (F44)"
Cohesion: 0.15
...
### Community 315 - "TestQueue_SnapshotsAndReverts"
Cohesion: 0.38
...
### Community 316 - "ResolveForContainer"
Cohesion: 0.29
...
Cohesion: 0.21
Nodes (7): Handlers, ForComputed(), ForNamespace(), ForProvider(), TestForNamespace(), TestProviderRoundTrip(), TestValid()
...
### Community 358 - "providers.svelte.ts"
Cohesion: 0.32
Nodes (4): providers, ProvidersStore, ADR-0059, EnrichSource
...
### Community 381 - "downloadImageToTemp"
Cohesion: 0.62
...
### Community 471 - "identity_test.go"
Cohesion: 0.39
...
### Community 474 - "personDecisionServer"
Cohesion: 0.16
...
### Community 483 - "ADR-005: MCP Server Transport — HTTP/SSE (Primary) + stdio (Secondary)"
Cohesion: 0.29
...
### Community 510 - "vitest"
Cohesion: 0.08
Nodes (20): vitest, buildQuery(), parseSceneNumberInput(), sceneBadgeLabel(), Video components, FilmsPeopleInput, filmsPeopleLayout, SideLayout (+12 more)
...
### Community 544 - "Fake"
Cohesion: 0.14
Nodes (14): resolveCounter, Asset, EnrichResult, FakePerson, ProviderPerson, Candidate, TestSingleStrongMatch(), SingleStrongMatch() (+6 more)
...
### Community 581 - "Sink"
Cohesion: 0.09
Nodes (21): fakeStudioRepo, FilmRepo, personRepo, Sink, StudioRepo, filmImageSourceProvider(), New(), ReplaceFilmImageFile() (+13 more)
...
### Community 663 - "person-aliases.md"
Cohesion: 0.07
Nodes (25): ADR-003: SQLite (modernc.org/sqlite) + FTS5 chosen as database, WAL mode enabling concurrent reads during scanner writes, ADR-016: Database Migrations — golang-migrate with Embedded Versioned SQL, Consequences, Context, Decision, Rationale, 1. Global search (command-palette style) — primary search box (+17 more)
...
## Knowledge Gaps
- **2477 isolated node(s):** `$schema`, `PreToolUse`, `holodex`, `Handlers`, `categoryTagIDsBody` (+2472 more)
...
- **Why does `Lookup()` connect `Field` to `SanitizeValue`, `Service`, `net/http.Request`, `net/http.ResponseWriter`, `ResolveFields`, `ResolvedField`, `AutoRegisterFields`, `time.Time`, `Complete`?**
...
- **Should `types.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.01793045664013406 - nodes in this community are weakly interconnected._
- **Should `format.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.03135642982971227 - nodes in this community are weakly interconnected._