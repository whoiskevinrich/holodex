...
## Corpus Check
- 986 files · ~1,473,784 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7586 nodes · 16324 edges · 635 communities (346 shown, 212 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 1931 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c2e6fdbf`
...
## Communities (635 total, 212 thin omitted)
...
Cohesion: 0.04
Nodes (30): resolve(), provider(), busy, error, orderDraft, remove(), save(), scopeVerb (+22 more)
...
Cohesion: 0.10
Nodes (11): IconRef, ImageSink, Manifest, ProviderClient, SourceInfo, TestValidatePattern(), ValidatePattern(), Service (+3 more)
...
Cohesion: 0.06
Nodes (59): ResolvedWrite, ReviewAction, bytes.Buffer, testing.T, TestRelinkVideoPeople_UnmappedFieldLeavesExistingLinksUntouched(), TestRelinkVideoStudios_UnmappedFieldLeavesExistingLinksUntouched(), TestSourceBuildQuery_EmptyTitleNeverBlank(), TestSourceBuildQuery_OptionalTokenOmittedNoArtifact() (+51 more)
...
Cohesion: 0.05
Nodes (25): web/src/lib/browse.svelte.ts — module-scoped browse-state cache, web/src/routes/+page.svelte — the browse grid, web/src/lib/theme.svelte.ts — established module-scoped singleton pattern, Client-side seeded shuffle for unpaged People/Tags lists (mulberry32 PRNG), vitest, activity, ActivityState, ADR-0030 (+17 more)

### Community 39 - "people/+page.svelte"
Cohesion: 0.04
Nodes (34): onKey(), Sort components, segmentedToggleWrapperClass, firstLetter(), letterAnchors(), seededShuffle(), ADR-0045, keyFor() (+26 more)
...
Cohesion: 0.05
Nodes (62): mustVideoID(), TestCategoriesForTag(), TestCategoryCrossTableCollision(), TestCategoryCRUD(), TestCategoryTagAssignment(), TestCategoryVideoFilterFacet(), TestListCategoriesTagFields(), TestResolveOrCreateTag() (+54 more)
...
### Community 65 - "f36.ts"
Cohesion: 0.08
Nodes (35): Writeback components, autoResize(), busy, enqueueError, ensureDecision(), onKeydown(), submit(), trapTab() (+27 more)
...
### Community 69 - "newRepoDB"
Cohesion: 0.18
Nodes (23): newRepoDB(), reviewPair, hasPair(), mustExec(), readReviewQueue(), rowCount(), TestIdentityBackfill(), TestIdentityBackfillIdempotent() (+15 more)
...
Cohesion: 0.18
Nodes (18): TestBuildVideoFromFileForcesExtractWithoutPersisting(), TestExtractionHook(), TestExtractionHook_ErrorDoesNotFailScan(), activeCount(), newFakeRepo(), newTestScanner(), TestChangedFileIsReindexed(), TestReactivatesUnchangedFile() (+10 more)
...
### Community 78 - "Video"
Cohesion: 0.08
Nodes (21): filmVideoCandidate, fakeVideoLookup, Handlers, ExtraMetadata, Video, ftsPrefixQuery(), RelatedShelf, VideoFilter (+13 more)

### Community 79 - "enrich/enrich.go"
Cohesion: 0.15
Nodes (16): fileConfig, Registry, Store, sync/atomic.Pointer, Empty(), entityTypesSupport(), Source, Load() (+8 more)

### Community 80 - "service.go"
Cohesion: 0.18
Nodes (14): Asset, assetFetcher, EnrichRepo, EnrichResult, ProviderPerson, TestSanitizeFieldsCaps(), TestSanitizePeopleRejectsWhitespaceInExternalID(), TestSanitizeStudioExternalIDsRejectsMalformedID() (+6 more)
...
Cohesion: 0.15
Nodes (21): time.Time, dependencyLabels(), Derive(), deriveAge(), deriveAgeAtDeath(), firstValues(), ResolvedField, insertComputed() (+13 more)

### Community 89 - "Normalize"
Cohesion: 0.09
Nodes (32): providerInfo, image.Image, Handlers, providerIconURL(), downscale(), Normalize(), forgePNGDims(), jpegBytes() (+24 more)
...
Cohesion: 0.15
Nodes (32): dimension, entityKind, fixtureFields, links, rung, spec, textVariant, TestEncodedNamesDistinguishRungsWithinADimension() (+24 more)
...
Cohesion: 0.07
Nodes (19): curationBody, Handlers, chi.Router, validateCurationBody(), validCurationAction(), Handlers, chi.Router, Handlers (+11 more)

### Community 104 - "writeJSON"
Cohesion: 0.07
Nodes (14): Handlers, Handlers, chi.Router, validEntityType(), Handlers, filmImageURL(), setFilmAttachmentPosterURLs(), setFilmImageURLs() (+6 more)
...
Cohesion: 0.11
Nodes (32): TestEnrichRungsSeedTheirNamespaces(), TestEnrichZeroRungStoresNothing(), addressable(), countRows(), overviewRows(), paletteValue(), seed(), seedInto() (+24 more)

### Community 121 - "0043_films.up.sql"
Cohesion: 0.53
Nodes (5): film_images, film_people_roles, film_videos, films, films_fts

### Community 122 - ".mergePromotions"
Cohesion: 0.10
Nodes (19): promotionBody, promotionView, FieldHint, hasNonEmpty(), lookupHint(), normalizeGroupOrEmpty(), SanitizeFieldHints(), TestAssetHostAllowed() (+11 more)
...
### Community 147 - "people-source-of-truth.md"
Cohesion: 0.12
...
### Community 148 - "CurationFieldRow.svelte"
Cohesion: 0.12
...
### Community 161 - "Handlers"
Cohesion: 0.17
Nodes (4): categoryTagIDsBody, Handlers, chi.Router, parseCategoryName()

### Community 162 - "flagNearMissForName"
Cohesion: 0.06
Nodes (31): EntityAlias, EntityRef, canonicalTable(), nameKeyExpr(), entityConflict(), Repo, mergeEntityLookupErr(), orderPair() (+23 more)
...
Cohesion: 0.11
Nodes (13): dismissable(), activate(), deactivate(), onClick(), onKey(), DismissableOptions, closeBox(), historyRowAt() (+5 more)
...
Cohesion: 0.07
Nodes (17): WriteBatchFunc, net/http.Request, Handlers, serveEntityImageFile(), filmImageRole(), Handlers, chi.Router, Handlers (+9 more)
...
Cohesion: 0.05
Nodes (33): ADR-002: SvelteKit chosen as frontend framework (SPA/static-adapter mode), ADR-003: SQLite (modernc.org/sqlite) + FTS5 chosen as database, WAL mode enabling concurrent reads during scanner writes, ADR-005: MCP Server Transport — HTTP/SSE (Primary) + stdio (Secondary), Client Configuration Examples, Configuration, Consequences, Context (+25 more)

### Community 182 - "ResolvedField"
Cohesion: 0.07
Nodes (28): relinkContext, FieldCandidate, FieldDecision, Handlers, Handlers, injectSyntheticFacet(), firstResolvedValue(), resolvedValues() (+20 more)
...
### Community 453 - "filmsPeopleLayout.ts"
Cohesion: 0.40
Nodes (4): FilmsPeopleInput, filmsPeopleLayout, SideLayout, base

### Community 456 - "HOLODEX-281 · film_people_roles CRUD (film-level billing/role data)"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (17): Handlers, chi.Router, decodeJSON(), Handlers, chi.Router, Handlers, chi.Router, Handlers (+9 more)
...
Cohesion: 0.10
Nodes (14): 1. Setup, 2. Smoke, 3. Agent, 4. Human, Manual QA Checklist: Extract from filename on the media detail page (F48.5a), brand_icon provider-level asset (ADR-059), Spec: Holodex Metadata Provider Contract (hand-off, protocol v1), testdata/enrich-stub/ reference implementation (Node, dependency-free) (+6 more)
...
### Community 581 - "Sink"
Cohesion: 0.12
Nodes (21): FilmRepo, personRepo, Sink, StudioRepo, New(), ReplaceFilmImageFile(), ReplaceStudioImageFile(), jpegBytes() (+13 more)
...
Cohesion: 0.13
Nodes (13): 1. Global search (command-palette style) — primary search box, 2. In-grid filtering — browse narrowing, ADR-017: Search Architecture — Global Mixed-Entity Search + FTS5, Consequences, Context, Decision, FTS configuration, Rationale (+5 more)
...
## Knowledge Gaps
- **2476 isolated node(s):** `$schema`, `PreToolUse`, `holodex`, `Handlers`, `categoryTagIDsBody` (+2471 more)
  These have ≤1 connection - possible missing edges or undocumented components. (Counts symbols only; 2893 node(s) total have ≤1 connection when file, concept and rationale nodes are included.)
- **212 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Canonical Field Registry (operator reference)` connect `Spec: Metadata Source Plugins (F22/F27/F28)` to `ADR-075: Tag governance & video enrichment`, `Spec: Holodex Metadata Provider Contract (hand-off, protocol v1)`, `Design handoff: Completeness panel — collapsible facet fold`, `Spec: Derived/calculated person fields (F45)`, `.mergePromotions`?**
  _High betweenness centrality (0.349) - this node is a cross-community bridge._
- **Why does `Lookup()` connect `Lookup` to `Handlers`, `EnrichedField`, `parseEntityType`, `net/http.ResponseWriter`, `ResolveFields`, `ResolvedField`, `AutoRegisterFields`, `time.Time`, `.mergePromotions`, `Complete`, `Field`?**
...
- **Should `format.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.04041720990873533 - nodes in this community are weakly interconnected._