...
## Summary
- 5046 nodes · 10078 edges · 539 communities (311 shown, 228 thin omitted)
- Extraction: 84% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1596 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1306729d`
- Run `git rev-parse HEAD` and compare to check if the graph is stale.
- Run `graphify update .` after code changes (no API cost).

## Community Hubs (Navigation)
- types.ts
- studios/[id]/+page.svelte
- session-start.mjs
- Normalize
- testPatterns
- NewService
...
1. `newRepo()` - 152 edges
2. `sampleVideo()` - 95 edges
3. `writeError()` - 94 edges
4. `itoa()` - 80 edges
5. `writeJSON()` - 69 edges
6. `pathID()` - 68 edges
7. `Handlers` - 58 edges
8. `Router()` - 57 edges
9. `Open()` - 53 edges
...
- `run()` --calls--> `NewHealth()`  [INFERRED]
  cmd/holodex/main.go → internal/api/health.go
...
## Communities (539 total, 228 thin omitted)

### Community 0 - "types.ts"
Cohesion: 0.02
Nodes (116): ADR-0006, ADR-0028, ADR-0036, ADR-0056, ADR-0073, checkRedirect(), ENRICH_ENTITY_BASE, ENTITY_BASE (+108 more)

### Community 1 - "studios/[id]/+page.svelte"
Cohesion: 0.07
Nodes (22): provider(), runEnrichRefresh(), runEnrichRefreshAll(), providers, ProvidersStore, ADR-0059, EnrichEntityKind, EnrichSource (+14 more)
...
Cohesion: 0.06
Nodes (55): providerInfo, Image, Handlers, Context, Request, ResponseWriter, providerIconURL(), Backfill() (+47 more)
...
### Community 6 - "Repo"
Cohesion: 0.09
Nodes (25): ftsPrefixQuery(), Context, DB, ExtraMetadata, Mutex, Person, Pointer, Repo (+17 more)
...
Cohesion: 0.09
Nodes (26): rescanner, scanStatusSource, searchMetrics, thumbnailer, Cache, FacetValue, curationFromRows(), decisionsFromRows() (+18 more)
...
### Community 13 - ".Get"
Cohesion: 0.14
Nodes (33): iconEnv, Handlers, Repo, Service, T, newProviderIconEnv(), providersDirectory(), TestProviderIcon_DownloadNormalizeServe() (+25 more)

### Community 14 - ".resolveStudio"
Cohesion: 0.09
Nodes (19): Handlers, Context, Request, ResponseWriter, Studio, setStudioLogoURL(), Handlers, Context (+11 more)

### Community 15 - "Service"
Cohesion: 0.12
Nodes (18): assetFetcher, EnrichRepo, ImageSink, ProviderClient, SourceInfo, assetRoleFor(), Context, Service (+10 more)
...
Cohesion: 0.05
Nodes (17): batchId(), revert(), i(), progressed, progressPct, calculatedFrom(), formatDuration(), formatYear() (+9 more)

### Community 18 - "itoa"
Cohesion: 0.18
Nodes (33): aliasList(), aliasServer(), Repo, T, TestAddAliasConflict409(), TestAliasEndpointsGatedAndValidated(), TestGetPersonIncludesAliases(), TestMergeEndpoint() (+25 more)

### Community 19 - "newRepo"
Cohesion: 0.10
Nodes (37): T, TestClaims_SetClearsPromotionInSameWrite(), TestClaims_SetListClear(), T, TestHasSuccessfulJobRun(), TestJobRunDigest(), TestJobRunDigestCleanWindow(), TestJobRunsAttributionRoundTrip() (+29 more)

### Community 20 - "Scanner"
Cohesion: 0.13
Nodes (15): Context, Duration, Logger, ScanStatus, Time, New(), Config, Extractor (+7 more)

### Community 21 - "pathID"
Cohesion: 0.22
Nodes (8): Handlers, Request, ResponseWriter, Handlers, EnrichedField, Request, ResponseWriter, pathID()
...
### Community 23 - "run"
Cohesion: 0.12
Nodes (32): backfillStudioLinks(), backfillStudioLogos(), Context, Logger, Repo, main(), newLogger(), run() (+24 more)
...
Cohesion: 0.14
Nodes (35): passthroughFetcher, Repo, Service, T, newSvc(), TestAssetClientAssetHosts(), TestAssetClientNonBaseHostRequiresHTTPS(), TestAssetClientSSRF() (+27 more)

### Community 26 - "sampleVideo"
Cohesion: 0.08
Nodes (34): T, TestDecisions_ForVideosBatch(), TestDecisions_SetGetClear(), TestHasManualSource(), T, TestExpiredSoftDeletedAndHardDelete(), TestRestore(), TestSoftDeleteHidesFromEverySurface() (+26 more)
...
### Community 28 - "Auth"
Cohesion: 0.16
Nodes (9): Auth, sessionClaims, POST /api/v1/session (token exchange) + DELETE /api/v1/session (sign-out), deriveSessionSecret(), Handlers, Handler, Request, ResponseWriter (+1 more)
...
### Community 33 - "mcp.go"
Cohesion: 0.12
Nodes (26): filterNamed(), CallToolRequest, CallToolResult, Context, ExtraMetadata, T, Video, jsonResult() (+18 more)
...
Cohesion: 0.21
Nodes (29): Context, T, mergeField(), stubField(), TestBrowseTitle_FallbackToFileTitle(), TestBrowseTitle_NoBrowseField(), TestBrowseTitle_ProviderWins(), TestResolve_CasingLowerAndTitle() (+21 more)

### Community 37 - "ResolveReviewAction"
Cohesion: 0.31
Nodes (13): ResolvedWrite, ReviewAction, ResolveReviewAction(), T, TestResolveReviewAction_Filename(), TestResolveReviewAction_FilenameRequiresValue(), TestResolveReviewAction_Manual(), TestResolveReviewAction_ManualMultiValue() (+5 more)

### Community 38 - "activity.svelte.ts"
Cohesion: 0.06
Nodes (18): web/src/lib/browse.svelte.ts — module-scoped browse-state cache, web/src/routes/+page.svelte — the browse grid, web/src/lib/theme.svelte.ts — established module-scoped singleton pattern, Client-side seeded shuffle for unpaged People/Tags lists (mulberry32 PRNG), ADR-0030, ADR-0046, GOOD, ADR-0046 (+10 more)

### Community 39 - "people/+page.svelte"
Cohesion: 0.11
Nodes (12): Sort components, firstLetter(), letterAnchors(), seededShuffle(), ADR-0045, keyFor(), loadSeed(), newSeed() (+4 more)
...
### Community 41 - "Field"
Cohesion: 0.12
Nodes (23): Source, studioField(), studioFieldByCanonical(), studioFields(), Dedupe(), Empty(), ExtraMetadata, Pointer (+15 more)
...
Cohesion: 0.16
Nodes (17): ResolvedField, Source, personDecisionSource(), personField(), personFieldByCanonical(), personFields(), personizeResolved(), providerSources() (+9 more)

### Community 44 - "Open"
Cohesion: 0.29
Nodes (10): genreWritebackServer(), Handlers, Repo, T, TestGenreWritebackEndpoint(), TestGenreWritebackValues(), TestGenreWritebackValues_NoMappings(), DB (+2 more)

### Community 45 - "sendDecision"
Cohesion: 0.18
Nodes (33): decisionServer(), Repo, T, resolvedField(), sendDecision(), TestDecisionAPI_AdoptProviderThenClear(), TestDecisionAPI_ManualLiteral(), TestDecisionAPI_OwnerGated() (+25 more)
...
### Community 53 - "personIDByName"
Cohesion: 0.20
Nodes (22): countPeople(), Person, T, Video, hasVideoTitle(), personIDByName(), TestAliasesSurviveRescan(), TestMergePersons() (+14 more)
...
Cohesion: 0.21
Nodes (10): refreshAllResult, Hint, Video, Handlers, Context, EnrichedField, HandlerFunc, Request (+2 more)

### Community 58 - "Context"
Cohesion: 0.16
Nodes (12): canonicalTable(), Context, Repo, Tx, mergeEntityLookupErr(), orderPair(), selfRefAncestorIDs(), New() (+4 more)

### Community 59 - "NewHealth"
Cohesion: 0.16
Nodes (36): fakeRescanner, extractReviewGET(), extractReviewPOST(), extractReviewServer(), Repo, T, TestDismissExtractionReview(), TestExtractionQueue_Empty() (+28 more)
...
Cohesion: 0.19
Nodes (20): Repo, T, studioIDByName(), tagIDByName(), TestEntityConflictExcludesSelf(), TestKeepSeparateStore(), TestMergeEntitiesValidation(), TestMergeEntitiesWithAffectedVideos_CapturesLinksAtomically() (+12 more)
...
### Community 65 - "f36.ts"
Cohesion: 0.10
Nodes (32): 10. Three-skin QA (required), 11. What is explicitly not in this handoff, 1. The Promote control (owner-only, on the auto row), 2. The inline editor (shared promote + edit — DD2), 3. After promotion — the partition move (shared by all treatments), 4. Edit / Remove promotion (owner-only, on the promoted row), 5. States, 6. Responsive behavior (+24 more)
...
Cohesion: 0.29
Nodes (6): Candidate, T, TestSingleStrongMatch(), SingleStrongMatch(), sanitizeCandidates(), sanitizeProfileURL()
...
Cohesion: 0.06
Nodes (31): DismissableOptions, PopoverMenu, PopoverMenuOptions, createAndAssign(), focusOption(), onKey(), onOptionKey(), optionCount (+23 more)

### Community 71 - ".resolvedFieldForVideo"
Cohesion: 0.16
Nodes (14): Handlers, Context, ExtraMetadata, ResolvedField, Video, ForComputed(), ForNamespace(), ForProvider() (+6 more)

### Community 72 - "writeError"
Cohesion: 0.25
Nodes (9): ResponseWriter, writeError(), Handlers, PersonImageSet, Reader, Request, ResponseWriter, parseImageID() (+1 more)

### Community 75 - "Manager"
Cohesion: 0.15
Nodes (10): T, TestGenerateFrameRealFfmpeg(), Context, Int64, Logger, Manager, New(), ThumbPath() (+2 more)
...
Cohesion: 0.16
Nodes (14): Context, Manager, absPath(), Context, Reader, Manager, lastLine(), scaleArgs() (+6 more)
...
Cohesion: 0.19
Nodes (14): FieldHint, fileConfig, IconRef, Manifest, Registry, Store, Empty(), entityTypesSupport() (+6 more)

### Community 80 - "0001_init.up.sql"
Cohesion: 0.07
Nodes (26): people, people_fts, tags, tags_fts, video_metadata, video_people, video_tags, videos (+18 more)

### Community 81 - "Process"
Cohesion: 0.17
Nodes (22): Decision, Deps, Enqueuer, FieldExtraction, ManualSourceChecker, ReviewStore, Context, Logger (+14 more)
...
Cohesion: 0.33
Nodes (9): SanitizeFieldHints(), SanitizeFieldLabel(), sanitizeHintLabel(), T, TestAssetHostAllowed(), TestManifest_DecodeBackwardCompat(), TestSanitizeFieldHints_DropsCanonicalReservedAndUnknownVocab(), TestSanitizeFieldHints_EmptyAndNil() (+1 more)

### Community 86 - "thumbServer"
Cohesion: 0.27
Nodes (11): stubThumbs, Context, Repo, T, seedThumbVideo(), TestAdminStatus(), TestListEnqueuesVisibleAndExposesURL(), TestRegenerateDisabled() (+3 more)

### Community 87 - "identityServer"
Cohesion: 0.12
Nodes (30): T, reqTokBody(), TestCategoryEndpoints(), TestResolveOrCreateTagEndpoint(), getJSONTok(), T, TestDuplicatesEndpoints(), TestNearMissEndpoint() (+22 more)

### Community 88 - "Lookup"
Cohesion: 0.15
Nodes (27): Lookup(), fieldByKey(), ResolvedField, dependencyLabels(), Derive(), deriveAge(), deriveAgeAtDeath(), firstValues() (+19 more)
...
### Community 94 - ".sessionCookie"
Cohesion: 0.30
Nodes (9): Duration, ttlForClass(), baseSessionCookie(), Handlers, Cookie, Request, ResponseWriter, Time (+1 more)
...
### Community 100 - "decodeJSON"
Cohesion: 0.15
Nodes (14): curationBody, Handlers, Request, ResponseWriter, validateCurationBody(), validCurationAction(), decodeJSON(), Handlers (+6 more)
...
Cohesion: 0.19
Nodes (12): cachingResolver, FieldOutcome, Orchestrator, Outcome, Resolver, Result, VideoLookup, fileTagValues() (+4 more)
...
### Community 107 - "Server"
Cohesion: 0.22
Nodes (19): Logger, Repo, Store, New(), call(), CallToolRequest, CallToolResult, Context (+11 more)

### Community 108 - "Context"
Cohesion: 0.23
Nodes (5): Context, Person, Repo, Tx, resolveOrCreatePerson()
...
Cohesion: 0.30
Nodes (13): Repo, Studio, T, studioByName(), studioNames(), TestGetStudio_NotFound(), TestListStudios_AttachesLogoVersion(), TestReconcileVideoStudios_CreateReplacePrune() (+5 more)
...
### Community 119 - "browse.svelte.ts"
Cohesion: 0.24
Nodes (10): browseCache, BrowseSnapshot, ADR-0032, createNavSnapshot(), Keyed, ADR-0032, peopleScroll, PeopleScrollSnapshot (+2 more)

### Community 120 - ".restoreMedia"
Cohesion: 0.21
Nodes (7): purger, trashItem, Handlers, Duration, Request, ResponseWriter, Time

### Community 121 - ".mergePromotions"
Cohesion: 0.17
Nodes (11): promotionBody, promotionView, Handlers, Context, ResolvedField, hasNonEmpty(), lookupHint(), normalizeGroupOrEmpty() (+3 more)
...
### Community 129 - ".add"
Cohesion: 0.45
Nodes (9): T, newFakeRepo(), TestDisabledManagerNoops(), TestExtractEmbedded(), testManager(), TestProcessGeneratesAndMarks(), TestProcessMarksFailed(), TestRunDrainsBackfill() (+1 more)
...
### Community 143 - ".writebackMedia"
Cohesion: 0.23
Nodes (5): WriteBatchFunc, Handlers, Request, ResponseWriter, SanitizeValues()
...
### Community 154 - "Context"
Cohesion: 0.29
Nodes (5): Context, Repo, Time, StudioLogo, StudioLogoInsert
...
Cohesion: 0.22
Nodes (8): T, toAnySlice(), Context, DB, Repo, Tag, isTagDescendant(), videoIDsForTagsQuery()
...
### Community 166 - "activityResponse"
Cohesion: 0.29
...
### Community 177 - "ADR-008: Caching Strategy — In-Process Cache with Redis-Ready Interface"
Cohesion: 0.07
Nodes (30): ADR-008: Caching Strategy — In-Process Cache with Redis-Ready Interface, Cache Interface, Configuration, Consequences, Context, Decision, Invalidation Strategy, What Gets Cached (+22 more)
...
### Community 181 - ".resolveExtractionReview"
Cohesion: 0.48
Nodes (3): Handlers, Request, ResponseWriter

### Community 182 - ".genreWritebackValuesForVideo"
Cohesion: 0.47
Nodes (4): Handlers, Context, ExtraMetadata, Video
...
### Community 258 - "writeback_snapshots_test.go"
Cohesion: 0.48
Nodes (6): T, TestSnapshotExistsForVideo_ScopedPerVideo(), TestWritebackSnapshots_EmptyMapIsNoop(), TestWritebackSnapshots_RoundTrip(), TestWritebackSnapshots_UnknownBatchIsEmpty(), TestWritebackSnapshots_VideoDeleteCascades()
...
Cohesion: 0.11
Nodes (17): commitEdit(), draft, editing, isProvider, onEditKey(), provenance, add(), adding (+9 more)
...
### Community 350 - "QA: Metadata Writeback (F28)"
Cohesion: 0.11
...
### Community 357 - "Client Session & Video UI"
Cohesion: 0.13
Nodes (4): activity, ActivityState, endSession(), Video components
...
### Community 460 - "PromoteFieldEditor.svelte"
Cohesion: 0.22
Nodes (6): busy, error, onKey(), orderDraft, save(), scopeVerb
...
### Community 464 - "fakeImageRepo"
Cohesion: 0.33
Nodes (4): Context, PersonImage, fakeImageRepo, PersonImageInsert
...
### Community 473 - ".adminActivity"
Cohesion: 0.52
Nodes (4): Handlers, Request, ResponseWriter, atoiDefault()

### Community 474 - "genresServer"
Cohesion: 0.43
Nodes (6): genresServer(), Handlers, Repo, T, TestMaterializeVideoTags(), TestMaterializeVideoTags_NoMappings()

### Community 475 - ".personResolved"
Cohesion: 0.50
Nodes (3): Handlers, Person, Request
...
### Community 480 - ".refreshMedia"
Cohesion: 0.50
Nodes (3): Handlers, Request, ResponseWriter

## Knowledge Gaps
- **1207 isolated node(s):** `$schema`, `SessionStart`, `PostToolUse`, `Stop`, `PreToolUse` (+1202 more)
...
- **Why does `Open()` connect `Open` to `Store`, `Normalize`, `extractServer`, `writeJSON`, `.Get`, `.resolveStudio`, `itoa`, `newRepo`, `run`, `personDerivedServer`, `enrich/enrich_test.go`, `tagWritebackSyncServer`, `sendDecision`, `sendTok`, `holoShuffle`, `writeback/writeback.go`, `NewHealth`, `openAt`, `writeError`, `api/person_images_test.go`, `authServer`, `New`, `thumbServer`, `identityServer`, `genresServer`, `refreshServer`, `Server`, `newRepoDB`?**
  _High betweenness centrality (0.182) - this node is a cross-community bridge._
- **Are the 137 inferred relationships involving `newRepo()` (e.g. with `TestAliasesSurviveRescan()` and `TestMergePersons()`) actually correct?**
  _`newRepo()` has 137 INFERRED edges - model-reasoned connections that need verification._
- **Are the 84 inferred relationships involving `sampleVideo()` (e.g. with `TestAliasesSurviveRescan()` and `TestMergePersons()`) actually correct?**
  _`sampleVideo()` has 84 INFERRED edges - model-reasoned connections that need verification._
- **Are the 91 inferred relationships involving `writeError()` (e.g. with `.addAlias()` and `.addEntityAlias()`) actually correct?**
  _`writeError()` has 91 INFERRED edges - model-reasoned connections that need verification._
- **Are the 76 inferred relationships involving `itoa()` (e.g. with `TestAddAliasConflict409()` and `TestAliasEndpointsGatedAndValidated()`) actually correct?**
  _`itoa()` has 76 INFERRED edges - model-reasoned connections that need verification._