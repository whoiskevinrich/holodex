...
## Corpus Check
- 1083 files · ~1,672,688 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 8585 nodes · 18125 edges · 697 communities (406 shown, 211 thin omitted)
- Extraction: 88% EXTRACTED · 12% INFERRED · 0% AMBIGUOUS · INFERRED: 2091 edges (avg confidence: 0.85)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ae03130`
...
## Communities (697 total, 211 thin omitted)
...
Cohesion: 0.08
Nodes (63): countPeople(), hasVideoTitle(), personIDByName(), TestAliasesSurviveRescan(), TestMergePersons(), TestMergePersons_DedupesSameRoleLinkAtMergeTime(), TestMergePersons_RepointsExternalID(), TestMergePersonsValidation() (+55 more)

### Community 6 - "api/writeback_test.go"
Cohesion: 0.29
Nodes (15): getMediaWritebackStatus(), jobStatusURL(), mediaWritebackURL(), seedFailedWriteback(), TestDismissWriteback_DeletesRow(), TestEnqueueWriteback_ClearsPriorFailedForVideo(), TestGetMedia_WritebackStatusRedactedForVisitor(), TestGetMedia_WriteTarget() (+7 more)

### Community 7 - "ladder_test.go"
Cohesion: 0.12
Nodes (31): TestNoOtherDimensionIsEnriched(), addressable(), countRows(), overviewRows(), paletteValue(), seed(), seedInto(), TestDerivedBlocksDoNotOverlapTheSupportingPool() (+23 more)
...
Cohesion: 0.18
Nodes (25): iconEnv, filmImageServer(), solidJPEG(), TestFilmImage_BannerRequiresLandscape(), TestFilmImage_DeleteClearsProviderRow(), TestFilmImage_InvalidRole(), TestFilmImage_MutationsRequireOwner(), TestFilmImage_ReplaceAdvancesVersion() (+17 more)
...
Cohesion: 0.04
Nodes (69): mustVideoID(), TestCategoriesForTag(), TestCategoryCrossTableCollision(), TestCategoryCRUD(), TestCategoryTagAssignment(), TestCategoryVideoFilterFacet(), TestListCategoriesTagFields(), TestResolveOrCreateTag() (+61 more)

### Community 18 - "Handlers"
Cohesion: 0.05
Nodes (22): purger, rescanner, scanStatusSource, searchMetrics, thumbnailer, time.Duration, filmImageURL(), setFilmAttachmentPosterURLs() (+14 more)
...
Cohesion: 0.14
Nodes (31): TestServiceRecordSearched_AppliedDetail(), TestServiceResolveGatesImageURL(), Service, newSvc(), TestDownloadAssetsFirstSuccessPerRole(), TestEnrichAssetFailureIsNonFatal(), TestEnrichDownloadsAssets(), TestEnrichDownloadsFilmAssets() (+23 more)
...
Cohesion: 0.11
Nodes (29): disambiguate(), fieldHint, movieAliases(), movieDisambiguate(), movieYear(), parseReleaseFilename(), TestDisambiguate(), TestParseReleaseFilename() (+21 more)
...
Cohesion: 0.06
Nodes (30): Accessibility, Design Handoff: People on the unified source-of-truth model (F37), Design tokens, Entity-generic baseline label (dev notes), Layout, Long-text fields (`bio`) — P1-1 resolved, Overview, States and Interactions (delta to F36) (+22 more)
...
Cohesion: 0.07
Nodes (21): UI vocabulary: translate, link, record, ADR-091: Writeback is fire-and-forget; job status is a property of the video, not of the dialog, Alternatives considered, Consequences, Context, Decision, Scope, ADR-093: A field's sync state is unknown, not false, when nothing reads the written tag back (+13 more)
...
Cohesion: 0.09
Nodes (27): canonicalKey(), dedupe(), Extracted, isBinaryValue(), leadingOrdinal(), mapExiftool(), mapFfprobe(), newKeySet() (+19 more)

### Community 36 - "Resolve"
Cohesion: 0.11
Nodes (47): decide(), providerCandidate(), TestResolve_CandidatesListFileAndMatchedProviders(), TestResolve_DecisionAdoptProvider(), TestResolve_DecisionKeepFileOverridesMappingOrder(), TestResolve_DecisionManualLiteral(), TestResolve_DeclaredBaseline_StaysKnowable(), TestResolve_Edition_TagBeatsFilename() (+39 more)

### Community 37 - "service.go"
Cohesion: 0.11
Nodes (26): assetFetcher, TestSanitizeDetail(), TestServiceResolve_DetailIngest(), TestSanitizeImageURL(), TestSanitizeCandidatesAutoApply(), TestSanitizeFieldsCaps(), TestSanitizePeopleRejectsWhitespaceInExternalID(), TestSanitizeProfileURL() (+18 more)
...
### Community 44 - "New"
Cohesion: 0.09
Nodes (73): net/http.Handler, TestMergeEndpoint_PropagatesWritebackToAffectedVideos(), NewAuth(), facetMap(), TestGetMedia_Completeness(), TestGetPerson_Completeness(), TestGetStudio_Completeness(), peopleDecisionServerWithFields() (+65 more)
...
### Community 46 - "Queue"
Cohesion: 0.14
Nodes (9): fakeEnqueuer, WritebackJob, buildBatch(), detailLine(), JobField, Queue, BatchJob, PostWriteFunc (+1 more)
...
Cohesion: 0.07
Nodes (26): ADR-052: BaselineSource contract, 1. Setup / preconditions, 2. Smoke — automated (green in CI), 3. Agent — drive the running app, 4. Human — needs an eye (run in **all three skins**: Cinémathèque · Broadcast · Brutalist), Manual QA Checklist: Per-field source-of-truth decisions (F36), 1. Setup / preconditions, 2. Smoke — automated (green in CI) (+18 more)
...
Cohesion: 0.23
Nodes (20): clientWith(), fakeTMDB(), TestRankConfidence(), TestTMDBEnrich(), TestTMDBEnrichMovie(), TestTMDBEnrichStudio(), TestTMDBEnrichStudioNoWebsite(), TestTMDBEnrichUnknownID() (+12 more)

### Community 59 - "getJSON"
Cohesion: 0.17
Nodes (26): externalLinksEnv, fakeRescanner, linksByProvider(), newExternalLinksEnv(), seedSourceURLPerson(), TestExternalLinks_Film(), TestExternalLinks_MalformedIDSkipped(), TestExternalLinks_MultiBadge() (+18 more)
...
Cohesion: 0.10
Nodes (31): tagIDByName(), TestEntityConflictExcludesSelf(), TestKeepSeparateStore(), TestMergeEntitiesValidation(), TestMergeEntitiesWithAffectedVideos_UnknownEntityType(), TestRenameStudioKeepsOldNameAsAlias(), TestRenameTagInternalWhitespaceConflict(), TestStudioAliasCRUD() (+23 more)
...
Cohesion: 0.11
Nodes (34): TestDisplayNames(), headshotVersionOf(), posterVersionOf(), seedPerson(), TestCollapseDuplicateGalleryExtras(), TestCoreSlotReplace(), TestDeleteSuppressesEnrichmentURL(), TestExistingPersonImageURLs() (+26 more)

### Community 70 - "time.Time"
Cohesion: 0.13
...
### Community 78 - "Provider"
Cohesion: 0.10
Nodes (11): Handlers, chi.Router, personDecisionSource(), recordDecisionSource(), Handlers, chi.Router, ForComputed(), Provider() (+3 more)

### Community 79 - "enrich/enrich.go"
Cohesion: 0.10
Nodes (23): FieldHint, fileConfig, IconRef, Registry, Store, Empty(), entityTypesSupport(), Source (+15 more)
...
Cohesion: 0.06
Nodes (23): WriteBatchFunc, net/http.Cookie, net/http.Request, ttlForClass(), Handlers, chi.Router, serveEntityImageFile(), filmImageRole() (+15 more)
...
Cohesion: 0.10
Nodes (36): partsFixture, reqTokBody(), TestCategoryEndpoints(), TestResolveOrCreateTagEndpoint(), completenessBrowseServer(), mediaTitles(), TestCompletenessFacets(), TestListMedia_CompletenessSort_Orders() (+28 more)
...
Cohesion: 0.23
Nodes (18): Normalize(), forgePNGDims(), jpegBytes(), pngBytes(), TestNormalizeAcceptsWebP(), TestNormalizeDownscales(), TestNormalizeJPEGFlattensTransparency(), TestNormalizeKeepsTransparencyAsPNG() (+10 more)
...
Cohesion: 0.19
Nodes (28): dimension, fixtureFields, links, rung, spec, TestEncodedNamesDistinguishRungsWithinADimension(), bindNamedEntity(), materialize() (+20 more)
...
Cohesion: 0.16
Nodes (19): Handlers, ForNamespace(), TestForNamespace(), actionableCandidate(), classifyTier(), Complete(), criticalityWeight(), ResolvedField (+11 more)
...
Cohesion: 0.35
Nodes (10): queryToken, QueryFields, Source, parseQueryPattern(), renderPattern(), sanitizeTitle(), titleIsRedundant(), tokenValue() (+2 more)
...
Cohesion: 0.07
Nodes (32): §1 Setup, §2 Smoke — `[smoke]`, §3 Agent — live, all three skins — `[agent]`, §4 Human — `[human]`, QA Checklist: Revealable candidate detail in the Enrich picker (HOLODEX-380), §1 Setup, §2 Smoke — `[smoke]`, §3 Agent — live, all three skins — `[agent]` (+24 more)
...
Cohesion: 0.03
Nodes (26): Noop, recordingSink, storedAsset, countingResolver, fakeResolver, context.Context, Handlers, Match (+18 more)
...
### Community 143 - "entityKind"
Cohesion: 0.17
Nodes (18): axes, entityKind, entry, filmAxes, imageAxes, imageSlotAxes, manifest, manifestDimension (+10 more)
...
### Community 148 - "Hint"
Cohesion: 0.23
Nodes (12): Hint, gateHint(), Source, intersectSearchFields(), sanitizeSearched(), boolPtr(), fullHint(), keys() (+4 more)
...
Cohesion: 0.07
Nodes (30): EntityAlias, queueFilmSameTitle(), canonicalTable(), nameKeyExpr(), entityConflict(), Repo, mergeEntityLookupErr(), orderPair() (+22 more)
...
### Community 166 - "New"
Cohesion: 0.06
Nodes (76): encoding/xml.Name, NewExtractor(), TestEditionRoundTrip_BothContainers(), TestDownloadImageToTemp_PropagatesFetcherRefusal(), TestDownloadImageToTemp_RefusesNonHTTPS(), TestDownloadImageToTemp_RefusesWithNoFetcherConfigured(), TestDownloadImageToTemp_WritesAllowedBytesToTemp(), withImageFetcher() (+68 more)
...
### Community 171 - "Find"
Cohesion: 0.23
Nodes (15): entityDir(), Ext(), Find(), Path(), Remove(), Store(), TestExt_FollowsBytes(), TestPath_ServerAssignedIDsOnly() (+7 more)
...
### Community 173 - "Video"
Cohesion: 0.14
Nodes (10): filmVideoCandidate, stubFileExtractor, fakeVideoLookup, Handlers, ExtraMetadata, Video, Person, fakeExt (+2 more)

### Community 174 - "scanner_test.go"
Cohesion: 0.15
Nodes (19): TestBuildVideoFromFileForcesExtractWithoutPersisting(), TestExtractionHook(), TestExtractionHook_ErrorDoesNotFailScan(), activeCount(), newFakeRepo(), newTestScanner(), TestChangedFileIsReindexed(), TestReactivatesUnchangedFile() (+11 more)
...
Cohesion: 0.07
Nodes (12): categoryTagIDsBody, Handlers, Handlers, chi.Router, parseCategoryName(), Handlers, chi.Router, validEntityType() (+4 more)
...
Cohesion: 0.04
Nodes (43): ADR-002: SvelteKit chosen as frontend framework (SPA/static-adapter mode), metadata.Extractor Go interface encapsulating tool implementations, ADR-004: layered ffprobe + exiftool + ffmpeg metadata extraction pipeline, ADR-010: MKV (Matroska) Tag-Target Precedence, Consequences, Context, Decision, Rationale (+35 more)

### Community 182 - "ResolvedField"
Cohesion: 0.08
Nodes (26): enrichRoute, relinkContext, FieldCandidate, FieldDecision, Handlers, injectSyntheticFacet(), firstResolvedValue(), queryFieldsFrom() (+18 more)
...
Cohesion: 0.10
Nodes (18): 2026-08-31 · design-handoff artifacts committed, 2026-08-31 · session, 2026-09-01 · code-review high --fix, 2026-09-01 · implementation landed, Gates — definition of done, HOLODEX-303 · Person detail: move bio into the name/photo header row, Session log — append-only (cap: last 8 sessions; older → archive/), Up next — ordered (position = priority) (+10 more)
...
Cohesion: 0.24
Nodes (9): providerInfo, Handlers, providerIconURL(), Find(), Path(), Remove(), Store(), TestStorePNG_ExtensionFollowsBytes() (+1 more)
...
Cohesion: 0.06
Nodes (56): bytes.Buffer, testing.T, gateTestHandlers(), Handlers, TestGateImageURL_MergedField(), attachFilmVideo(), resolvedValue(), seedFilm() (+48 more)
...
### Community 381 - "Sink"
Cohesion: 0.19
Nodes (9): FilmRepo, personRepo, Sink, StudioRepo, ForProvider(), filmImageSourceProvider(), ReplaceFilmImageFile(), ReplaceStudioImageFile() (+1 more)
...
### Community 398 - "Repo"
Cohesion: 0.17
Nodes (24): backfillPersonLinks(), backfillStudioLinks(), main(), newLogger(), promoteEnrichmentAliases(), run(), runHealthcheck(), runMCPStdio() (+16 more)
...
Cohesion: 0.14
Nodes (8): refreshAllResult, resolveCounter, Candidate, ResolveResult, TestSingleStrongMatch(), SingleStrongMatch(), newEnrichRun(), EnrichedField
...
### Community 459 - "Load"
Cohesion: 0.15
Nodes (20): applyEnv(), Defaults(), envBool(), envInt(), envInt64(), envStr(), Config, Overrides (+12 more)
...
### Community 479 - "EnrichmentRow"
Cohesion: 0.13
Nodes (7): ExternalLink, Handlers, TestNamespaceLabel(), namespaceLabel(), SourceURLsFromRows(), EnrichmentRow, Repo
...
Cohesion: 0.26
Nodes (15): sendTok(), deleteServer(), TestDeleteEndpointsGated(), TestDeleteNotFoundPaths(), TestPurgeNowEndpoint(), TestSoftDeleteRestoreFlow(), doJSONTok(), reviewServer() (+7 more)
...
Cohesion: 0.07
Nodes (19): curationBody, Handlers, chi.Router, validateCurationBody(), validCurationAction(), decodeJSON(), Handlers, chi.Router (+11 more)
...
Cohesion: 0.09
Nodes (17): Decision, Film banner landscape guard — design handoff, Not in scope, QA, What the owner sees, 2026-07-10 · what happened this session, 2026-08-04 · Full epic delivered end-to-end and merged, Gates — definition of done (+9 more)
...
Cohesion: 0.15
Nodes (27): aliasList(), aliasServer(), TestAddAliasConflict409(), TestAliasEndpointsGatedAndValidated(), TestGetPersonIncludesAliases(), TestMergeEndpoint(), TestPersonDetail_AliasSourceAndSkipped(), hintServer() (+19 more)
...
### Community 589 - "Repo"
Cohesion: 0.19
Nodes (6): ExtractionCandidate, SplitJoined(), ExtractionQueueRow, Repo, ExtractionCandidate, ExtractionReviewRow
...
Cohesion: 0.17
Nodes (14): net/url.Values, movieThumbURL(), rankConfidence(), slugify(), splitID(), TestSlugifyConcurrent(), TestTMDBMovieURL(), tmdbEntityURL() (+6 more)
...
Cohesion: 0.20
Nodes (5): EnrichQueueProviderState, Handlers, EnrichQueueRow, Repo, EnrichQueueProviderState
...
Cohesion: 0.13
Nodes (23): buildCompanyEnrichResponse(), buildEnrichResponse(), buildMovieEnrichResponse(), buildPeopleCredits(), headshotFor(), TestBioTrimAtSentence(), TestBuildEnrichResponseCapsAt20(), TestBuildEnrichResponseFallsBackToProfilePath() (+15 more)
...
### Community 661 - "Lookup"
Cohesion: 0.24
Nodes (4): Handlers, chi.Router, Lookup(), TestCriticality()

### Community 662 - "Design Handoff: Candidate thumbnail in the Enrich picker (HOLODEX-406 / F64)"
Cohesion: 0.20
Nodes (10): Content spec, Design Handoff: Candidate thumbnail in the Enrich picker (HOLODEX-406 / F64), Edge cases, Implementation notes, Keyboard and accessibility, Non-goals, Overview, Placement (+2 more)

### Community 663 - "Design Handoff: Candidate slot shape per entity kind (HOLODEX-414)"
Cohesion: 0.20
Nodes (10): Content spec, Design Handoff: Candidate slot shape per entity kind (HOLODEX-414), Edge cases, Implementation notes, Keyboard and accessibility, Non-goals, Overview, Placement (+2 more)
...
### Community 672 - "ADR-012: Resolution Classification — Width-Based Buckets with 10% Tolerance"
Cohesion: 0.22
...
### Community 682 - "Holodex landing page (site/index.html)"
Cohesion: 0.29
...
### Community 683 - "ADR-094: Local development credentials come from the environment, never a repo file"
Cohesion: 0.33
...
## Knowledge Gaps
- **2979 isolated node(s):** `$schema`, `PreToolUse`, `holodex`, `Handlers`, `categoryTagIDsBody` (+2974 more)
...
- **Why does `Canonical Field Registry (operator reference)` connect `Canonical Field Registry (operator reference)` to `ADR-090-two-layer-entity-metadata-management.md`, `Spec: Tag governance & video enrichment (F50)`, `Spec: Holodex Metadata Provider Contract (hand-off, protocol v1)`, `.mergePromotions`?**
  _High betweenness centrality (0.365) - this node is a cross-community bridge._
- **Why does `Lookup()` connect `Lookup` to `.mergePromotions`, `time.Time`, `EnrichedField`, `parseEntityType`, `ResolveFields`, `Handlers`, `ResolvedField`, `writeError`, `Complete`, `AutoRegisterFields`, `Field`?**
