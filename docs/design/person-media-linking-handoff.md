# Design handoff: person & studio link picker + role badge (F39)

**Spec:** [person-media-linking.md](../specs/person-media-linking.md) · **ADR:** [ADR-056](../architecture/ADR-056-person-link-resolved-derivation.md) · **Jira:** [HOLODEX-114](https://whoiskevinrich.atlassian.net/browse/HOLODEX-114)
