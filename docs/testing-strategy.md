...
**Date**: 2026-06-05 (plan) · updated 2026-06-14 (Quick Wins batch: ADR-031/032) · 2026-06-29 (Owner tooling hub F35) · 2026-07-12 (F47 enrichment review workflow, ADR-066) · 2026-07-14 (F48 on-demand metadata extraction, ADR-067) · 2026-07-28 (F49 claimed provider keys, ADR-074) · 2026-07-29 (F50 tag governance & video enrichment, ADR-075) · 2026-07-31 (tag writeback exclusion, ADR-077, HOLODEX-239; tag categories, ADR-078, HOLODEX-240) · 2026-08-01 (tag & category create affordance, HOLODEX-243) · 2026-08-04 (unified nav search live filter, HOLODEX-249, pre-implementation) · 2026-08-05 (F52 owner-mode video editing: commentary field, poster upload, studio placement, file-metadata gating; F40 implementation begins) · 2026-08-05 (F53 two-tier video poster resolution, HOLODEX-253, pre-implementation) · 2026-08-05 (F54 configurable provider search patterns, ADR-080, HOLODEX-254, pre-implementation) · 2026-08-05 (F55 Poster View for the People list page, HOLODEX-255, [design handoff](design/people-poster-view-handoff.md), pre-implementation) · 2026-08-07 (tag detail hierarchy & categories, HOLODEX-259, epic HOLODEX-240) · 2026-08-09 (Entity Completeness Score, F55/HOLODEX-260, ADR-081/082, [design handoff](design/entity-completeness-handoff.md)) · 2026-08-10 (Two-tier field editing model, F56/HOLODEX-268, epic HOLODEX-267, [design handoff](design/two-tier-field-editing-handoff.md), pre-implementation) · 2026-08-11 (Video composite-key collision check, F56.3/HOLODEX-270, [spec](specs/video-composite-key-collision.md), [design handoff](design/video-collision-verdict-handoff.md)) · 2026-08-11 (Studio relationship-edit popover, F56.4/HOLODEX-271, [spec](specs/studio-relationship-popover.md), [design handoff](design/studio-picker-handoff.md)) · 2026-08-13 (Writeback hides the target file tag, HOLODEX-216, parent epic HOLODEX-167, [design handoff](design/writeback-target-visibility-handoff.md)) · 2026-08-16 (Core file-metadata fields manually editable + writable, HOLODEX-115, epic HOLODEX-167: `overview`'s `long_text` branch now renders `SourceBadge` like every other replace field; the bespoke `commentary` field (F52) is retired — a system owner maps whatever they want the file's Comment tag to mean via `metadata-mappings.yaml`, not a hardcoded facet) · 2026-09-02 (alias collapse, ADR-088/HOLODEX-306 — provider `also_known_as` values become real `entity_aliases` rows; plan written ahead of implementation) · 2026-09-04 (F59 film provider enrichment, ADR-089) · 2026-09-06 (Fire-and-forget writeback, ADR-091/HOLODEX-323, [spec](specs/fire-and-forget-writeback.md), pre-implementation — supersedes **ADR-073 D4 only**; the D1/D2/D3 rows below stand) · 2026-09-09 (geometry assertion harness, HOLODEX-349/epic HOLODEX-342 — see §12; first automated frontend coverage of rendered layout, and the regression mechanism for the stress fixture) · 2026-09-10 (Manage split button, HOLODEX-362, [design handoff](design/manage-split-button-handoff.md) — destructive-action hierarchy on the media detail page; verified by the §5 computed-token method, **not** the §12 geometry harness, per §12.2's colour/focus exclusion) · 2026-09-10 (Media detail stage layout, HOLODEX-363, [design handoff](design/media-detail-stage-layout-handoff.md) — File joins the enrichment group, More-with shelves break `max-w-stage`, visitors regain read-only field values, overview moves to the rail; the geometry harness gains an `lg` (1024) width cell, a `visitor-view` preparation and two assertions, one of which caught a real clip on the first live check — see §12.4) · 2026-09-11 (Structured resolve hints, ADR-095/HOLODEX-367, [spec FR6–FR9](specs/configurable-provider-search-patterns.md), [contract §4.10](specs/metadata-provider-contract.md), [design handoff](design/structured-resolve-hints-searched-caption-handoff.md), pre-implementation — extends the F54 rows below; the F54 §5 row's "optional P1 caption" clause is superseded by the `searched[]` caption row) · 2026-09-13 (F61 `candidates[].detail`, HOLODEX-380, [spec](specs/candidates-detail.md), [contract §2.3/§5](specs/metadata-provider-contract.md), [design handoff](design/candidates-detail-handoff.md), [QA checklist](design/candidates-detail-qa-checklist.md) — written **after** implementation, reconciling the checklist with what could actually be automated: the §4 and §5 rows below, one new §12 assertion that was mutation-tested on the way in, and the harness-less component items recorded as live `[agent]` measurements) · 2026-09-18 (Writeback dialog as cockpit, HOLODEX-400, [design handoff](design/writeback-cockpit-handoff.md) — pure row-class/decision helpers under Vitest, chooser + focus behaviour live-verified; see the §5 row) · 2026-09-19 (Poster row as an image-tile chooser + ledger-witnessed image sync, HOLODEX-403, [ADR-101](architecture/ADR-101-ledger-witnessed-image-sync.md), [design handoff](design/writeback-poster-chooser-handoff.md) — resolver/repo witness under Go test, cockpit helpers under Vitest, tiles live-verified end to end; see the §5 row) · 2026-09-19 (Provider traffic contract + entity refresh sweep, F66, [ADR-103](architecture/ADR-103-provider-traffic-contract-and-enrich-sweep.md), [design handoff](design/entity-refresh-sweep-handoff.md) — pacer/pause/breaker/sweep under Go test on a fake clock, `sweepLine` under Vitest, the UI live-verified on three skins against a real TMDB sweep; see the §4 and §5 rows)  
**Date**: 2026-06-05 (plan) · updated 2026-06-14 (Quick Wins batch: ADR-031/032) · 2026-06-29 (Owner tooling hub F35) · 2026-07-12 (F47 enrichment review workflow, ADR-066) · 2026-07-14 (F48 on-demand metadata extraction, ADR-067) · 2026-07-28 (F49 claimed provider keys, ADR-074) · 2026-07-29 (F50 tag governance & video enrichment, ADR-075) · 2026-07-31 (tag writeback exclusion, ADR-077, HOLODEX-239; tag categories, ADR-078, HOLODEX-240) · 2026-08-01 (tag & category create affordance, HOLODEX-243) · 2026-08-04 (unified nav search live filter, HOLODEX-249, pre-implementation) · 2026-08-05 (F52 owner-mode video editing: commentary field, poster upload, studio placement, file-metadata gating; F40 implementation begins) · 2026-08-05 (F53 two-tier video poster resolution, HOLODEX-253, pre-implementation) · 2026-08-05 (F54 configurable provider search patterns, ADR-080, HOLODEX-254, pre-implementation) · 2026-08-05 (F55 Poster View for the People list page, HOLODEX-255, [design handoff](design/people-poster-view-handoff.md), pre-implementation) · 2026-08-07 (tag detail hierarchy & categories, HOLODEX-259, epic HOLODEX-240) · 2026-08-09 (Entity Completeness Score, F55/HOLODEX-260, ADR-081/082, [design handoff](design/entity-completeness-handoff.md)) · 2026-08-10 (Two-tier field editing model, F56/HOLODEX-268, epic HOLODEX-267, [design handoff](design/two-tier-field-editing-handoff.md), pre-implementation) · 2026-08-11 (Video composite-key collision check, F56.3/HOLODEX-270, [spec](specs/video-composite-key-collision.md), [design handoff](design/video-collision-verdict-handoff.md)) · 2026-08-11 (Studio relationship-edit popover, F56.4/HOLODEX-271, [spec](specs/studio-relationship-popover.md), [design handoff](design/studio-picker-handoff.md)) · 2026-08-13 (Writeback hides the target file tag, HOLODEX-216, parent epic HOLODEX-167, [design handoff](design/writeback-target-visibility-handoff.md)) · 2026-08-16 (Core file-metadata fields manually editable + writable, HOLODEX-115, epic HOLODEX-167: `overview`'s `long_text` branch now renders `SourceBadge` like every other replace field; the bespoke `commentary` field (F52) is retired — a system owner maps whatever they want the file's Comment tag to mean via `metadata-mappings.yaml`, not a hardcoded facet) · 2026-09-02 (alias collapse, ADR-088/HOLODEX-306 — provider `also_known_as` values become real `entity_aliases` rows; plan written ahead of implementation) · 2026-09-04 (F59 film provider enrichment, ADR-089) · 2026-09-06 (Fire-and-forget writeback, ADR-091/HOLODEX-323, [spec](specs/fire-and-forget-writeback.md), pre-implementation — supersedes **ADR-073 D4 only**; the D1/D2/D3 rows below stand) · 2026-09-09 (geometry assertion harness, HOLODEX-349/epic HOLODEX-342 — see §12; first automated frontend coverage of rendered layout, and the regression mechanism for the stress fixture) · 2026-09-10 (Manage split button, HOLODEX-362, [design handoff](design/manage-split-button-handoff.md) — destructive-action hierarchy on the media detail page; verified by the §5 computed-token method, **not** the §12 geometry harness, per §12.2's colour/focus exclusion) · 2026-09-10 (Media detail stage layout, HOLODEX-363, [design handoff](design/media-detail-stage-layout-handoff.md) — File joins the enrichment group, More-with shelves break `max-w-stage`, visitors regain read-only field values, overview moves to the rail; the geometry harness gains an `lg` (1024) width cell, a `visitor-view` preparation and two assertions, one of which caught a real clip on the first live check — see §12.4) · 2026-09-11 (Structured resolve hints, ADR-095/HOLODEX-367, [spec FR6–FR9](specs/configurable-provider-search-patterns.md), [contract §4.10](specs/metadata-provider-contract.md), [design handoff](design/structured-resolve-hints-searched-caption-handoff.md), pre-implementation — extends the F54 rows below; the F54 §5 row's "optional P1 caption" clause is superseded by the `searched[]` caption row) · 2026-09-13 (F61 `candidates[].detail`, HOLODEX-380, [spec](specs/candidates-detail.md), [contract §2.3/§5](specs/metadata-provider-contract.md), [design handoff](design/candidates-detail-handoff.md), [QA checklist](design/candidates-detail-qa-checklist.md) — written **after** implementation, reconciling the checklist with what could actually be automated: the §4 and §5 rows below, one new §12 assertion that was mutation-tested on the way in, and the harness-less component items recorded as live `[agent]` measurements) · 2026-09-17 (F64 `candidates[].image_url`, HOLODEX-406, [spec](specs/candidates-image.md), [contract §2.3/§5/§6](specs/metadata-provider-contract.md), [design handoff](design/candidates-image-handoff.md), [QA checklist](design/candidates-image-qa-checklist.md) — the candidate thumbnail rides ADR-056's `assetHostAllowed` gate as one more caller, so the riskiest-assumption test is a 16-row sanitizer table plus a mutation-tested service round-trip; the picker slot re-based the F61 row assertion to an equality and, because the 60px slot now masks the `py-1` mutation, split the text-block height out into its own assertion; a third asserts every slot is 40 wide, which is the x-offset parity the harness can express without a cross-element metric)   · 2026-09-18 (F65 completeness score v2, HOLODEX-412, ADR-099, [design handoff](design/completeness-ring-badge-handoff.md) — required-band score + separate extras, trigger-invalidated materialized store, ring badge) · 2026-09-20 (F65.8 ring button, HOLODEX-435, [spec F65.8/RD9](specs/entity-completeness-score.md), [design handoff § F65.8](design/completeness-ring-badge-handoff.md) — the ring fires the single-entity sweep step and re-reads its own bands; one new owner-gated read under HTTP test, the button's pure helpers under Vitest, the four hoisted mounts live-verified by hit-testing since `web/` has no component harness; see the §4 row) · 2026-09-20 (F68 person hover card, HOLODEX-431, [spec](specs/person-hover-card.md) R1–R8, [design handoff](design/person-hover-card-handoff.md) — one new public read under HTTP test, the placement maths under Vitest pinned to the OQ1 probe, the chip's open/close/focus/single-open/clamp contract live-verified across four surfaces; see the §4 row)
...
| **Page-level writeback wait has no time cap** (HOLODEX-419, spec R2.5a, `web/src/lib/writebackJob.test.ts`) | Unit + live | `waitForVideoWriteback` with `timeoutMs: Infinity` (the media detail page's call) keeps polling past `JOB_POLL_TIMEOUT_MS` until the status settles — 40 pending answers under fake timers, ~167 s of backoff clock, 41 fetches; mutation-checked: the default cap resolves `{pending: true}` at ~30 fetches and fails the assertion. The defect it pins: the page's `$effect` returned on a timed-out (`pending: true`) result without reloading or re-arming, and nothing else re-runs the effect, so a write slower than 120 s (every multi-GB MKV without `mkvpropedit` — copy + full ffmpeg remux) left *writing to file* + *out of sync* and a stale poster until a manual reload. Reproduced and re-verified live on `backend-amv` by shrinking the helper cap to 400 ms: before the fix two poll ticks then silence while the server reported `pending:false`; after it, seven ticks, badge cleared, poster `?v=` advanced | 100% |
...
| **Job-run dismissals** (ADR-100, [spec](specs/job-history-digest-and-search.md) P0-7, HOLODEX-416) | Unit + Integration | `job_runs` stays an insert-then-prune audit table: a dismissal is a `job_run_dismissals` row, never an `UPDATE`. `TestDismissJobRun_DigestAndHistory` — dismissing a kind's **newest** error leaves `runs` at 2 and `errors` at 1 (triage, not erasure), `last_status` **still reads `error`** and `last_dismissed` is true (handoff D5 — the digest never shows an older `ok` for a kind whose latest run failed), the failure list drops to the older undismissed run, history returns all three with `dismissed_at` on exactly one; a **fresh failure an hour later** is a new undismissed run — `errors` 2, `last_dismissed` false, it heads the failure list — the owner's "I only care about failures after dismissal" pinned as the load-bearing case. Double dismiss, an `ok` run and an absent id are all `false, nil` (`INSERT OR IGNORE … SELECT` guarded on `status`), never an error. `TestDismissJobFailures_WindowAtRequestTime` — bulk dismiss counts only rows it wrote (an already-dismissed run is not re-counted), touches no `ok` run, is `0` on repeat, and a failure recorded **after** the call is not in it (no client id list; the window is evaluated server-side from the rows that exist). `TestPruneJobRuns_CascadesDismissal` — a dismissed run back-dated past the window is swept by `PruneJobRuns` and its dismissal goes **with it through the FK** (`ON DELETE CASCADE`, no code at either sweep site); the test doubles as the guard that `foreign_keys(ON)` stays on the DSN, since the cascade does not exist without it. `last_dismissed` rides the same bare-column-with-`MAX(started_at)` rule as `last_status`, so the test asserts **both** from the newest-run case — a rewrite of that query (say to a window function) must not break one silently. HTTP (`TestDismissJobRuns_OwnerGatedAndIdempotent`): both `POST` routes 401 without the token; row dismiss `{dismissed:true}` then `{dismissed:false}` (200, never 409); dismiss all `{dismissed:n}`; the digest afterwards excludes what was dismissed while history still carries it | ~90% |
| **Page-level writeback wait settles on an HTTP-status refusal** (HOLODEX-420, spec R2.5b, `web/src/lib/writebackJob.test.ts`) | Unit | `waitForVideoWriteback` answers a status fetch that throws with an HTTP `status` (404: video trashed / re-indexed mid-write; 5xx) by **resolving** the not-pending zero value after that one fetch — not the last-known `pending: true` (which would tell the page to do nothing) and not a rejection; mutation-checked: restoring the rethrow fails exactly this case. The defect it pins is in the caller, which no page harness can exercise: the media page chains guard-clearing + `reloadDetail()` onto the resolved promise with no `.catch`, so a rejection left `pollingGeneration` set for the page's lifetime and every later `reloadDetail()` that came back `pending: true` returned without re-arming the poll — *writing to file* until navigation. Fixing the helper's contract (its doc already promised "never throws"; the page is its only caller) makes the rejection path unreachable rather than handled; the page additionally applies the settled state before the reload so a reload that fails (the same 404) cannot leave the badge on the stale pending object | 100% |
| **Provider traffic contract + entity refresh sweep** (F66, [spec](specs/entity-refresh-sweep.md) RD7–RD9 / P0-2…P0-4 / P0-8, [ADR-103](architecture/ADR-103-provider-traffic-contract-and-enrich-sweep.md), HOLODEX-421; `internal/enrich/pacer_test.go`, `refresh_pair_test.go`, `sweep_test.go`, `internal/api/enrich_review_test.go`, `providers/tmdb/tmdb_test.go`) | Unit + Integration | **Pacer on a fake clock** (`pacer_test.go`, injected `now`/`sleep` — D5): the default `2 req/s` burst `4` admits four at once and makes the fifth wait exactly one token interval (500 ms); `setLimit` adjusts the *live* bucket (after a drain at 2/s, `SetLimit(10/s)` puts the next token 100 ms away — never a re-created limiter); a pause returns `*ErrProviderPaused{provider, remaining}` **immediately with zero sleeps** (the load-bearing D2/D4 assertion — the pacer never sleeps through a pause), a shorter pause never cuts a longer one, and a cancelled context hands its reservation back (the next caller waits one interval, not two). `RateLimit.Normalize` is table-driven over the contract's §4.13 rules (zero key → default for that key; `0.01 → 0.1`, `500 → 50`, `1000 → 100` clamped *and* reported; negative → malformed); a tolerant `UnmarshalJSON` pins that a non-object or wrong-typed `/describe.rate_limit` marks the value malformed **instead of failing the whole manifest** (the review finding — `"fast"` or `"burst": 4.5` must not make a provider unusable). `parseRetryAfter` covers absent / `0` / negative / HTTP-date → 30 s and `9000` → 300 s cap. Precedence is a three-tier walk on a real `Store` (`TestRateLimitPrecedence`: undeclared → default; `/describe` `{10, 200}` → `{10, 100}` clamped and logged naming the provider; operator yaml `{1,1}` outranks a `/describe` `{10,20}`; an absent key clears the cache; a malformed object is ignored), and `TestServiceClientIsPacedPerProvider` pins one pacer per provider name shared across clients and never shared across providers. The transport is the only place that reads `Retry-After` (`TestHTTPClient429IsTyped`: `429` + `17` → `errRateLimited{17s}`, absent → 30 s); the paced decorator turns it into the pause + typed error, passes `Describe` through unpaced, and lets every other error through unchanged **without** pausing (`TestPacedClientOtherErrorsPassThrough`). **`RefreshPair`** (`refresh_pair_test.go`, fake + real repo): unlinked single strong match → `auto_applied`, link stored, **both** job runs (enrich + searched) carry the batch id; a linked pair fetched 3 h ago is `stale_skipped` without dialing, `Force` refreshes it, 25 h ago refreshes on its own; a dismissed pair is `dismissed` with zero calls (F47 RD4 inside the sweep); two strong candidates → `needs_review` and nothing stored; a `429` on the apply is `failed` **with the typed error intact**, the resolve is still recorded under the batch, and the now-paused bucket fails the next linked refresh fast — proved by clearing the fake's error so a dial *would* have succeeded. **Sweep runner** (`sweep_test.go`, injected sleep): two seeded people → summary `person / 2 / linked 1 / no_candidates 1` with one `enrich-sweep` row plus ≥ 2 `enrich` rows under one batch and the P0-4 `Detail` line verbatim; a second non-forced sweep skips the just-linked pair (`stale_skipped 1`), a forced one refreshes it; `TestSweepSingleFlightAcrossKinds` holds a sweep mid-flight behind a gated fake and pins `started:false, err:nil` for the **other** kind and for a second of the same kind, with `Status()` reading `running / person / total 1 / done 0`; a dead provider (`502` on every resolve) fails exactly `breakerFailures` (5) pairs then skips the rest with `skipped_providers = [{fake, stopped responding}]`; a studio-only provider is never dialed for a people sweep (`TestSweepSkipsProvidersThatDoNotSupportTheKind`, P0-2); a `429`-answering provider is waited out **once per pair** (`slept` has exactly `breakerPauses` entries), each pair fails on the second pause, and the third pause trips the `rate-limited` breaker. Two review findings are pinned by test: `skipped_providers` serialises as `[]` never `null` after `Status()`'s copy, and a shutdown `context canceled` does not count toward the breaker. **API** (`enrich_review_test.go`): `TestEnrichRateLimitedFailsFast` — `/enrich/resolve` on a `429`-answering fake is `503` with body `{error: "fake is rate-limiting — try again in 42 s", retry_after: 42}` and the `Retry-After` header; the paused bucket then answers `503` **without reaching the provider** (a `LastHint` sentinel — `Calls` is not usable because `/describe` is unpaced and counts); refresh-all while paused is `200` with one `rate_limited` row. `TestEnrichSweepEndpoint` — `401` without a token, `404` for `/sweep/films`, `202 {started:true}`, poll `/admin/activity` to `sweep.state idle` with `last_run{kind person, total 1, linked 1, batch_id}`, `history?batch=` returns only that batch, `library.studios` present. **Sidecar** (`TestRateLimitedPassThrough`): an upstream TMDB `429` is `429` + `Retry-After` on both `/resolve` and `/enrich` — `17` forwarded, absent / HTTP-date → `30`. Standing gap: the breaker and the pause are unit-tested against fakes; handoff QA item 8 (a fixture sidecar answering `429 Retry-After: 120` end to end) and item 11 (stop a sidecar mid-sweep) are still open — filed in the worklog, not the doc | ~90% |
| **Clear / Dismiss report a prior writeback** (HOLODEX-370, [spec](specs/enrichment-review-workflow.md#api)) | Integration | `TestVideoClearAndDismissReportWrittenBack`: `DELETE /media/{id}/enrich/{provider}` and `POST …/dismiss` answer `200 {written_back}` — false with no audit rows; **still false** with rows from another provider, a same-prefix lookalike (`fakery:` vs `fake:`), `manual` and `revert` sources (the attribution is an exact `<provider>:` prefix, not LIKE); true on both once one `fake:` row exists; undismiss stays 204. Person and film dismiss assert `written_back:false` (no file). Detection only — no revert is triggered, by design (a batch can hold several sources; per-provider revert would need per-field snapshots) | ~95% |
...
| **Structured resolve hints — opt-in `hint.fields`/`hint.filename`/`hint.query_source`, residue rule, `searched[]`** (ADR-095, HOLODEX-367/368, F54 FR6–FR8, planned) | Unit + Integration | **Manifest gate (D1)** — golden: a provider whose `/describe` has no `resolve_hints` receives a `POST /resolve` body **byte-identical** to the ADR-080 golden above (the request grows only for a provider that asked); `["fields"]` adds `hint.fields` only, `["filename"]` adds `hint.filename` only, either adds `hint.query_source`; unknown list entries ignored. **Operator deny** — `Source` deny flag set ⇒ `hint.filename` **absent** (not `""`), `hint.fields` unaffected; unset ⇒ present (default allow asserted explicitly, since an inverted default would pass every "present" test with the flag set). **`hint.fields` (D2)** — keys = the five search fields (`title`/`studio`/`actors`/`director`/`release_date`) ∩ the provider's advertised `fields` (a video with resolved `actors` and a provider advertising only `title`/`studio` never sees `actors`; a provider advertising `overview`/`homepage`/`external_provider_id` never receives them however the video resolves — the security-review finding, asserted with a provider that advertises all of §4.2a); values are the **resolved** slice — a standing ADR-051 decision preferring provider X's `studio` changes the value sent; multi-valued fields carry every surviving value (no `performersCap`); `/enrich`-shaped `{key: [values]}`; sent as-is (a title with brackets arrives with brackets — no sanitizer on `fields`); omitted when the intersection is empty. **`hint.filename` (D3)** — `filepath.Base(v.FilePath)` verbatim: extension, brackets, parens and commas intact; a path with three directory components yields a value with **no** separator; never the sanitized form. **`hint.query_source` (D4)** — derived in `enrichVideoResolve` by re-rendering `BuildQuery` from the same resolved slice: equal ⇒ `"pattern"`, one-character edit ⇒ `"user"`, the sanitized-title floor ⇒ `"pattern"`, a client-supplied `query_source` in the request body **ignored**, a field edited between render and submit ⇒ `"user"`; batch path always `"pattern"`. **Residue rule (D5)** — table-driven in `query.go`: title exactly studio + performers + date ⇒ `{title}` renders **empty** and the pattern still renders from the other tokens (required `{title}` does **not** fall the tier through — assert the render, not the floor); any residue ⇒ the **whole** title kept, duplication included (all-or-nothing, never a rewrite to the residue); case folding; each date-token shape (`YYYY`, `YYYY-MM-DD`, `YY.MM.DD`, `DD.MM.YY`); a non-ASCII word is residue; strips against **all** resolved performers (actors + director), not the `{performers}` top-3; **pattern-aware** — `{title} {year?}` keeps the studio/cast words (no token in that tier said them), `{studio} {title}` keeps a title whose only residue is the cast; floor tier untouched; `hint.fields` untouched. **Both paths (D8)** — refresh-all across two providers with different patterns sends two different `hint.query` strings each with its own opted-in keys, asserted inside the fan-out (the ADR-080 AI5 shared-hint regression guard). **`searched[]` ingest (D6)** — >10 entries ⇒ first 10 kept; an entry >4096 chars truncated; control characters stripped and newlines rejected (the `candidates[].label` treatment); empty-string entries dropped; missing key ⇒ nil, not empty slice; on the batch path the entries land in `job_runs.detail` as `searched: a · b` with **no** `/` or `\` anywhere in the appended text | ~95% |
| **`candidates[].detail` — ingest, caps, unattended audit segment** (F61, HOLODEX-380, spec FR1/FR2/FR5, contract §2.3/§5; **shipped 2026-09-13**, `internal/enrich/candidate_detail_test.go` + `internal/api/enrich_hints_test.go`) | Unit + Integration | **Sanitizer** (`sanitizeDetail`, table-driven): > 8 entries ⇒ first 8; an entry > 256 bytes cut **on a rune boundary** (a 2-byte rune straddling byte 256 is dropped whole, never split into invalid UTF-8 — asserted with `utf8.ValidString` on every output); control characters stripped, `\n`/`\r` collapsed so one entry is one rendered line; blank entries dropped; nil ⇒ nil and `[]` ⇒ nil (the client never sees an empty list — asserted on the marshalled JSON: no `"detail"` key). **Wire ingest** — one candidate with `detail` reaches the caller sanitized and in provider order while its `label`/`disambiguation`/`profile_url`/`confidence` are untouched; a sibling with `[]` and one with no key both decode to nil. **Unattended audit (FR5)** — `RecordSearched(…, applied *Candidate)`: written when `searched[]` **or** an applied candidate's `detail` is present (today's no-op on empty `searched[]` is narrowed, asserted on the detail-only case); format `… (N candidates) · searched: … · applied: <label> — <line> · <line>`; a `needs_review` outcome (two equal candidates) adds no `applied:` segment; an applied candidate **without** `detail` and no `searched[]` writes no entry (unchanged from today). **`applied:` only after a successful apply** — a lone strong candidate whose `/enrich` then fails (`Fake.EnrichErr`) leaves a resolve entry with `searched:` only plus the enrich job's own `(failed)` entry, never `applied:` (the `/code-review` finding on the first cut, which logged before `Enrich` ran). No `/` or `\` anywhere in the appended text. `Fake` gains per-record `Detail` and the `EnrichErr` knob so both paths are drivable from `internal/api` | ~95% |
| **`candidates[].image_url` — host gate, wire shape, sidecar rendition** (F64, HOLODEX-406, spec FR1/FR2/FR4, contract §2.3/§5/§6; **shipped 2026-09-17**, `internal/enrich/candidate_image_test.go` + `internal/api/enrich_hints_test.go` + `providers/tmdb/tmdb_test.go`) | Unit + Integration | **Sanitizer** (`sanitizeImageURL`, 16-row table — the feature's riskiest-assumption test, that the allowlist is the whole perimeter): base host over http kept; an `asset_hosts` entry over https kept; the same entry over **http** cleared (checkHost's https-off-base rule); foreign host, suffix spoof of the base host and prefix spoof of the asset host cleared; `ftp:`, `javascript:`, `data:`, protocol-relative, relative, malformed (`http://[::1`), empty, whitespace cleared; a control character stripped and the remainder allowed; over `maxFieldLen` **cleared, not truncated** (a truncated image URL is never useful — this is the one place the candidate sanitizers diverge from `label`'s truncation). **Gate is the existing one**: `sanitizeImageURL` calls `assetHostAllowed`, the function `Service.ImageURLAllowed` (ADR-056's render gate) wraps — one allowlist, one more caller; `sanitizeCandidates` now takes the provider `Source` to reach it. **Service round-trip** (`TestServiceResolveGatesImageURL`, `Fake` with `FakePerson.ImageURL`): own-host image round-trips unchanged; foreign host arrives cleared with `label`/`profile_url` intact; absent stays absent. **Mutation-tested**: with the `sanitizeImageURL` step removed the foreign-host row fails. **Wire** (`TestEnrichVideoResolve_ImageURLGatedOnTheWire`, `hintServer`): the JSON carries `image_url` for the own-host candidate and **no key** for the foreign-host one (`omitempty` after clearing — never `""`, which the picker would otherwise have to special-case). The person, film and studio handlers pass `res.Candidates` through identically, so the video handler is the wire proof for all four. **Sidecar** (`TestTMDBResolveImageURL`): person search + by-id, movie search (with poster → `w185` URL; without → key absent, asserted on the marshalled JSON), studio search — `tmdbThumbURL` is `w185`, never `original`; `tmdbPerson`/`movieSearchEntry` gained the `profile_path`/`poster_path` fields the search structs never decoded. Regression: the existing candidate-sanitizer rows for `label`/`disambiguation`/`profile_url`/`detail` unchanged |
...
| **Detail-read cast poster version** (HOLODEX-415, `internal/repo/person_images_test.go`) | Integration | `TestDetailCastPosterVersion`: `GetVideo`'s `people[]` and `FilmCast` carry `poster_version` exactly as `ListPeople` does — `0` with no poster, the image id once one is inserted, and **advancing on a replace** (asserted as a strictly new id). The regression this guards: `PeopleGrid` built a versionless poster URL for the media/film Cast grids, and the image route's `immutable` cache pinned the first poster forever | 100% |
| **Video image URL token = image file mtime** (HOLODEX-415, `internal/api/video_poster_test.go`) | Integration | `TestMediaImageURLsVersionOffImageFileMtime`: `thumbnail_url`/`poster_url` carry the served **image file's** mtime (nanoseconds) as `?v=`, not the video's — no file yet → falls back to the video mtime; the file appearing changes the token; an overwrite **inside the same second** (`os.Chtimes` +500ms) still advances it (the edge `no-cache` + `If-Modified-Since` cannot see: `ServeContent` compares at one-second granularity); a poster file gets its own token while the thumbnail's is untouched, and with no poster file the poster token tracks the thumbnail's exactly as `servePoster` falls back. Mutation-checked: always-fallback `imageVersion` fails at "file existed" | 100% |
| **Completeness queue video row `thumbnail_url`** (HOLODEX-415, `internal/api/completeness_queue_test.go`) | Integration | `TestRemediationQueue_VideoRowThumbnailURL`: a video row in the remediation queue carries the same versioned `/media/{id}/thumbnail?v=` URL the browse grid emits — `completenessForVideos` hands back bare repo rows and the queue used to copy the empty `ThumbnailURL` through, so `CompletenessQueueRow` fell back to the bare route with no cache-buster. Mutation-checked: dropping the `setThumbnailURL` call fails it | 100% |
| **Completeness bands + facet model** (F55/HOLODEX-260 → **v2 F65/HOLODEX-412, ADR-099 D1**, `internal/resolver/complete_test.go`) | Unit | `Complete` returns `Required` / `Extras` (`*int`) — the spec's § Worked examples table pinned **verbatim** as a table test, one case per row: Video A `100/67`, Video B `75/100`, Video C `100/0` (provider-resolved is present — binary tier), Person `0/50`, Studio `null/100` and `null/0` (no critical facet → `null`, never a vacuous 100), plus a video with every critical facet not-applicable → `null/25` (`TestComplete_WorkedExamples`); per-facet payload — tier, `Actionable`+`Provider` on a missing facet with a cached candidate, not-applicable listing, and `Missing()` returning only scored applicable facets with their band (`TestComplete_FacetsAndActionability`); zero missing scored facets → `100/null` with `Actionability` **nil** not `0` (undefined ratio, not a zero one — `TestComplete_NoMissingFacets`); a field with no `registry.FieldDef.Criticality` tag (e.g. `deathdate`) is skipped entirely — unscored, unlisted, both bands `null` (`TestComplete_AllExcludedYieldsNullBands`); a `Computed:true` field (D1's invariant, e.g. `age`) is never scored/listed even if it somehow carries a `computed:` `WinningSource` (`TestComplete_ComputedFieldNeverScored`); a missing **merge** field (RD1 — merge fields carry no `Candidates`) is always non-actionable, since actionability only ever reads a **replace** field's cached candidate list (`TestComplete_MergeFieldMissingIsNeverActionable`); an `optional` facet (F60 RD6, widened by F65 RD4 to twelve demotions) is listed but never scored, never in `Missing()` (`TestComplete_OptionalFacetListedNeverScored`) | 100% |
| **Completeness computation + asset-facet injection** (F55/HOLODEX-260, `internal/api/completeness_test.go`) | Integration | `completenessForVideos` scores the four critical facets against a seeded video — `50/null`, extras `null` because the fixture maps no nice_to_have facet (`TestCompletenessForVideos_ScoresCriticalFacets`); a facet marked not-applicable leaves **both** the band's denominator and actionability's missing count — `67/null` (`TestCompletenessForVideos_NotApplicableExcluded`); person `photo` and studio `branding_image` have no row from the normal `ResolveFields` pass (they're asset-delivered, not field-mapped) and are synthesized via `injectAssetFacet` — asserted present with the correct tier for a person/studio image already on file, and the v2 bands move `0/0 → 100/0` (person: photo is the only critical facet; nationality/alternate_names are optional) and `null/0 → null/100` (studio: branding is the only extra) (`TestCompletenessForPeople_PhotoInjection`, `TestCompletenessForStudios_BrandingImageInjection`) | ~90% |
| **Browse sort/filter + facet summary** (F55/HOLODEX-260, `internal/api/completeness_browse_test.go`) | Integration | `Completeness` sort param is silently ignored (falls back to default order) for a non-owner request, honored for an owner one, on **all three** entity lists (`TestListMedia/People/Studios_CompletenessSort_OwnerGated`); sort actually orders low→high or high→low correctly (`TestListMedia_CompletenessSort_Orders`); the browse "Missing {facet}" filter narrows to entities where that canonical is unresolved (`TestListMedia_MissingFacetFilter`); `GET /completeness/facets` returns the per-facet missing-count summary the filter chip's options are built from (`TestCompletenessFacets`). **v2 (F65):** every one of these now runs through the materialized store — the sort is SQL `ORDER BY` over `entity_completeness`, the filter an `EXISTS` over `entity_completeness_missing`, the summary a `GROUP BY` — so these tests double as the drain's end-to-end proof: the fixture server never calls the drain explicitly, the owner's first list read does | ~90% |
...
| **Completeness store — trigger set** (F65/HOLODEX-412, ADR-099 D4, migration 0049, `internal/db/completeness_triggers_test.go`) | Integration (migration) | The enumerating test the ADR calls for: `completenessInputs` lists every input table with one write each, and each write must leave exactly one `completeness_dirty` row for the owning entity (`TestMigration0049_EveryCompletenessInputDirtiesItsEntity`, 20 subtests); the table list is cross-checked **both ways** against the migration text's `CREATE TRIGGER … ON <table>` set, so an input table can be added neither to the migration without a test row nor to the test without a trigger (`TestMigration0049_TriggerSetMatchesEnumeratedInputs`); the `videos` update trigger fires only on a real change to `title`/`active`/`deleted_at` — a scan-shaped rewrite (`SET title = title, file_size = …`) dirties nothing, a soft-delete dirties the row (`TestMigration0049_VideoUpdateDirtiesOnlyOnScoredColumnChange`); trigger bodies survive the firing statement's conflict clause — an `INSERT OR REPLACE` and an `ON CONFLICT DO UPDATE` upsert against an already-dirty entity neither fail nor duplicate (`TestMigration0049_TriggersSurviveUpsertConflictPolicy`); deleting a `people` row drops its `entity_completeness`, `_missing` and dirty rows (`TestMigration0049_EntityDeleteDropsDerivedRows`); `video_people` / `video_studios` writes flag **both** sides — no person facet reads a link, but listability does, and a person with no active video has no store row, so re-linking must re-flag them (`TestMigration0049_LinkTablesDirtyBothSides`); shadow-table writes for an entity type nothing scores (a film's enrichment, a tag's alias) leave no dirty row at all (`TestMigration0049_UnscoredEntityTypesNeverDirty`) | 100% of the trigger set |
| **Completeness store — repo** (F65/HOLODEX-412, ADR-099 D2/D3/D4, `internal/repo/completeness_test.go`) | Integration | The composite sort over the store is `(COALESCE(required, extras), extras)`: a `null` required band falls back to extras (studio rule, or every critical facet not-applicable), and two entities tied on required break on extras, both directions (`TestListVideos_CompletenessSort_CompositeWithNullFallback`); `DrainCompleteness` hands each dirty `(type, ids)` chunk to the compute callback under `writeMu`, stores what comes back, clears the flags, and an id compute does not return loses its store rows — while `StoreCompleteness` (the detail self-heal) rewrites the row but **never** touches the dirty flag (`TestDrainCompleteness_StoresComputedAndClearsUnscored`); `NamedListFilter`'s missing-facet predicate, id restriction and completeness sort compose with the people list's active-video join (`TestListPeopleFiltered_MissingFacetAndIDs`) | ~90% |
| **Completeness store — list surfaces** (F65/HOLODEX-412, ADR-099 D3–D5, `internal/api/completeness_store_test.go`) | Integration (HTTP) | Every owner list item carries `completeness {required, extras}` on the **default** sort (`25/null`, `50/null`, `100/null` for Bare/Half/Full) and a visitor's items carry no such key — absence, not null (`TestListMedia_CompletenessOnItems_OwnerOnly`); an input-table write (enrichment upsert of a poster) reaches the badge on the next owner read with no restart and no backfill — trigger → dirty → drain (`TestListMedia_StoreRecomputesAfterMutation`); the completeness sort pages in SQL — `limit=2&offset=1` of the ascending order is `[Half, Full]` with `total: 3` (`TestListMedia_CompletenessSort_Pages`); a corrupted store row is rewritten by one detail view — the self-heal (`TestGetMedia_SelfHealsStoredCompleteness`); people and studio items carry the field for the owner only, a person reads `0/0` (photo-only ring) and a studio `null/0` under the completeness sort (`TestListPeopleAndStudios_CompletenessOnItems`); `GET /completeness/facets?entity_type=person` counts come from the missing rows with the band as `criticality` and never offer an optional facet (`TestCompletenessFacets_FromStore`); a visitor read of all three lists never drains — the seeded dirty set and the empty store both survive it, and the first owner read consumes it (`TestListMedia_VisitorReadNeverDrains`) | ~90% |
| **Completeness ring button** (F65.8/HOLODEX-435, spec F65.8 + RD9, `internal/api/completeness_store_test.go`, `web/src/lib/components/completeness/ring.test.ts`) | Integration (HTTP) + Vitest + live `[agent]` | The endpoint the ring re-reads after firing: `GET /media/{id}/completeness` returns the stored bands (`25/null` for Bare) **and drains first** — the seeded dirty set is empty after one summary read, so a ring that just wrote enrichment sees the recomputed row; a visitor is refused by the owner gate; an unknown id is 404 (`TestEntityCompletenessSummary`). No new refresh code is under test because there is none — the press calls the existing `refresh-all` handler, already covered by `TestEnrichRefreshAll_*`. Pure helpers: the button's accessible name puts the action before the reading and switches to "Refreshing" while busy; the busy arc is a fixed quarter lap (`RING_BUSY_ARC === arc(25)` — the animation, not the length, marks it); `bandsAfterRefresh` keeps the list's bands when the re-read fails and takes the fresh ones when it lands (`ring button (F65.8)` describe). **Hoisting is a DOM invariant the harness cannot express**, so it is a live `[agent]` check recorded 2026-09-20 on the films testbed at 1280 px: `document.querySelectorAll('a button.completeness-ring').length === 0` on `/`, `/people` (list, poster, select mode) and `/studios`; the video overlay's rect equals the frame's rect in both layouts (16:9 `208×117`, poster `292×438`) and the chip keeps its 6 px inset and shares the duration pill's 20 px baseline; `elementFromPoint` at the count centre resolves inside the `<a>` (stretched link) and at the ring centre inside the `<button>`; in select mode a ring click leaves the checkbox unchecked while a count click toggles it; a real press on a video moved `75/17 → 100/67` with exactly two requests (`POST …/refresh-all`, `GET …/completeness`), `aria-busy`/`disabled`/`ring-busy-spin` observed mid-flight, no navigation; visitor list carries no `completeness` and the direct read is 401; all three skins resolve the ring's track/arc to their own `--muted`/`--accent` | ~90% of the backend surface; hoisting by live check |
| **Person hover card** (F68/HOLODEX-431, spec R1–R8 + RD1–RD12, `internal/api/person_card_test.go`, `web/src/lib/components/person/personCard.test.ts`) | Integration (HTTP) + Vitest + live `[agent]` | **Endpoint (R5):** `GET /people/{id}/card` on `personDerivedServer`'s pinned clock — `age` is the resolver's derived row (36 for 1990-03-14 at 2026-07-08, never a client subtraction), `nationality` the resolved values, `video_count` from `GetPerson`, `ref` = `person:{id}`; a visitor's card has **no** `completeness` key and no `display_name` when no name decision stands; the owner's carries the ring bands; unknown id 404 (`TestPersonCard`); a person with no birthdate/aliases/links/headshot omits every one of those keys rather than nulling them, and `film_count` is 0 with films disabled (`TestPersonCard_SparseOmitsKeys`). The card reuses `personResolve`, so no new resolve code is under test — the profile's own age/nationality tests cover it. **Placement (R3/RD10, pure):** `placeCard` opens below-start with room, flips above only when the card cannot fit below *and* above has more room, clamps x by the overshoot past the 16 px gutter — the OQ1 probe's numbers pinned verbatim (trigger at 120, 288 wide, 400 px viewport → −24) — never past the left gutter, and counts the 6 px gap in the fit test (6 cases). **Component contract — live `[agent]` on the films testbed 2026-09-20 (no component harness):** nothing opens before 250 ms and the card is there after; leaving closes after 150 ms, re-entering within the grace keeps it; entering a second chip swaps the card (one open, app-wide); Escape closes and returns focus to the link; keyboard focus opens at once (requires `document.hasFocus()` — the pane needs a real click first) with `aria-describedby` set on the consumer's own `<a>`; Tab order inside the card is header → ring → Videos → Films → provider badge; focus leaving the wrapper closes it; a right-column Cast tile's card is clamped (`translateX(−135.8px)`, right edge 1264 at 1280) with no horizontal scroll; two hovers of one person issue one `/card` request; the ring press inside the card fires `refresh-all` → `completeness` → `/card` and the card stays open; the `/search` page rows keep `role="option"` + roving tabindex under the wrapper while the header dropdown mounts zero chips; the visitor's card opens without a ring; under `pointer: coarse` neither hover nor focus mounts a card and the link navigates; three skins resolve the card to their own `--surface/--rule/--accent/--radius`. **Not exercised live:** the film page's billed-absent chips — the testbed's films have no billed-but-absent cast (film enrichment needs review there); same wrapper as the shelf title, left to the human pass on the real library. **Geometry harness rungs (HOLODEX-439, §12.4):** `person-card-no-page-overflow` and `person-card-inside-gutter` open the card under the `person-card-open` preparation on the right-most People tile of the `people >= 25` media pages and assert no horizontal page scroll and a ≥ 16 px right gutter — mutation-tested (clamp removed → all cells fail). The flip-above half (card below a bottom-edge trigger) stays a live check | ~90% of the backend + placement; clamp + no-scroll by harness rung, rest by live check |
| **Provider-link badge projection** (HOLODEX-266, ADR-083, `internal/api/external_links_test.go`) | Integration | `externalLinksForEntity` (the HTTP-layer projection both `getPerson` and `getStudio` call) and `Service.BuildProviderLink`/`verifiedClient`'s link-template persistence are exercised together against a fake HTTP provider, since `persistLinkTemplates` only fires as a side effect of a real provider action (`Resolve`) — a direct repo write would skip the D2 wiring under test. `TestExternalLinks_MultiBadge`: two distinct namespaced ids attached to the same person (via two `ReconcileVideoPeople` calls, additive across namespaces per `attachExternalID`'s `INSERT OR IGNORE`) round-trip as **two** independently namespace-split, labeled, resolved badges (ADR-083 D3, "one badge per stored id, 0..N"). `TestExternalLinks_Studio` mirrors this on the studio wiring with a **mixed** resolved+degraded pair, proving both `externalLinksForEntity` call sites share one projection. `TestExternalLinks_TemplateMismatch` table-drives the degraded state (ADR-083 D2): no `link_templates` declared, a template declared for a different namespace, for a different entity kind, and enrichment disabled entirely (`h.enrich == nil`) — all four yield a **label-only** badge (`url` key omitted, not empty-string or an error), never a broken link. `TestExternalLinks_MalformedIDSkipped` proves a stored external id without a `namespace:id` separator (the column has no format constraint) is silently dropped from the response, not surfaced as a partial/broken entry. `TestExternalLinks_Film` (HOLODEX-393, F63 P0-6) is the third call site on the same projection: a film created via `CreateFilm` with `tmdb:`/`imdb:` ids attached through `AttachExternalID` (the write `Service.Enrich`'s identity step uses) renders a linked `tmdb` pill from a `film`-kind template and a label-only `imdb` pill, and a film with no ids projects no entries — the person/studio `null` contract the page's `?? []` already tolerates, so the year line stays byte-identical. `TestExternalLinks_Video` (HOLODEX-394, F63 P0-7, ADR-098 D4) is the fourth call site and the only one **off** `entity_external_ids`: `externalLinksForVideo` reads the resolver's winning `external_provider_id` (the env now wires a mapping store with `fake:external_provider_id, file:ExternalId` sources so `getMedia` actually resolves it) and runs the same `ProviderLink` precedence keyed on that value's namespace — table-driven over a provider value with a `video` template (linked), a provider value with only its own stored `_source_url` (linked to the stored page, via `SourceURLsFromRows` over the rows `getMedia` already fetched), a stored page under a **foreign** namespace (degraded — RD3 holds on video too), and a file-layer `imdb:` winner with no template (degraded); a video with no value projects `null`, so the header meta row stays byte-identical. **HOLODEX-424 (spec P0-7b)** widens the same table to the second input, the provider match stamped on the video's enrichment rows (`match` column, `want` is now a namespace→url map so cardinality is asserted, not assumed): match only with no field value (linked through the `video` template), match + foreign-namespace file tag (**two** pills), match in the file tag's namespace (one pill, keyed on the resolved value — first wins), match with neither template nor `_source_url` (degraded, never dropped), extraction-style rows with `ExternalID == ""` (`null`), and a **re-match** case that backdates the first match's rows and re-upserts under a new id with a smaller payload — the pill must follow the newest row, not the alphabetically-first leftover (`ORDER BY provider, field_key` would otherwise hand `backdrop_url`'s stale id the dedup). Mutation-checked: dropping the row loop fails three cases, replacing the newest-row rule with first-row-wins fails the re-match case | ~90% |
...
| **Provider-alias collision → review queue** (ADR-088 D5, HOLODEX-306, planned) | Integration | A provider name whose `alias_key` is already held by **another** entity cannot be inserted (`UNIQUE (entity_type, alias_key)`, ADR-061 RD1). Enrich **skips it and still succeeds** — asserted by checking the person's bio/birthdate/photo all landed in the same run, since the real failure mode is one awkward AKA costing an entity its entire enrichment — and inserts the pair into the existing `identity_review_queue` with `variation='provider-alias'` (still written, but **no longer listed** by the Duplicates queue since ADR-108 — see §18), `id_lo`/`id_hi` ordered so the same pair reached from either direction is one row, not two. The alias is **absent** from the enriching entity afterwards; no code path merges the two entities (extends F43's "near-miss never auto-merges" to a second, non-owner-initiated candidate source). A candidate colliding with the **same** entity's existing alias is a plain no-op — no queue row, no error — asserted alongside, so the two collision shapes can never be conflated. The skipped set surfaces on the person and studio detail reads as `skipped_aliases`, **derived from the queue rather than stored per-entity, and returned to the DENIED side only**. The queue row is a pair and reads from both ends, but the panel's sentence ("<name> already belongs to another {noun}") is only true for the entity that was *refused* the name — on the entity that owns it, the same line asserts the opposite of the truth. The side is not stored, so it is derived: the row belongs to the caller when the **other** entity holds `detail`, by canonical name or as an alias, the same two routes `entityConflict` walks. Phrasing it as "the other side holds it" rather than "this side does not" also makes a stale pair silent on both pages once the holder frees the name. `TestSkippedAliasesForEntity` covers both holder routes, the denied side, the holder's silence, and the stale-pair case and that resolving the pair clears the line with no extra bookkeeping, and that a near-miss pair with no `detail` never leaks into it. `TestPersonDetail_AliasSourceAndSkipped` covers the HTTP shape and the owner gate: for a visitor the key is **absent**, not null or empty, so a visitor never learns a collision exists. `TestAliasSourceRoundTrips` pins `source` on both the per-entity and the batch alias read, which are separate SELECTs that could otherwise drift — a dropped `Scan` target would make every provider alias look owner-typed and the badge would simply never render. **A guard the plan missed and the implementation added**: `FlagNearMiss` consults `entity_keep_separate` before queueing, and a provider-alias collision must too — otherwise every re-enrich re-proposes a pair the owner already dismissed, which is F43 RD5's "a kept-separate pair never nags" violated by a source that repeats on a schedule rather than on an owner action (`TestProviderAliasCollisionRespectsKeepSeparate`; the pair is still *skipped*, just not re-queued). **Delivered** as `internal/repo/provider_aliases_test.go` — `TestApplyProviderAliases_{LiveOnArrival,Filters,AdditiveAndIdempotent,Studio,UnknownEntity}`, `TestProviderAlias{SuppressionIsDurable,CollisionQueuesReview,CollisionRespectsKeepSeparate}` — plus `TestEnrich{WritesProviderAliasesToSpine,SurvivesAliasWriteFailure}` (`internal/enrich/enrich_test.go`) for the wiring and its best-effort posture | ~90% |
| **Films on the identity spine — composite key** (ADR-096 D3, F60 RD4/RD5, HOLODEX-376) | Unit + Integration | Film identity is `(lower(trim(name)), year)`, not the name: two same-title films under different years are two rows (`ux_films_namekey` rejects only a same-title **and** same-year duplicate, folded case/whitespace). `CreateFilm` is the one film resolve path (films are never scanner-created) and its routing is the assertion: a title matching another film's canonical name or alias routes there **only** when the year matches, or when no year is given and exactly one film answers to the title; a disagreeing year, or two same-title films and no year, creates a new film and queues a non-fuzzy `same-title` review pair with every same-title film — never a silent fold, and never for a kept-separate pair. A rename onto a same-title/other-year title is free (composite key) but queues the same pair; onto the same title **and** year it is `ErrNameTaken` naming the occupant; a rename keeps the old title as an alias and leaves the year untouched. `DELETE FROM films` clears aliases, suppressions, keep-separate and queue rows (trigger). Provider alternative titles land as `source='provider'` aliases through the same `ApplyProviderAliases` path, with a same-title collision skipped and queued rather than attached. Film merge moves every scene link — a scene number the survivor already uses falls to NULL, never a dropped membership — plus cast roles and the loser's title as an alias. Film refs carry `year` on review pairs and near-miss so two "Dune"s read apart. **Delivered** as `internal/repo/film_identity_test.go` (`TestFilm{CompositeKey,AliasRoutingByYear,AmbiguousNoYearQueues,DeleteCleansSpine}`, `TestRenameFilmKeepsOldTitleAsAlias`, `TestApplyProviderAliases_Film`, `TestMergeFilms`) + `internal/api/film_identity_test.go` (routes under the films gate, 401/409-with-year, merge, dismiss) + `TestBuildMovieEnrichResponse_FilmAliases` (sidecar) | ~90% |
| **Edition as a resolved video field** (ADR-096 D4, F60 RD6–RD8/RD11/RD12, HOLODEX-377) | Unit + Integration | Edition is a file fact on the ordinary resolver: the container tag is the baseline, the F48 filename marker the only candidate, custom the override — no edition-specific resolver code, which the resolver test proves by declaring the field with `stubField` alone. The parser **lifts** the strict Plex `{edition-<text>}` marker out of the stem before pattern matching (RD7): a marked file still matches the library's `^…$` patterns, the marker alone is a match when none fit, text is trimmed with case kept, an empty marker yields nothing, and loose forms (`- Final Cut`) are never parsed. `edition` is `TierHigh`, so a lone filename value (0.30 + 0.50) clears the auto-apply threshold under the existing flag and a tag conflict never does. The write keys are the RD8 evidence pinned as a test: an edition written through `writeback.Write` on a generated MKV **and** MP4 reads back through the scanner's own extractor as bare `Edition` (integration-tagged, skips without ffmpeg/exiftool); `TestExampleMappingCoversWriteTargets` fails if the example ever drops the `Edition` read-back source (ADR-093). The film detail stamps `edition` on full-film rows only, through the same pure resolver as the media page, and `FacetScore.Curatable` is true for plain-text replace fields alone so the media page's deep-linked empty row is never synthesised for an image, long-text or merge field. `edition` is `CriticalityOptional`: the facet is listed (tier, label, `Curatable`) but adds nothing to the weight sum, the missing count, actionability or the remediation queue — a library where most files have no edition must not read as incomplete. **Delivered** as `TestMatchFirst_EditionMarker`, `TestAutoApplyThreshold` (+edition), `TestResolve_Edition_TagBeatsFilename`, `TestMapExiftoolMatroskaLangSuffix` (+`Edition-und`), `TestEditionRoundTrip_BothContainers` (`-tags integration`), `TestGetFilm_FullFilmCarriesEdition`, `TestComplete_CuratableIsPlainTextReplaceOnly`, `TestComplete_OptionalFacetListedNeverScored`. Live-QA'd: filename → candidate → film pill; `+ Set edition` → landing expanded → Custom → decision → pill; `WritebackFormDialog` lists Edition; three skins; visitor sees pills, no link | ~90% |
| **Media parts — `part` as a resolved video field** (HOLODEX-389, [spec](specs/media-parts.md) RD1–RD10, [design handoff](design/media-parts-handoff.md)) — **pre-implementation, target coverage; the edition row above is the template, and every test below is the edition test with the field swapped unless marked *new*** | Unit + Integration (+ Vitest for the one helper) | **Lifter (RD4)**: `liftEdition` generalises to lift both markers, each at most once, in either order; `TestMatchFirst_PartMarker` table-drives `{part-2}`/`{part-02}` → `"2"`, marker-only stem (no pattern fits, still a match carrying only `part`), `{edition-X} {part-2}` and `{part-2} {edition-X}` both yielding both keys, a marker inside a `^…$` pattern still matching, and the four rejected bodies (`{part-2of3}`, `{part-}`, `{part-two}`, `{part-0}`) **left in the stem** so the pattern fails (`wantOK:false`, no `part` key) — plus the mixed case `{edition-X} {part-2of3}` where edition lifts and the part literal stays and breaks the match, proving one bad marker never poisons the other. `TestMatchFirst_EditionMarker` runs **unmodified** as the regression guard on the generalisation. `part` joins `TestAutoApplyThreshold` at edition's tier; **found in build**: the analogy failed at the specificity step — `classifySpecificity` rated a one- or two-digit value *partial*, so a lone marker scored 0.55 and every `{part-N}` file queued a review row — fixed as a general rule (a bare integer is full specificity, `TestClassifySpecificity` +3 rows) and pinned at the routing level by `TestProcess_PartMarker_RoutesLikeEdition` (lone marker → `OutcomeAutoApplied`, no review row; tag conflict → `OutcomeQueued` naming both values); no `part` branch exists in `process.go`/`confidence.go` beyond the tier row. **Resolver (RD6)**: `TestResolve_Part_TagBeatsFilename` declares the field with `stubField("part", false, "PartNumber", "DiskNumber", "filename:part")` alone — tag wins with `file:PartNumber`, two candidates so both chips render, filename-only resolves the ordinal, a manual decision wins. **Extractor**: `TestMapExiftoolMatroskaLangSuffix` gains a `PartNumber-und` row (count 5→6); *new* per OQ1 (extractor recommended) a table over the leading-integer normalisation — `2 of 3`/`2/3` → `2`, bare `2` unchanged, empty stays empty, a non-numeric value passes through untouched — applied to both `PartNumber` and `DiskNumber` and to no other key. **Mapping loader (RD2/RD3, *new behaviour, no precedent* — `parseSources` validates nothing today)**: `TestLoadRejectsProviderPartSource` feeds an inline YAML with `tmdb:part` and asserts `mapping.Load` errors naming `part`; needs a registry-level "file-only" fact on the `part` `FieldDef`, not a string match on the canonical. `TestExampleMappingNoSharedFileSource` parses the shipped `.example` and asserts no `file:` key feeds two fields (RD3's invariant, so a future un-commenting of `episode` cannot silently reclaim `PartNumber`). **Writeback (RD5)**: `TestTagForField` gains `part` → `PART_NUMBER` (Matroska, WebM), `disk` (MP4), `!ok` for mp3/flac; `TestPartRoundTrip_BothContainers` (`-tags integration`, ffmpeg-synthesised samples, skips without tools) writes `"2"` and re-extracts to `PartNumber`/`DiskNumber` == bare `"2"` — the MP4 case is the ADR-093 `in_sync` claim, so it must assert the read-back is **not** `2 of 0`; `TestExampleMappingCoversWriteTargets` extends for free once both read-back keys are in the example. `TestMergeTagsXML` (foreign `PART_NUMBER` survives a Genre write) stays unmodified; *new* `TestMergeTagsXML_ReplacesPartNumber` proves a `part` write **replaces** the existing SimpleTag rather than appending a second — survival and replacement are different invariants. **Completeness (RD7)**: `part` joins `TestComplete_OptionalFacetListedNeverScored` and `TestComplete_CuratableIsPlainTextReplaceOnly` (true). **Payload (RD9, the load-bearing gap)**: `part` is a field on `model.Video` filled by one batch pass on the list path, so cards, `FilmVideo.Video` (scenes *and* full-film rows — unlike edition, which stamps full-film only, because the scenes grid renders `VideoCard`), and queue rows all inherit it. `applyBrowseTitles` passes `extra=nil` and only walks `Browse` fields — today's list path **cannot see a container-tag baseline**, so `TestListVideos_CarriesPart` seeds three videos whose only source is, respectively, a `PartNumber` extra-metadata row, a `filename`-namespace enrichment row, and a manual decision, and asserts each summary row's `part`; the **container-tag-only** case is the one that failed until the list path loaded the file layer — **delivered** as `partsFor`/`applyParts` (`internal/api/parts.go`): one pass per list through the real resolver over `ExtraMetadataForVideosByKey` (a key-scoped variant of the batch loader F55 already had) + `EnrichmentForVideosField` + the existing curation/decision batches, wired into browse, completeness sort, search, related shelves, person/tag/studio pages, film candidates, both queues, and the detail's `video` object; tests are `TestListMedia_CarriesPart`, `TestListSurfaces_CarryPart`, `TestGetMedia_VideoCarriesPart`, `TestGetFilm_CarriesPartOnScenesAndFullFilms`, `TestQueues_CarryPart`, `TestEnrichment_NeverWritesPart`. `TestGetFilm_FullFilmCarriesPart` mirrors edition's; `TestEnrichQueueEntities_VideoCarriesPart` and the extraction-review-row equivalent cover the handoff's "most likely to be forgotten" surface, with a no-part video omitting the key. **Triplet invariance (RD10)**: `TestApplyEnrichment_NeverWritesPart` seeds three videos with distinct tag parts, applies the same fake-provider candidate to all three where the fake's payload **includes** a `part: 9` key, and asserts the provider fields resolve identically while each video's resolved `part` is unchanged — the mapping has no provider source, so the shadow row is inert even if stored. **P1 tiebreak (OQ2, only if built)**: `TestListVideos_TitleSortTiebreakOnPart` inserts same-title videos in reverse part order and asserts ascending part under title-sort, with `v.id` order preserved when no part exists. **Frontend**: Vitest `partBadge.test.ts` — `partBadgeLabel(2)` → `Part 2`, `' 02 '` → `Part 02`, `'two'` → `Part two` (RD8 verbatim, no normalisation in the label). No component harness in `web/`, so the handoff's §2.2–2.4 "smoke" items (card badge inside the `<a>` with no `button` role, edition-before-part pill order, queue pill as `shrink-0` sibling of the truncating link) are **agent live QA**, not automated — run with the §3 computed-style checks (badge/duration rect disjointness at the 8- and 16-column tiers, Brutalist reel-counter clearance, 375px header wrap, ≥4.5:1 contrast) and §4 human items on all three skins; visitor sees every pill and no `#field-part` link or custom chip. **Human pass found two (2026-09-16)**: (1) the `#field-<canonical>` deep-link landing — F60's "+ Set edition" and the new "+ Set part" — had scrolled to a row inside the Metadata fold, collapsed at rest and `inert` while closed since HOLODEX-320, and SvelteKit runs no `afterNavigate` for a same-page hash change, so the page's own "same-page" branch was dead code; every DOM measurement had been fooled because the row exists while clipped — **the QA rule that came out of it: a landing assertion must check `elementFromPoint` hits the row and `document.activeElement` is the input, not that the row exists**; the landing now opens the fold, keys on `$page.url.hash`, opens the Custom input for an empty row and focuses it after SvelteKit's focus reset. (2) header search results carried no part — added to the row's `sub` slot. **Fixtures — two tools, two halves, delivered**: the stress seeder (`testdata/stressseed`, HOLODEX-342) has a `part` dimension (block 1000): rungs `00`/`01`/`02`/`12` seeded as the container tag only — the source the list path never used to load — under one shared title (`ownsTitle`), pinned by `TestPartRungsAreATripletOnOneTitle` (one `PartNumber` row per rung, none on `00`, exactly one title across the dimension, manifest `axes.video.part`) and a `part not mapped at all` refusal case; the seeder's `mappings.yaml` declares `part`. Four geometry-harness assertions (`part-badge-reaches-the-grid`, `part-badge-is-a-real-box` on `/?sort=title_asc`; `part-pill-beside-the-title`, `part-pill-holds-two-digits` on the manifest's part pages) pass across the 3 skins × 3 widths. **Narrowed from the plan**: the handoff's two-rect checks (badge vs duration, badge vs Brutalist reel counter) need a metric the probe does not have — per-element scalars only — so they stay hand-measured (worklog 2026-09-16) rather than pinned; and the source × value matrix was cut to the tag source, since the filename and decision sources are the API tests' job and the seeder has no scanner. The scanner half rides `testdata/demo/generate.mjs`: three "Live at the Observatory" items — two named `{part-N}` (an item `filename` override), one with only the `disc` atom (`-metadata disc=N`; ffmpeg's mov muxer maps `disc`, not `disk`) — scanned by a real backend to parts 1/2/3 with zero errors | ~90% |
| **Display name as a decision on `name`** (ADR-096 D5, F60 RD9/RD10, HOLODEX-378) | Unit + Integration | A decision on `name` is display-only: the three `name` guards are gone and the resolver honours the row with no new code, so the tests pin the *invariants* rather than the mechanism. Person/Studio/Film: a provider or manual decision changes `resolved[name].values[0]` and nothing else — the canonical column and the detail payload's `person.name`/`film.name` stay canonical, and clearing (or confirming `record`) returns the resolved value to canonical. Search matches canonical, display and alias spellings, and its rows carry `display_name` **beside** a canonical `name` (the pickers read the same endpoint and send `name` back for linking); after a clear the display spelling no longer matches and `display_name` is omitted. `repo.DisplayNames` is a narrow SQL mirror of the resolver's decided-replace rule, tested on its own edge cases — manual literal (trimmed), the decided provider's spelling and no other provider's, a decided provider with no stored spelling omitted (the resolver drops the row → canonical), a `file` decision omitted, and film read under the sidecar's `title` key — and pinned to the resolved payload by the API search test. Writeback: a person's display decision never reaches a file — the video's resolved `actors` still carries the canonical spelling and the captured tag write receives it. Film `name` sources are the record baseline first, then one `<provider>:title` per provider (the ADR-089 D3 guard retargeted: it now asserts the shape, since D5 admits the provider spelling as a display candidate while the column stays unwritten). **Delivered** as `TestPersonNameDisplayDecision`, `TestWriteback_PersonDisplayNameNeverReachesFile`, `TestDisplayNames` (repo), `TestFilmFields_NameSourcesAreBaselineThenProviderTitle`, and the flipped `TestFilmFieldDecision` / `TestPersonDecisionAPI_Validation` / `TestStudioDecisionAuth`. No component-test harness in `web/`, so the frontend contract — pencil prefills canonical (`NameEditControl editValue`), the "In files as" line only when resolved ≠ canonical and only for the owner (a visitor sees the heading alone), focus hand-off across the link↔badge swap, three skins, no overflow at 375px — was verified live (handoff QA 3.6) | ~85% |
...
| **Film banner landscape guard** (HOLODEX-386, [spec P0-10a](specs/film-provider-enrichment-ux.md), [design handoff](design/film-banner-landscape-guard-handoff.md)) | Unit + Integration | The guard is one predicate on the dimensions `personimage.Normalize` already returns, applied at both ingest doors, so the tests pin *where it sits* and *what it reports* rather than image decoding. `TestCheckRoleAspect` (`internal/filmimage`): portrait **and square** refused for the banner role, a 501×500 accepted (strictly wider than tall), the poster role accepts anything, and the typed error carries the dimensions. `TestSinkRefusesPortraitFilmBanner` (`internal/imagesink`): a portrait JPEG built at run time under `film`/`banner` returns `*filmimage.PortraitBannerError` and reaches **neither the repo nor disk** (asserted by an empty inserts slice and an empty dir — a guard that ran after the row write would pass a store-count assertion alone); a landscape banner and a portrait poster then both store. `TestEnrichRecordsRefusedFilmBanner` (`internal/enrich`): the recording sink refuses the banner role with the typed error; the run stays `success` with `Errors == 0` (a refusal is not a failure), the poster still stores, and the activity row reads `… · banner skipped: 1000×1500 is portrait, banner role requires landscape` with `Skipped == 1`; the same run with a landscape banner records no skip clause — the second half guards against the note leaking onto every run. `TestFilmImage_BannerRequiresLandscape` (`internal/api`): an 8×8 and a 10×15 upload to `banner` are 400 with `banner refused: <w>×<h> is portrait` in the body and no `ImageVersions[banner]`, then a 16×6 lands 201 and the same 8×8 still lands as a poster. The pre-existing happy path (`TestFilmImage_UploadServeDelete`) now uploads a landscape file for the banner — the first thing the guard broke, which is the evidence it is wired. **Not** in the ingest path, so untouched: the stress seeder (`testdata/stressseed`) writes its wrong-ratio film banner through `ReplaceFilmImageFile` directly, so its 2:3 rung still stages the frame-vs-source mismatch the geometry harness looks for | ~95% |
| **Alpha-preserving normalization** (HOLODEX-396, [ADR-097](architecture/ADR-097-alpha-preserving-image-normalization.md)) | Unit + Integration | The change is one encoder decision at the ADR-038 gate plus an extension that is *derived* rather than stored, so the tests pin the decision and the derivation, not image codecs. `TestNormalizeKeepsTransparencyAsPNG` (`internal/personimage`): a transparent-white PNG with one opaque red pixel comes out as PNG with corner alpha 0 **and** the red pixel intact — the pixel assertion is what proves no background was painted in, the format check alone would not; `TestNormalizeTransparentDownscaleStaysPNG`: the same source through the downscale branch (which rebuilds pixels into a fresh RGBA) still lands as PNG, guarding the case where the alpha decision ran on the wrong image; `TestNormalizeJPEGFlattensTransparency`: the video-poster entry point still emits JPEG from the same transparent source; `TestNormalizeReencodesToJPEG` (pre-existing) now states its input is *opaque*, so an opaque PNG → JPEG is the unchanged baseline. `TestExt_FollowsBytes` + `TestStoreRemove_PNG` (`internal/entityimage`) and `TestStorePNG_ExtensionFollowsBytes` (`internal/providericon`): PNG-signature bytes land at `{id}.png`, `Find` resolves them, no `.jpg` sibling appears, `Remove` clears it and `Find` then reports `os.ErrNotExist` via `errors.Is` (the wrapped error is the contract — `os.IsNotExist` would not unwrap it, which the first draft of the tests found); the opaque round-trip keeps `.jpg` so every pre-ADR-097 file is provably still found. `TestStudioImage_TransparentLogoKeepsAlpha` (`internal/api`): the whole door — a transparent logo upload is 201, `GET` serves `Content-Type: image/png` with corner alpha 0 and the red pixel, delete is 204 and the slot 404s (the `.png` was actually removed). The pre-existing serve tests still assert `image/jpeg` for an opaque upload, so the header is proven to follow the file, not a constant | ~95% |
...
- **A same-title film pair is surfaced, never folded** (F60/ADR-096 D3): the film key is composite, so "Superman II" 1980 and 2006 coexist; the only automatic routing of a title to an existing film is an exact year match or a year-less title that exactly one film answers to — every other same-title case creates and queues a `same-title` pair for the owner. The homonym rule for people, applied to a kind where homonyms are the normal case.
...
- **A provider that did not opt in gets a byte-identical request** (ADR-095 D1): `hint.fields`, `hint.filename` and `hint.query_source` exist on the wire **only** for a provider whose `/describe.resolve_hints` lists them. The contract makes no unknown-key promise for the `/resolve` request body, so this is a wire-compat invariant, not a preference — the golden test is against the ADR-080 request body, and a test that "helpfully" sends the keys to every provider is asserting a contract break.
- **The residue rule is lossless, and rendered-empty is not missing** (ADR-095 D5): `{title}` renders empty **only** when stripping the resolved studio, every performer and any date token leaves no Unicode alphanumeric residue — every dropped word is present from another token by construction. A title with residue is kept **whole**; the rule never rewrites a title down to its residue (that is a lossy guess — decomposition is `hint.fields`' job). And an empty-by-residue `{title}` must **not** trip the required-token fallthrough: if it did, the tier would collapse to the title-only floor and resend exactly the duplication the rule removes. Assert the rendered string, not "the floor was used".
- **`query_source` is derived, never trusted** (ADR-095 D4): the handler re-renders `BuildQuery` and compares; a `query_source` in the client's request body is ignored. A test that sets it on the request and asserts it arrives at the provider is testing a spoofing hole.
- **`hint.fields` is the five search fields and nothing else** (ADR-095 D2, security review 2026-09-11): `title`, `studio`, `actors`, `director`, `release_date` ∩ advertised — never `overview`/`tagline` (owner free text: a file's `Comment` tag, a curated synopsis) and never `homepage`/`external_provider_id`/`poster_url` (which would tell provider A which other providers the owner uses). "∩ advertised" alone is **not** the bound — a provider advertises whatever it likes. The test fixture must advertise every §4.2a key and assert only the five can appear.
- **`hint.filename` is the basename and nothing else** (ADR-095 D3): `filepath.Base`, verbatim — no sanitizer (the stripped grammar is what a filename matcher consumes) and **never** a directory component. A basename is the one input a written-back wrong match cannot poison because Holodex never renames media; a test that "cleans" it up is asserting the ADR-080 D4 behavior on the wrong field.
- **`filename` default is allow** (ADR-095 D1): the operator deny is per-source and opt-out. A fleet default of off would silently cut recall for every provider with a filename matcher, so the "present when the flag is unset" case is asserted explicitly — an inverted default passes every "present when set" test.
- **`applied:` in the activity log means the apply succeeded** (F61 FR5): the unattended resolve entry gains the auto-applied candidate's `detail` lines so a refresh-all that bound the wrong duplicate can be audited — which is worthless if the segment can appear when the apply failed. `RecordSearched` is called **after** `Enrich` with `applied` only on success; the failure path passes nil and the enrich job's own `(failed)` entry carries the failure. The first cut logged before the apply and the review caught it; the failing-apply test is the guard against putting it back.
- **`detail` is presentation, verbatim, and never `[]`** (F61): it is not a field — it never enters `entity_enrichment`, `/enrich` results or writeback (a test that finds `detail` text in the shadow store is a bug, not coverage); the client renders each entry as one line with no `Key:` parsing (P2-a is deliberately unbuilt); and after `sanitizeDetail` a missing key and `[]` are the same nil, so the picker never has to reason about an empty toggle.
- **A collapsed `detail` row costs exactly one actions line** (F61, design handoff): 20 + 16 + 24 + 16 = 76px is the ceiling and the §12 bound. The 24 is the toggle's `py-1` — the owner's call on QA §4.6 (2026-09-13), a real touch target — so the bound's **floor** (70) is as load-bearing as its ceiling: the padding disappearing lands at 68 and fails, the first cut's inline-block-on-the-baseline defect lands at 77 and fails. Both mutations were run. **Re-based 2026-09-17 (F64)**: the 60px thumbnail slot beside the text block makes 76 a floor as well as a ceiling, so the bound is now the equality `[76, 76]` — and the slot swallows the `py-1` mutation (a 52px text stack still sits beside a 60px slot), which is why the text block's own height (60, exact) became a second assertion. Both mutations were re-run: `py-1` dropped ⇒ the text-block assertion fails and the row one passes, as predicted; the bare-`<div>` actions line ⇒ the row lands at 77 and fails.
- **`image_url` is rendered, never fetched, never stored** (F64, spec G2/AC2/AC10): the thumbnail reaches the browser only if its host passes `assetHostAllowed` — the *same* function ADR-056's `render: image_url` field gate calls — and Holodex never dials it (no asset download, no normalize, no `entity_enrichment` row, no `/enrich` echo, no writeback, no activity-log line). A second allowlist, or a server-side fetch "to cache the thumb", is a perimeter change that needs its own review; a test that finds `image_url` in the shadow store is a bug, not coverage. The wire never carries `"image_url": ""` — cleared is absent.
- **The candidate slot is always there, always 60 tall, and one width per picker** (F64, design handoff "Placement"; **HOLODEX-414**: the width follows the entity kind — `w-10` person/film, `w-27` video, `w-30` studio — from `SLOT_CLASS[slotShape(entityType)]`, never an `aspect-*` class): image or monogram, pictured row or not, every `<li>` in one picker starts with the same `aria-hidden` box, so every label shares one x and a collapsed row is never shorter than 76. A slot that grows with its image, collapses on a monogram row, or disappears on a pre-F64 provider shifts that row's text off the column. `object-contain`, not `cover` — a candidate image's aspect is not gated at ingest (`enrichment/CLAUDE.md`), so a wide logo letterboxes rather than crops. The harness asserts the width on every `flood` row; the monogram rows live on `twins` and were measured live (§5).
- **A broken image falls back to the monogram, never to the browser's broken-image glyph** (F64 FR3/AC5): the per-row `failed` map flips the slot on `<img>` `error`, and — like F61's `open` map — it describes the *last response*, so it is reseeded on every response and dropped when the box is edited; a stale flag from a previous response must not hide a good image on the next.
...
- **`required` and `extras` are never combined** (F65/HOLODEX-412, ADR-099 D1): no field anywhere in the payload — detail `score`/`extras`, list `completeness`, the SQL sort — sums, averages or weights the two bands. A test that computes a blended number and asserts it against either key is asserting v1. The ring, the panel headline and the primary sort key are `required`; `extras` is the tiebreaker and the overfill, and the only case in which it stands in for `required` is when `required` is `null`.
- **A band with no applicable facet is `null`, never 100** (F65 § Edge rules): a studio has no critical facet, and a video can have every critical facet marked not-applicable — both must report `required: null`, so the ring draws from `extras` and an empty studio never draws a full ring. A test expecting `100` for "nothing to score" is asserting the lie D1 exists to stop; `TestComplete_WorkedExamples`'s studio and all-not-applicable rows pin this.
- **The migration is the input-table list, and the test is its mirror** (ADR-099 D4): `resolver.Complete`'s inputs are read from twenty tables, and a Go reader of `Complete` cannot see which. `completeness_triggers_test.go` is the only place the two are reconciled — a new input table without a trigger, or a trigger without a test row, fails `TestMigration0049_TriggerSetMatchesEnumeratedInputs`. Do not "fix" that failure by editing the test list alone.
- **The drain runs under `writeMu`; the self-heal never clears the flag** (ADR-099 D4): a write that lands between reading the dirty set and clearing it would be lost if the drain ran outside the lock, so `repo.DrainCompleteness` owns the whole read → compute → write and the API only supplies the compute callback. The detail page's `StoreCompleteness` computes outside the lock, so it may only rewrite the row — a pending recompute is always correct to keep. A refactor that moves the drain back into the API layer, or makes the self-heal delete dirty rows, reintroduces the race `code-review` caught on 2026-09-18.
- **Trigger bodies use `INSERT … SELECT … WHERE NOT EXISTS`, not `INSERT OR IGNORE`**: SQLite lets the *firing* statement's conflict clause override the one written inside a trigger, so an `OR IGNORE` body fired by an `INSERT OR REPLACE` or an upsert aborts the outer write with a UNIQUE failure — the whole repo suite went red on it. `TestMigration0049_TriggersSurviveUpsertConflictPolicy` pins the shape.
- **The drain is best-effort on the list pages; the list is never the casualty** (ADR-099 D4 as implemented): `drainCompleteness` logs and returns on failure, and listMedia / listPeople / listStudios / completenessFacets serve whatever the store holds — a stale ring, or none — rather than a 500 over one entity whose resolve blew up. The ids stay dirty, so the next owner read retries. A test that makes the drain fail must assert the list still returns 200 with the pre-failure rows; asserting a 500 is asserting the bug.
- **A visitor's list item has no `completeness` key** (F65.5): the redaction is by omission (`omitempty` on a nil pointer), never a `null` or a zero-value object, so the card's "render iff the field exists" rule holds without an `isOwner` check anywhere in the frontend. Assert `'completeness' in item` is false, not that the value is falsy.
...
- **A stored provider page backs only its own provider's pill** (HOLODEX-392/ADR-098 D3, F63 RD3): `ProviderLink` looks the `_source_url` row up by `provider = namespace`, so a page TMDB stored can never sit behind the `imdb` pill on the same entity — a foreign namespace is template-or-degraded by construction, with no "which provider enriched this" bookkeeping. The template always wins when declared (policy over data). `_source_url` is validated by the same `validHTTPURL` predicate as `profile_url` and link templates: a hostile scheme is dropped at ingest (and, sent alone, clears the stale row) without failing the enrich; the value is never dialed server-side and never reaches the resolver, field list, claims, promotions, or writeback (`InternalFieldPrefix`).
...
| **Hotkey registry + guard** (`lib/actions/hotkey.svelte.ts`, F62) | Unit | Vitest (`hotkey.test.ts`, node — the guard reads a `KeyLike` shape, not a DOM event) | register/unregister by node; **duplicate key → first wins, one sheet row, one dev `console.warn`, unmounting the first promotes the second**; `rows` sorted by key; RD6 order: `defaultPrevented` → Ctrl/Alt/Meta (Shift allowed) → `INPUT`/`TEXTAREA`/`SELECT`/**`VIDEO`**/`contenteditable` → `?` only when no *other* dialog is open → any dialog (incl. the sheet) silences page keys; `fire` = `focus()` **then** `click()` |
| **`?` sheet + bound buttons** (`HotkeySheet.svelte`, F62) | Interaction (browser) | Manual per `docs/design/hotkeys-handoff.md` §QA | `e`/`f` carry `aria-keyshortcuts` and the ` (f)` title suffix; `f` opens `WritebackFormDialog` from body, **not** with the `<video>` focused; `?` opens the sheet (empty group on browse, two rows on media detail), `?`/Esc/backdrop close it, focus returns to the opener; `?` while another dialog is open does nothing; **9 keys → two columns, no scroll, long label ellipsized**; clicking a Page row closes the sheet and fires the button; **all 3 skins**: `<kbd>` on `--surface-2`/`--rule`/`--ink`, panel on `--surface`, radius follows the skin, no accent |
...
| Delete / Trash (F24) | Component/Interaction + visual | Vitest + Playwright | **owner-only** Manage block + header Trash link (absent from DOM for non-owner); `ConfirmDialog` a11y — `role=dialog`/`aria-modal`, **focus starts on Cancel**, trap, Esc/backdrop cancel, focus-return; soft-confirm copy reflects the grace days; **purge confirm names the file path**; Trash rows show "deleted X ago · purges in Y", Restore=accent (no confirm) vs Delete-permanently=warn (confirmed); empty/loading/error states themed; **all 3 skins** — `--warn` destructive vs `--accent` restore stays distinct (load-bearing on Brutalist), solid-warn CTA uses readable `--warn-ink`. **Manage split button** (HOLODEX-362, [design handoff](design/manage-split-button-handoff.md)): at rest the block renders exactly one control and `Delete permanently` is **absent from the DOM** — the assertion that the purge is no longer one overshoot from the soft-delete; the chevron carries `aria-haspopup=menu`/`aria-expanded` and opening it moves focus to the first `role=menuitem`; Escape closes **and returns focus to the chevron**, an outside click closes and **leaves focus alone** (`use:dismissable`); choosing the menu item closes the menu and opens the **unchanged** purge `ConfirmDialog`, the default segment the soft one. Per §12.2 this is deliberately **not** a geometry assertion — the change is colour weight, focus and DOM presence, all three of which that harness explicitly excludes — so it is verified by the §5 computed-token method: outline segment resolves to `--warn` and the menu item to `bg-warn`/`text-warn-ink` in all three skins (cinematheque `#e2603f`/`#170e08`, broadcast `#ff6f61`/`#0a0610`, brutalist `#ff5e3a`/`#0a0a0a`; AA 5.42–7.36:1), with `--radius` following the skin (2px / 0 / 0) |
| **Media detail stage layout** (HOLODEX-363, [design handoff](design/media-detail-stage-layout-handoff.md)) | Component/Interaction + geometry | Vitest + geometry harness (§12) + live measurement | **Block order** — `#field-overview` is the rail's first child, above Tags, both roles, every width; File renders once, inside `max-w-stage`, as the first block of the owner-only audit wrapper and directly above the first `Enrichment data:` disclosure; the two `RelatedShelf` bands are siblings of the capped wrappers (never descendants of `max-w-stage`), so below `lg` the one-column stack reads `… studio → overview → tags → films/people → metadata → shelves → file+enrichment` and Tags reach focus before the shelves (tab index measured 12 vs 17 at 412px). **Visitor gate** — the Metadata section renders when `metadataFieldCount > 0`; `visibleResolved` drops valueless fields for a visitor only (the owner keeps them so pins stay changeable); the fold is owner-only (`metadataListOpen = isOwner ? metadataExpanded : true`, chevron absent for visitors); zero `button`/`input`/`select` inside `#metadata-fields` as visitor; rows carry `ProvenanceBadge`. **The file-only `fields` fallback fires only when `resolved` is empty** — the first visitor render dropped into it because every resolved field was either elsewhere or valueless, and re-rendered Overview/Actors/Studio from raw file tags as a second copy; guarded on `!resolved.length`. **Overview gate is exhaustive with its branches** (`(isReplaceField && isOwner) || value`) and `hasPageAnchor('overview')` mirrors it exactly, so an owner whose `overview` is mapped `multi` and empty never sees an orphan heading and never loses the deep-link anchor. **Shelf rule** (`.stage-band`, same declaration as `.video-grid.stage-aligned`) measured live at 5120: 5 cards → box 2600 = stage, first card at the stage's left edge, overhang 0/0; 16 cards (cloned in-page) → box 3824, overhang **612/612**, no scroll; 30 cards → box 5057 (window − padding − scrollbar), scroller scrolls, `document.scrollWidth === clientWidth`. At 1920 and 412 the box equals the stage and cards sit flush left. **`width: fit-content` against `overflow-x: auto` behaves identically to the grid case** — the handoff's trap 1, closed. **Tracks** measured: 5120 → 1503/1073, 1920 → 1069/764 (15px scrollbar), 1024 → 547/390, 412 → 364 one column; `field-grid` resolves Metadata 3/2/1-across and File **7**-across at 2600 (not 8 — `gap-2` costs a column: 8×320 + 7×8 = 2616 > 2568). **Three skins** — the new `Overview` label carries the identical class string to every sibling label and measures identical computed colour/size/tracking to `Tags` in cinematheque `#9b9082`, broadcast `#6f7da6`, brutalist `#8a8a8a`; `.stage-band` paints no background or border in any skin. **One real defect found and fixed by the move**: `ExpandableText`'s `<p>` had no `wrap-anywhere`, so the `unbroken` rung's 62-character synopsis overflowed the 390px rail by **34px** at 1024 and `line-clamp`'s `overflow:hidden` cut it off silently — no scroll, nothing poking out. Now `overview-fits-the-rail` in §12, which needed both the `lg` cell and the `visitor-view` preparation to be able to fail at all, and was mutation-tested: fix removed → fails on exactly `text/unbroken` at `lg` in all three skins; fix restored → 72/72 |
| **`ConfirmDialog` bounded + `SourceEditModal` clamped rows** (HOLODEX-417, [design handoff](design/source-edit-modal-overflow-handoff.md)) | Component/Interaction + geometry | Live measurement (§5 computed-token method) | **The bug was a shell defect, not a content one**: `ConfirmDialog`'s overlay is `fixed inset-0` and its panel had no `max-h`/`overflow`, so a paragraph-length body put Save/Cancel below the viewport with nothing to scroll (Tab still reached them — the only reason the modal worked). Now the panel is `flex max-h-[80vh] flex-col`, `#confirm-body` is `min-h-0 flex-1 overflow-y-auto`, footer/error `shrink-0` — the `EnrichPicker` shell, applied to all eleven `ConfirmDialog` callers. **Measured live** on the AMV testbed (`/media/5`, Notes = 473-char file value + a 2000-char Custom decision saved and then reverted) at **520px** viewport height: panel `h` 408 (= 80vh − chrome) with `top` 67 / `bottom` 474, Save `bottom` 457 < 520 in every state — collapsed (`bodyScroll` 305 / `bodyClient` 297), after **Show more** (`bodyScroll` 418, File row 146 → 258px), and scrolled to the end (textarea `bottom` 400 ≤ body `bottom` 409). **Clamp**: `SourceValueClamp` value span measures `-webkit-line-clamp: 4`, height 91px = 4 × 22.75 `leading-relaxed`; the first cut had `block` in the class list alongside `line-clamp-4`, whose `display:-webkit-box` it overrode — toggle showed, nothing clamped (row 258px) — so the class is now `expanded ? 'block' : 'line-clamp-4'`. Toggle absent when the text fits (HOLODEX-361), `aria-expanded` flips `false`→`true`, label `Show more`→`Show less`; a `<button>` inside the row `<label>` does not activate the radio. Textarea `rows` 5 (was 3), 107px, scrolls internally at 2000 chars. **Three skins** (`data-theme` swap, computed): `max-height` 608px (= 0.8 × 760) and `overflow-y: auto` in all three; toggle colour resolves to the skin's `--muted` and matches `ExpandableText`'s chevron exactly (cinematheque `#9b9082`, broadcast `#6f7da6`, brutalist `#8a8a8a`); value span is the row's `--ink`; Save keeps `bg-accent`/`text-accent-ink` (`#e8a33d`/`#1a1206`, `#36e0d0`/`#04121a`, `#d6ff3f`/`#0a0a0a`); `--radius` follows the skin (2px / 0 / 0). **No automated coverage** — consistent with §0's standing frontend-automation gap; a Playwright assertion that `Save.getBoundingClientRect().bottom <= innerHeight` for a 2000-char body is the natural first test when that harness lands |
...
| **Enrich-picker "Searched" caption** from `/resolve` `searched[]` (ADR-095 D6, F54 FR9, HOLODEX-369, [design handoff](design/structured-resolve-hints-searched-caption-handoff.md), [QA checklist](design/structured-resolve-hints-searched-caption-qa-checklist.md) — **supersedes the "optional P1 caption" clause of the row above**. Shipped 2026-09-11: the state table is the pure `searchedCaption.ts` helper under Vitest (13 cases, §2 of the checklist); the DOM/a11y/three-skin/stressed items were measured live via `javascript_tool` against the enrich stub's `stress` cascade; the §12 assertion is HOLODEX-372) | Component/Interaction | Vitest (+ §12 harness for the stressed state, HOLODEX-372) | `EnrichPicker.svelte` gains one block between the `aria-live` status `<p>` and the listbox: no `searched` key or empty array ⇒ **no element** (not an empty `<p>`); one entry ⇒ `Searched` + the entry, **no** toggle; ≥ 2 ⇒ first entry + a `+{n} more` `<button>` with `aria-expanded="false"` and `aria-controls` → an `<ol>`; activating ⇒ `aria-expanded="true"`, label `show less`, `<ol>` lists **every** entry in issue order (first entry repeats — the list is the record, the line is the summary); collapses again on the next response. Hidden while `loading`, on `error`, under 2 chars, and **at once on `oninput`** (before the debounce) — the caption describes the last response, not the current text; the stale-response guard that protects `candidates` also protects `searched`. The status `<p>` must **not** contain the caption text (nothing live-announced). Tab order: search box → `+N more` (only when present — asserted absent from the order with one entry) → active result row → None of these match → ✕, with `trapTab` **unchanged**. Tokens: label/toggle `text-muted`, entry `text-ink` (the query is content; muted at 12 px is the picker's contrast floor), `.btn-quiet` on the toggle, `truncate` + `title={entry}` on every rendered entry — a 600-char entry renders one line high. Stressed: ten entries expanded ⇒ the `<ol>` scrolls within `max-h-24` and the dialog stays ≤ 80 vh with the candidates `<ul>` still laid out (§12 geometry assertion, not a screenshot); no horizontal overflow in all three skins. `api.ts`: `enrichVideoResolve` returns `searched?: string[]`; the person/studio/film callers compile unchanged. Batch path: **no** `JobHistory.svelte` change — the existing detail `<p>` shows `searched: a · b`; assert the rendered text contains no path separator |
| **Enrich-picker `details` reveal** from `candidates[].detail` (F61, HOLODEX-380, [design handoff](design/candidates-detail-handoff.md), [QA checklist](design/candidates-detail-qa-checklist.md) — **shipped 2026-09-13**) | Component/Interaction | Vitest (pure helper) + live `javascript_tool` measurement + §12 harness (one assertion) | **The rule is a pure module** (`web/src/lib/candidateDetail.ts`, 9 cases): `collisionOpen` opens every candidate that carries `detail` **and** shares a normalized label (`trim` + collapse internal whitespace + case-fold — `harbor  lights` collides with `Harbor Lights`) with ≥ 1 other; a distinct label stays closed however much `detail` it carries; a same-label member **without** `detail` is absent from the map (no toggle to be open); a pre-F61 response opens nothing; `hasDetail` treats `[]` and a missing key alike. **The component has no test harness** (the caption row above set the precedent), so the checklist's §2.4–2.7 / 2.9–2.10 items were **measured live** against the enrich stub's `twins` (collision) and `flood` (distinct) personas in all three skins via computed style and `getBoundingClientRect`: 7 of 8 `twins` rows open on first render and the no-`detail` eighth has no toggle; a real click on `hide details` collapses the row and the dialog **stays open** (toggle never confirms); `aria-expanded` flips and the `<ul>` leaves the DOM; ↓ from row 1 moves the roving focus to row 2 with row 1's collapsed state and row 0's open state both preserved; the toggle is collected by `trapTab`'s existing `button` selector (asserted in the stop list, no selector change); `flood`'s 25 rows all start collapsed, its 8-line row and its 256-char row (truncated, `title` = full text) sit inside the listbox's scroll box after scrolling to the last row, dialog overflow 0; line contrast against the **active** row's `bg-surface-2` 4.71 / 5.47 / 5.88 (Broadcast / Brutalist / Cinémathèque), the toggle's `text-decoration-style` is `dotted` and both inherit the skin's `font-ui` (monospace in two skins). **What the live run found**: an inline-block `<button>` placed directly in the `<li>` sat on the baseline with its own descent gap — a collapsed row measured 74.5px where one 16px text line should have made it 66.6px; the actions line became a `flex items-baseline` row (the caption's own idiom) and parity held exactly. That number is now `collapsed-detail-row-costs-one-line` in §12.4 (re-based to 76 once §4.6 added `py-1`). A row without `detail` keeps its **exact** DOM (the `view source ↗` link renders through a snippet in both branches) |
| **Enrich-picker candidate thumbnail** from `candidates[].image_url` (F64, HOLODEX-406, [design handoff](design/candidates-image-handoff.md), [QA checklist](design/candidates-image-qa-checklist.md) — **shipped 2026-09-17**) | Component/Interaction | Vitest (pure helper) + live `javascript_tool` measurement + §12 harness (three assertions) | **The rule is a pure module** (`web/src/lib/candidateImage.ts`, 4 cases): `showThumb` is true only for an http(s) `image_url` whose row has not failed — `isHttpUrl` belt-and-suspenders like `profile_url`, so `javascript:`/`data:`/`""` never reach an `<img src>` even if one slipped the server. **The component has no test harness** (F61 precedent), so the checklist's §3 ran **live against the enrich stub** on the studio page (the AMV testbed lifts no people; the picker is one shared component, so the surface is the same) in all three skins: `twins` walks every slot state — rows 0–3 `<img>` 40 × 60 with `alt=""`, `loading="lazy"`, `referrerpolicy="no-referrer"`, computed `object-fit: contain`; row 4 the 64 × 16 logo in the same 40 × 60 box (letterboxed, plate visible); rows 5 (404 → `onerror`), 6 (foreign host, **absent from the wire**, verified on the fetched JSON) and 7 (no key) on the monogram `H`; the label's `x` is 98.4 on all eight rows; the slot is `aria-hidden`, has no `tabindex`/`role`/handler and adds no stop to `trapTab`'s list; clicking the image applied the candidate and neither `/thumb/` nor `image_url` appears in the entity page afterwards. **F61 interplay**: with a row's `detail` expanded the slot's `top` equals the label's before and after, and the `<ul>` left edge equals the label's (it lives inside the text block). **`flood`**: 25 rows all exactly **76.0** (the slot floor equals the F61 text stack, so pictured and no-detail rows match), last row inside the listbox scroll box, dialog overflow 0; all 25 thumbs requested at render — Chrome's lazy margin covers the list, recorded not asserted. **Three skins** — monogram `text-logo-plate-ink` on `bg-logo-plate` contrast **12.17 / 13.02 / 15.27** (Cinémathèque / Broadcast / Brutalist), plate radius 2 / 0 / 0, `font-display` per skin, and the plate reads the same over the active row's `bg-surface-2`. **375 px**: dialog 343, text block 232, label truncates, match text visible, horizontal overflow 0. **What the live run found**: nothing in the component — but the *harness* run did: the stub's portraits were the slot's own 40 × 60 and masked the `w-10` mutation (§10, §12.4); they are 80 × 120 now |
...
| **Completeness ring badge — `CompletenessRing.svelte`, `ring.ts`, panel headline** (F65/HOLODEX-412, [spec](specs/entity-completeness-score.md) F65.4/F65.5, [design handoff](design/completeness-ring-badge-handoff.md)) | Unit + interaction (browser) | Vitest (`ring.test.ts`) + agent-driven browser QA per the handoff §QA | `ringReading` pins the handoff's state table: `required` fills the accent arc, the ink overfill exists only once `required === 100` (`75/100` → no ink; `100/67` → 67 % ink lap; `100/0` and `100/null` → none), a `null` required band hands the ring to `extras`, both-null is `empty` and mounts nothing, and the `aria-label` drops a `null` clause (`Completeness: extras 100%`); `arc` maps 0–100 onto the 44-unit dasharray and keeps a 1–4 % tick visible. The component is owner-only **by payload**: `VideoCard` mounts it iff `video.completeness` exists, in a bottom-left flex row ahead of the HOLODEX-389 part badge, on a `bg-black/70` chip that must be `inline-flex` (an inline span inherits the line box and runs 30 px, not 20). Agent QA 2.1–2.5 (stroke colours resolve to each skin's `--muted`/`--accent`/`--ink`; chip 22 × 20 level with the duration pill, `left = frame.left + 6`; ink circle iff `required === 100 && extras > 0`; no bottom-edge overlap at 8 columns; visitor pages have zero `.completeness-ring` and the payload no `completeness`) ran green on all three skins on 2026-09-18 via `javascript_tool` — note the pane must be visible or every rect reads 0 × 0. Panel headline: `score` with `extras N%` beside it, extras standing in as the number when `score` is `null`. Human items 3.1–3.4 and 1.2 (needs a multi-part fixture video) are the owner's. No Playwright — §11's standing gap |
| **Provider-link badge** — `ProviderLinkBadge.svelte`, `EntityVideoMeta.svelte`, person page hero (HOLODEX-266, ADR-083) | Unit (shipped) + Component/Interaction + visual (target) | Vitest + Playwright | `sortExternalLinks`/`isHttpUrl` (`format.ts`) are unit-tested today (`format.test.ts`): alphabetical-by-label ordering independent of input/backend row order, non-mutating, a degraded (no-`url`) badge sorts the same as a resolved one; `isHttpUrl` accepts `http(s)://` case-insensitively and rejects `javascript:`/`data:`/`mailto:`/non-URL strings — the same scheme gate `ProviderLinkBadge.svelte` applies before ever setting `href` (defense in depth: the backend only ever emits a validated http(s) template, but Svelte doesn't sanitize `href`). The component layer itself — `ProviderLinkBadge`'s linked-`<a>` vs. non-interactive-`<span>` branch, its brand-icon/monogram fallback, and `EntityVideoMeta`'s `·`-separated badge row on the person/studio detail pages, plus the film page's year-line mount through `NameEditControl`'s `trailing` slot (HOLODEX-393, handoff DD4) — has **no** Vitest/Playwright coverage yet, consistent with §0/§11's standing frontend-automation gap; manually driven-browser QA target: multi-badge row renders one pill per external id in label-sorted order, a degraded badge is non-interactive (no `href`, `aria-label` reads "Known to {label}" not "View … on"), all 3 skins (`rounded-full` pill legible against `--surface`/`--accent` hover); on film, the `·` and pills are absent with no ids, the owner pencil follows the pills and keeps its "Change the year" name, and the pills vanish while the year is in edit mode; on media (HOLODEX-394, handoff DD5), the single pill follows the year on the header meta row (`FHD 1920×1040 · 1:30:40 · 2016 · [IMDb]`), the row is unchanged when `external_links` is null, and a 375px viewport wraps per segment with no horizontal overflow |
| **Provider-link badge `_source_url` fallback** (HOLODEX-392, ADR-098, F63 P0-4, `internal/enrich/source_url_test.go`, `internal/api/external_links_test.go`) | Unit + Integration | Ingest (D2) is pinned over a real SQLite repo with the in-process `Fake` registered under the source name `tmdb` — provider name = namespace, the very equality D3 keys on. `TestEnrichSourceURL_StoresFirstValidValue`: a `javascript:` value is skipped, the first http(s) value is kept, extras dropped — the row is single-valued and `Service.SourceURLs` reads it back keyed by provider. `TestEnrichSourceURL_OmittedKeepsMalformedClears`: the HOLODEX-258 raw/ok rule — an enrich that omits the key leaves the prior URL (additive store), one that sends only garbage overwrites the row to empty (so `UpsertEnrichment`'s per-key upsert actually clears it), neither fails the enrich, and `Clear` removes the row with the provider's others. `TestProviderLink_Precedence` table-drives D3 on `Service.ProviderLink`: a namespace with both a template (advertised through `Fake.LinkTemplates`, persisted by `verifiedClient` on the warming `Enrich`) and a stored page takes the **template**; one with only a stored page links to it; a foreign namespace with neither is degraded even though the enriching provider stored a page (RD3); no id / nil map → degraded. The HTTP projection is covered end to end in `external_links_test.go`'s fake-provider env (now with an `/enrich` route that returns `_source_url`): `TestExternalLinks_SourceURLFallback` — a person carrying a foreign `other:1` id and a `fake:1` id attached by the real `Enrich` renders the `fake` pill with the stored URL and the `other` pill degraded; `TestExternalLinks_TemplateBeatsSourceURL` — with a `fake` template declared, the template URL renders and the stored page is inert. The enrich stub's persona table (`alpha` templates, `bravo` `_source_url`, never both — asserted by `stub.test.mjs`) makes both branches reachable in a local QA run | ~90% |
| **TMDB sidecar `link_templates` + `homepage` unwind** (HOLODEX-391, F63 P0-2/P0-3, `providers/tmdb/tmdb_test.go`) | Unit | `TestDescribeLinkTemplates` pins the `/describe` manifest shape as a **map equality**, not a presence check: exactly the `tmdb` (person/studio/film/video) and `imdb` (person/film/video) namespaces, each kind's template string verbatim — so a template drifting to a non-`{id}` shape, a kind going missing, or a namespace appearing that core has no label for fails here before `enrich.ValidateLinkTemplate` ever sees it. The `homepage` unwind (P0-3, behaviour change) is asserted in both directions on every entity kind that had the override: `TestTMDBEnrichMovie` / `TestTMDBEnrichStudio` / `TestTMDBEnrich` (person) want the entity's **own** site when TMDB has one, and `TestTMDBEnrichMovieNoPoster` / `TestTMDBEnrichStudioNoWebsite` / `TestBuildEnrichResponseFallsBackToProfilePath` (person) want the key **omitted** — not the TMDB page — when it does not, which is the double-link the epic exists to remove (core's `ProviderLink` now owns that page). Not tested here, by design: what core does with the manifest — that is `external_links_test.go`'s fake-provider env (row above), which persists templates through the real `verifiedClient` side effect | ~95% |
...
| **Writeback dialog as cockpit — `WritebackFormDialog.svelte`** (HOLODEX-400, epic HOLODEX-167, [design handoff](design/writeback-cockpit-handoff.md)) | Unit + live `[agent]` measurement | Vitest + driven browser | The row-class / staged-value / decide-or-not logic is pure in `web/src/lib/writebackCockpit.ts` and pinned by `writebackCockpit.test.ts` (14 cases): `isCockpitRow` (replace ∧ not `image_url`), `stagedValue` (chip value / trimmed Custom literal / nothing for an unknown key), `rowClass` (unwritable ⇒ `⊖` regardless of value; `matches` is whitespace-insensitive against the `·file` candidate; an empty file value matches only an empty staged value; no candidates ⇒ never matches), `isUnverifiable` (writable cockpit row with `in_sync` absent, ADR-093), and `needsDecision` — true for an undecided row whatever is staged, true for an RD6 pending winner, **false for a decided row whose staged pick equals the committed selection**, true when re-pointed at another chip or when a manual literal changes (whitespace-insensitive). The chooser components (`curation/SourceChipRow`, `curation/SourceRadioList`) and the dialog's focus/promotion behaviour have no component-test harness (§0/§11 standing gap) and were verified live on `backend-films` with a TMDB-enriched Dune, owner session, via `read_page` + `javascript_tool` (handoff §9): (9.1) decided manual Title pre-checked with a chip row; undecided Overview unchecked, in the disclosure, **stacked** rows; Tagline decided but `in_sync` absent → checkbox, unchecked, `Can't verify — Subtitle isn't read back from this file.`; Released RD6 → dashed `pending` chip. (9.2) ArrowLeft onto the `·file` chip demoted Title to `=` (footer `Write 0 fields`), ArrowRight back promoted it (checkbox re-rendered checked) — **focus stayed on the chip through both transitions** after two fixes found by this very check: the chooser must stay open once interacted with, and it must have a single mount point across the `=`/will-write branches, otherwise Svelte unmounts the radiogroup and focus lands on `<body>`. (9.3) `change` on the `=` Studio row opened its chooser; Custom + Enter promoted it (checkbox checked, count +1) and focus returned to the manual chip. (9.4–9.6) Write with Title (decided, untouched), Studio (Custom) and Released (pending, checked) issued **exactly two** `PUT …/fields/{studio,release_date}/decision` → 204 — none for Title — then one `POST …/writeback` → 202; the API then reported `studio` = `manual:'Legendary'` standing and `release_date` = `provider:tmdb` standing. (9.8) Tab from the Title checkbox landed on the **checked** chip, not an unchecked one — `focusables()` now excludes `tabIndex === -1` (the trap previously selected every `<button>`). Escape inside the Custom input closed only the input (dialog stayed open, focus back on the chip). (9.10) Computed-style contrast on all three skins, dialog `bg-surface` as the backdrop: checked chip border 8.7 / 11.5 / 16.8:1, checked chip text ≥ 15.7:1, unchecked chip text 5.9 / 4.7 / 5.5:1 (existing `CurationChip` styling), `text-warn` note 5.4 / 7.0 / 6.4:1, stacked checked label 8.8 / 11.6 / 16.9:1 (Cinémathèque / Broadcast / Brutalist) — all ≥ 4.5:1. `/code-review high` then found two holes, both fixed and re-verified live: a blank Custom literal (the stacked textarea stages `custom` on focus) counted as a write and would have sent `manual:''` — now excluded from count/write/decision; and re-pointing a decided row at the `·file` chip dropped the pick entirely (row became `=`, left the submit set, button disabled) — now a decision-only row: with Title decided `manual` and already in sync, `change` → `·file` chip read `Save 1 decision`, submit issued exactly one `PUT …/title/decision` → 204 and **no** writeback POST, and the API reported `title` = `file` standing. Owner feedback the same day — "the writeback should be atomic for all values … deciding should be the check action" — removed the per-row checkbox and Select all from cockpit rows: `willWrite` (6 more Vitest cases) pins that a standing decision that lags the file always writes, an undecided row writes only once touched (the RD6 pending winner untouched → never), a blank Custom is nothing, and a non-cockpit row (`image_url`, merge) is never written — the owner then asked for the last checkboxes to go too ("you only eliminated some of the checkboxes"), so those rows are read-only with a `⊖` glyph and the poster is unwritable from the dialog until HOLODEX-403; the lead group became `leadRow` (standing ∧ lags, by open-time value) so a decided-but-unverifiable row leads rather than writing from inside the collapsed disclosure. Live (Dune again): no Select all, zero `<input type=checkbox>` and zero text inputs in the dialog, Genres/Actors/Poster read "Nothing to decide here yet — not written from this dialog"; Tagline + Released (decided, `in_sync` absent) led with the `↧` glyph, Overview/Language showed `○`; clicking Language's already-highlighted pending chip and re-clicking Overview's already-checked radio flipped both to `↧` (`Write 4 fields`); submit issued exactly two `PUT …/{overview,original_language}/decision` — none for the two already-decided lead rows — then one writeback with 4 fields. Then the **golden-record** reframe (owner, 2026-09-19 — "make it clear which data is available, which can and cannot be written to a file, and what the current decision is"): `savesDecisionOnly` (5 more cases) pins the second destination — an unmapped field decided here saves to Holodex only, a re-point at the file value likewise, an untouched row never, a writing row rides its decision with the write — and `willWrite` now defers to `isBlankCustom`. Live: zero `text-warn` lines; the four ADR-093 rows read `not read back` on the file chip (stacked: `Not read back from this file`) with `↧`; the four unmapped rows (Runtime/Status/Website/External ID) gained a chooser and `no file tag for this container` on the header; picking Runtime's tmdb chip flipped `○` → cylinder and the footer to `Write 4 fields, save 1 decision`; Write issued one `PUT …/runtime/decision` and a writeback carrying only the four mapped fields. Screenshots time out in this environment (§11); §9.11–9.12 `[human]` remain for the owner. | Pure helpers ~100%; dialog/chooser live-verified, no automated component coverage |
| **Poster row as an image-tile chooser + ledger-witnessed image sync** (HOLODEX-403, [ADR-101](architecture/ADR-101-ledger-witnessed-image-sync.md), [design handoff](design/writeback-poster-chooser-handoff.md)) | Unit + Integration (repo) + live `[agent]` | Go test + Vitest + driven browser | **Backend.** `TestResolveFields_ImageSyncFromLedger` pins ADR-101 D1 on a decided `image_url` field: no ledger loaded → `in_sync` nil; a ledger with no row for the field → nil; newest write equals the decided URL → true; another URL → false; an undecided image field stays in sync by construction and never consults the ledger; a *text* field with a ledger entry keeps the file read-back (decided `TMDB Title` vs file `filename_title` → false, ledger ignored). `TestLastWrittenValues` (repo, real SQLite) returns the newest row per `field_key` for one video only, and an empty map — not an error — for a video with no writes. The witness is loaded on the media detail only (`getMedia`), a failed load logs and degrades to unknown. **Frontend.** `writebackCockpit.test.ts` gains: `isCockpitRow` admits `image_url` (`isImageRow` distinguishes it); `needsDecision` treats an image row like any other; `willWrite` writes a picked provider tile, never an untouched one, never the `·file` pick (which `savesDecisionOnly`); and `rowClass` lets the backend's `in_sync: true` stand in for the file value when the staged pick is still the resolved winner — keyed on `in_sync`, not display, so a poster the allowlist degraded to text is still witnessed (a `/code-review` finding) — **and only for a standing decision** (HOLODEX-433): the resolver reports `in_sync: true` for every *undecided* field by construction, and the ungated clause read an undecided provider poster as `matches`, so picking its tile saved a decision and never wrote (same for every undecided provider-winning text row). One more `rowClass` case pins undecided + `in_sync: true` ⇒ `write` for an image row (`standing: false` and no `decision`) and a text row; live on Black Dynamite (MP4, TMDB, undecided): footer `Write 1 field to file`, one decision PUT + writeback 202, job landed in ~40 s with the file's `CoverArt` at the TMDB original's byte size and `in_sync: true` on the now-standing decision. The tiles also stopped cropping (`h-20 w-auto min-w-14 object-contain`, no `object-cover`): live geometry 56×80 for a 2:3 poster (ratio preserved to the border), 280×80 for a 320×90 probe, a 1:4 probe letterboxed inside the 56 px floor, a 404 probe kept a 56×80 box — identical on all three skins; the collapsed `=` row's thumbnail got the same treatment (`h-8 w-auto min-w-6 object-contain`: 24×32 for the 2:3 poster, 110×32 for the 320×90 probe, 24 px floor for the tall and 404 probes, three skins). **Live on `backend-films` (Dune, TMDB, owner session, this worktree's own servers):** the Poster row renders tiles — `·file` showing the served poster, `·tmdb, pending` dashed, no Custom, no checkbox, `→ cover.jpg` on the header, `○` gutter; clicking the tmdb tile → `↧`, `Write 1 field to file`; Write → `PUT …/fields/poster_url/decision` + writeback 202; the job took ~3 min (download + 21 GB attachment replace), after which `file_writebacks` holds the URL and the API reports `in_sync: true`; re-open → `=` (`tmdb poster — matches the file`, thumbnail, tiles behind `change`); `change` → `·file` tile → cylinder + `Save 1 decision`; back to `·tmdb` → `=`. Upload case: `POST …/poster` then re-open → `·file` tile is the `cover art / in file` placeholder and the ADR-049 note is present (upload deleted afterwards). Keyboard: focus on the checked tile, ArrowLeft staged `·file` and moved focus, Escape closed the dialog. Three skins: checked tile border 8.7 / 11.5 / 16.8:1, captions ≥ 4.67:1, placeholder and note ≥ 4.67:1. `/code-review high --fix` found the degraded-display witness gap and a standing manual literal with no tile (group unreachable by Tab) — both fixed. Screenshots time out (§11); §8.9 `[human]` remains. | Resolver/repo paths ~100%; chooser live-verified, no automated component coverage |
| **Entity refresh sweep UI — `SweepStatusLine.svelte`, status-page trigger, `JobHistory` batch chip** (F66, [design handoff](design/entity-refresh-sweep-handoff.md) Option D, [ADR-103](architecture/ADR-103-provider-traffic-contract-and-enrich-sweep.md), HOLODEX-421) | Unit + live `[agent]` | Vitest + driven browser | The line's logic is pure in `web/src/lib/components/activity/sweepLine.ts` and pinned by `sweepLine.test.ts`: `doneLineFor` shows this kind's `last_run` and nothing for the other kind, idle-with-no-run, running, or the dismissed batch (a *different* batch id shows again); `sweepFinished` fires **exactly once** on this kind's running→idle edge and never for the other kind or for a page mounted after the sweep finished (its initial load was already fresh — the P0-6 `reload()`-once rule); `skippedText` groups by reason and truncates to three names + `and N more`. `api.test.ts`: a `rate_limited` refresh-all row lands on the inline error slot as `tmdb is rate-limiting — try again in 42 s` while the other provider's reload still runs, and `runEnrichRefresh` surfaces the `503` body line (which is why `sendAuthed` now passes the body `error` into `ApiError`). The components have no rendering harness (§0/§11 standing gap) and were verified live on the worktree backend (`:7810`, a real TMDB sweep of 21 people in 42.8 s) via `read_page` + `javascript_tool` on all three skins: the two buttons render after Sign out and hide at count 0; the confirm replaces the row with the count, the checkbox rewrites the question and sends `force`, Cancel restores; `Yes, refresh` toasts `Refresh started.` and within one poll the running button reads `Refreshing people 0 / 21…` with the studios button disabled and its `aria-describedby` text in the DOM; the People page shows the running line counting (`3 of 21 · linked 2 · 1 need review`), the Studios page nothing; on the edge the page reloaded (portraits appeared) and the done line read `Refreshed 21 people in 42.8s — Linked 16 · 5 need review · View in System Activity · Dismiss`; a second non-forced sweep read `Linked 0 · 5 need review · 16 recently refreshed`; Dismiss stayed dismissed across polls; `Linked N` opened `/owner/status?batch=…` on the Log with the chip and only that batch's rows, `×` cleared it and reloaded the full log; 375 px: the confirm wraps above its buttons and `scrollWidth == innerWidth` on both list pages. One whitespace defect was caught only live (Svelte trimmed the text after `{#if}` → `linked 2· 1 need review`; separators are now explicit `{' · '}` expressions). Handoff items 8 (`429` fixture) and 11 (human, sidecar stopped mid-sweep) remain open | ~85% |
...
| **`StudioLinkCard.svelte` draws the studio logo** — `logo_url` → `icon_url` → monogram in a fixed-height, aspect-following plate (HOLODEX-397, [design handoff](design/studio-logo-link-card-handoff.md)) — **done** | Component + visual | Vitest + driven browser | Supersedes the row above's "driven purely by `icon_url` presence, not `logo_url`" assertion: the `<img src>` is `logo_url` when set, else `icon_url`, and the **dashed** frame now keys on *neither* being set (an icon-only studio keeps its solid frame). Plate is `h-12 min-w-12 max-w-48` with the image `h-full w-auto max-w-full object-contain`: assert a 5:1 logo yields a plate width in `(48, 192]`, a 12:1 logo clamps to exactly 192, and a portrait logo pads to 48×48 — never a cover-crop (entity `CLAUDE.md` aspect rule). Monogram branch keeps `w-12`. **Call-site regression guard**: both pages' rows are already `flex-wrap`; at 375px two wordmark studios wrap with `scrollWidth === clientWidth` (HOLODEX-356 overflow guard stays green). Accessibility unchanged (one `<a>`, `alt=""`, `aria-hidden` monogram). **All 3 skins**: plate `background-color` equals each skin's `--logo-plate`; token grep stays empty. Full numbered checklist in handoff §11. **HOLODEX-411 revision (2026-09-18)**: the **logo** state draws **no plate** — assert the box's `background-color` is transparent and `border-width` is `0px` in every skin (preflight leaves `border-style: solid`, so assert the width) while the icon and monogram states keep `--logo-plate` + `border-rule`; the 48px box, `[48, 192]` clamp and `p-1` inset are unchanged. **Aspect rule** (same revision): a logo with natural `w ≥ 2h` renders with **no caption** — assert the `<a>` has one child, `img[alt]` is the studio name and `a[title]` is `"{name} · {n} video(s)"`, and that the caption never appears when sampled from navigation (cached image included); a 300×300 logo, the icon state and the monogram keep the caption with `alt=""` and no `title`; `onerror` restores the caption. **Status**: implemented; §11 agent items 11.1–11.10 driven-browser verified 2026-09-17 against synthetic 5:1 / 12:1 / portrait / square / both / icon-only / none studios across all 3 skins; the 411 revision re-verified 2026-09-18 on `/media/{id}` (light 900×220 logo transparent + 0px border in all 3 skins, monogram plate `#e9e0d0` dashed 0.8px, dark-on-transparent logo confirmed faint — the accepted cost; 900×220 wordmark → one child, `alt`/`title` carry the name, 8 × 150ms samples never show a caption; 300×300 symbol → caption present, `alt=""`, no `title`; monogram unchanged); no dedicated Vitest/Playwright coverage, consistent with the standing frontend-automation gap | ~90% |
| **`/studios` list rows draw the studio logo** — the `StudioLinkCard` image box extracted into a shared `StudioLogoBox` + pure `studioLogo.ts` rule, mounted by a new `StudioListRow` (HOLODEX-432, [design handoff](design/studio-list-logo-handoff.md)) — **done** | Unit + component + visual + a11y | Vitest + driven browser | **Unit (new, `studioLogo.test.ts`)**: `isWordmark` is true at exactly 2:1 and wider, false below, for portrait and for 0×0; `showName` is always true when not bare, false for a bare logo while `wordmark` is `null` (loading) or `true`, true when `false` (symbol mark / failed load); `imageAlt` is `''` exactly when `showName` is true and the name otherwise — the "announced once, never twice" invariant is a pure function now, so it cannot drift between the card and the row. **Component**: the row's `<a>` keeps the pre-432 classes; box geometry per the row above (48px tall, `[48, 192]` width, 192 for a 12:1 logo, transparent + `0px` border for a logo, `--logo-plate` + `border-rule` for icon/monogram, dashed only when no image); the name `<span>` is **present but empty** on a wordmark row (it is the `flex-1` spacer — assert the ring and count stay right-aligned); `a[title]` = name only when the name is hidden; `img[loading]` is `eager` for `i < 6` and `lazy` after. **A11y tree**: each row link exposes the studio name exactly once — from `alt` on wordmark rows, from the text node on captioned rows — and the old `alt="{name} icon"` double announcement is gone. **Card regression guard**: `StudioLinkCard` on `/media/{id}` and `/films/{id}` renders identically to before the extraction (same box width, caption rule, alt/title). **Responsive**: at 375px every row is narrower than the viewport (the owner toolbar's pre-existing overflow is a separate bug). **All 3 skins**: logo box transparent everywhere; plate `#e9e0d0` / `#e4ebf8` / `#f0f0f0`, radius 2/0/0. **Halo (same-day owner revision)**: the `<img>` carries `.logo-halo` in both roles and its computed `filter` is the three-layer (1/3/6px) `drop-shadow` in that skin's `--logo-plate` — assert per skin, and that the monogram `<span>` has none (handoff 11.11b). **No plate under an image (HOLODEX-437, same PR, [handoff](design/image-plate-handoff.md))**: in `StudioLogoBox`, `EntityImageSlot` (both variants, `contain`) and `CompletenessQueueRow`, the wrapper's `background-color` is transparent and `border-width` `0px` whenever an `<img>` is present, the contained `<img>` has the halo and a transparent inset (`padding: 4px`; the queue row 2px), a `cover` image has neither, and the monogram / empty wrapper keeps `--logo-plate` (+ dashed rule where it had one) — handoff §7.3–7.8; 7.3, 7.4 and 7.6 driven-browser verified 2026-09-20 on the testbed (7.5 film hero and 7.7 link card share the same class expressions; no film on the worktree DB). **Status**: implemented 2026-09-20; unit test green (6 cases, suite 385/385); handoff §11 agent items 11.3–11.11 driven-browser verified the same day against a 1000×83 (12:1), 1000×378 (2.65:1) and 1000×974 (symbol) logo, an icon-only and two logo-less studios, in all 3 skins, including the accessibility-tree check; 11.12–11.13 and the human items open | ~90% |
| **Studio image halo toggle** — per-studio, per-role, per-palette owner choice, off by default (HOLODEX-463, [ADR-109](architecture/ADR-109-per-studio-image-halo.md), [design handoff](design/studio-image-halo-handoff.md)) — **done** | Unit + integration + driven browser | Go `httptest` + Vitest + driven browser | **Go (`internal/api/studio_image_halo_test.go`)**: `image_halo` absent by default; dark/light toggle independently per role; `on` twice is idempotent; turning dark off leaves light on; a logo **replace** keeps the choice (it is keyed on studio + role, not the `studio_images` row); the list read carries it; 401 without a token, 400 on a bad role / bad or missing mode, 404 on an unknown studio. **Unit (`halo.test.ts`)**: `paletteMode` puts all three shipped `--bg`s in dark, `#ffffff`/`#f3ece1` in light, splits either side of luminance 0.179 (`#737373` dark, `#777777` light), and falls back to dark on missing/short/named values; `haloClass` is empty by default and emits one `halo-<mode>` per mode. **Unit (`theme.test.ts`)**: `<html data-mode>` is `dark` for a shipped skin, `light` for a custom palette with a bright `--bg`, and back to `dark` when the custom palette is configured but not active. **Driven browser**: handoff §4 items 1–6: default filter `none` everywhere; the switch toggles `aria-checked` and the class and persists; per-skin plate colour; the /studios row follows the logo's choice; a `data-mode="light"` flip shows `halo-dark`-only as `none` and `halo-light` as black; the visitor view has no switch but keeps the halo. **Status**: implemented 2026-09-26; Go + Vitest green; §4 items 1–7 verified; 8–9 (human, live library / light custom palette) open | ~90% |
...
- **Scene number edit in place (HOLODEX-326)**: closes the gap left by F56's attach/detach-only model — an already-attached video's scene number can now be corrected without a detach+reattach round trip. `PATCH /films/{filmId}/videos/{videoId}` (`internal/api/film_videos.go`'s `updateFilmVideoScene`) + `internal/repo/films.go`'s `UpdateFilmVideoScene` reuse `filmSceneOccupant` (the same collision lookup `insertFilmVideo` already shares between attach and bulk-attach), so the 409-naming-the-occupant / no-auto-bump invariant holds identically for edit — except re-setting a video's own current number is explicitly a no-op success, not a collision (the occupant-is-self case). Mounted in the same `requireOwner` group as the existing attach/detach/bulk-attach routes — no new gate to test. `TestUpdateFilmVideoScene` (`internal/api/films_test.go`) covers the happy-path renumber, the self-number no-op, the 409-with-occupant collision, clearing to unnumbered, 404 on an unattached pair, and 401/403 unauthenticated. Frontend: a shared `EditSceneNumberDialog` (`web/src/lib/components/film/`) mounted from both the film detail page's scenes grid and the media detail page's Films chip row, opened by turning the existing read-only scene-number badge into a real `<button>` (a sibling of the video card's `<a>`, never nested inside it, avoiding a nested-interactive-element violation) via `web/src/lib/components/video/VideoCard.svelte`'s new optional `onEditScene` prop. Scene-number parsing/validation is shared with `FilmAttachDialog`'s identical rule via the new `web/src/lib/components/film/sceneNumber.ts` (`/simplify` caught the two dialogs re-implementing the same positive-whole-number-or-blank check independently and had this extracted). `/simplify` also caught and fixed: films/[id]'s save handler doing a full `reloadDetail()` refetch where a local array patch (already used by the media page's equivalent handler) is both cheaper and sufficient, since the scenes list's sort order is itself `$derived` from the patched array. `/security-review` found no new vulnerabilities — `film_id`/`video_id` are bound exclusively from validated URL params (never the request body), all queries parameterized, and the 409 payload shape is identical to the pre-existing attach conflict response. **Live-verified** against `backend-films` (a real film with two attached "Dune" scenes): renumbering via both dialogs, the self-number no-op, the 409 collision naming the correct occupant, and the badge/button rendering correctly across all 3 skins (Cinémathèque, Broadcast, Brutalist).
...
**Structured resolve hints — manifest gate, residue rule, derived query_source, searched[] (ADR-095, HOLODEX-367) — adversarial**
```
Given a provider whose /describe manifest has NO resolve_hints key (every provider shipped before
     ADR-095, including providers/tmdb/ today)
When Holodex builds the POST /resolve request for a video with every field resolved
Then the request body is BYTE-IDENTICAL to the ADR-080 golden — no fields, no filename, no
     query_source. §2.3 promises nothing about unknown request keys; sending them to a provider
     that didn't ask is the wire-contract break the opt-in exists to prevent

Given a provider advertising resolve_hints ["filename"] and fields ["title","studio"], and a video
     whose resolved actors are non-empty
When the request is built
Then hint.filename is present, hint.fields is ABSENT (not asked for), and if the provider had
     instead listed ["fields"], hint.fields carries title and studio only — actors was never
     advertised, so it is never sent. The intersection is asserted with a field the video HAS and
     the provider LACKS, which is the only case that distinguishes "∩ advertised" from "all resolved"

Given a provider advertising resolve_hints ["fields"] and EVERY §4.2a key in fields (title,
     overview, tagline, homepage, external_provider_id, poster_url, actors, …), and a video with
     a resolved overview (the file's Comment tag) and a poster_url from another provider
When the request is built
Then hint.fields carries title/studio/actors/director/release_date at most — overview, homepage,
     external_provider_id and poster_url are NEVER present. "∩ advertised" is not the bound; the
     five-field search vocabulary is. A test that sees overview here has found the owner's own
     free text leaving the box (security review, 2026-09-11)

Given the same provider and the operator's per-source deny for filename set in
     metadata-sources.yaml
When the request is built
Then hint.filename is ABSENT — not "", not null — and hint.fields is unaffected. And with the deny
     UNSET the key is PRESENT: the default-allow case is its own assertion, because an inverted
     default passes every "present when set" test

Given a video at /media/a/b/[Acme Pictures] Ada Lovelace (2023-08-01) 1080p.mp4
When hint.filename is built
Then it is exactly "[Acme Pictures] Ada Lovelace (2023-08-01) 1080p.mp4" — brackets, parens,
     extension intact, no directory component, and NOT the sanitized "Acme Pictures Ada Lovelace
     2023-08-01" the ADR-080 D4 sanitizer would produce. The stripped grammar is what a filename
     matcher consumes; a "cleaned" value here fails the probe that motivated the ADR (3/3 → 0/3)

Given the owner's picker submits a query equal to the server's own BuildQuery render
When enrichVideoResolve derives query_source
Then it is "pattern"; and the same query with ONE character changed is "user"; and the
     sanitized-title floor (no pattern configured) is "pattern"; and a query_source the client
     puts in the request body is IGNORED — a test that sets it client-side and sees it reach the
     provider has found a spoofing hole, not a feature

Given a resolved studio "Acme Pictures", actors ["Ada Lovelace"], release_date "2023-08-01", and
     pattern "{studio} {title} {performers} {year}" (title REQUIRED)
When the sanitized title is "Acme Pictures Ada Lovelace 2023-08-01" (a stem-derived title)
Then {title} renders EMPTY by the residue rule and the pattern STILL renders
     "Acme Pictures Ada Lovelace 2023" — the tier does NOT fall through to the floor. A test that
     sees the floor's "Acme Pictures Ada Lovelace 2023-08-01" here has found the duplication the
     rule exists to remove

Given the same fields and the title "Acme Pictures Ada Lovelace The Engine"
When the pattern renders
Then the render is "Acme Pictures Acme Pictures Ada Lovelace The Engine Ada Lovelace 2023" —
     residue exists ("The Engine"), so the WHOLE title is kept, duplication included. A test
     expecting "Acme Pictures The Engine Ada Lovelace 2023" is asserting a lossy rewrite the ADR
     rejected; decomposition is hint.fields' job

Given the title "acme pictures ada lovelace" (lowercase) and the title "Acme Pictures Ada
     Lovelace Émilie" (a non-ASCII residue word)
When the residue rule runs
Then the first renders empty (case-insensitive tokenization — the probe showed the upstream folds
     case) and the second is kept whole (Unicode alphanumeric residue counts)

Given refresh-all fanned out across two enabled video providers with different search patterns
When enrichQueryHint / refreshOneProvider build the hints
Then each provider receives ITS OWN hint.query render and its own opted-in keys — asserted inside
     the fan-out, per provider. One shared hint across the fan-out is the ADR-080 AI5 scope trim
     this ADR closes; a test that inspects only the first provider's request cannot see the
     regression

Given a /resolve response with 12 searched entries, one of them 5000 chars, one containing "\n"
When Holodex decodes it
Then 10 entries survive, the long one is truncated at 4096, the newline entry is stripped of the
     control character (the candidates[].label treatment) — and a response with no searched key
     decodes to nil, not an empty slice, so the picker renders NOTHING rather than an empty slot

Given the batch path records searched[] into job_runs.detail for a video whose basename a
     provider echoed back in its first entry
When the detail string is written
Then it reads "... · searched: [Acme Pictures] Ada Lovelace (2023-08-01) 1080p.mp4 · ..." and
     contains NO "/" or "\" — a basename is not a path, and the F22.6b no-path invariant on
     detail holds. A directory component anywhere in that string is a failing test
```

**candidates[].detail — caps, audit segment, label collision (F61, HOLODEX-380) — adversarial**
```
Given a /resolve candidate whose detail has 12 entries, one 400 bytes long with a 2-byte rune
     straddling byte 256, one containing "\n" and "\x1b[31m", and a blank one
When Holodex decodes it
Then 8 entries survive, the long one is ≤ 256 bytes AND valid UTF-8 (the straddling rune is
     dropped whole), the escape sequence is stripped to "[31mred[0m", the blank is gone —
     and a sibling candidate with "detail": [] marshals to the client with NO detail key

Given refresh-all resolves a lone 0.91 candidate carrying detail, and the provider's /enrich
     then returns 503
When the activity entries are read back
Then the resolve entry reads "… (1 candidates) · searched: …" with NO "applied:" segment and
     the enrich job's own entry reads "(failed)" — an "applied:" segment here is the audit
     line lying about a binding that never happened

Given four candidates labelled "Harbor Lights", one "harbor  lights", one "Harbor Lights II",
     and one same-label candidate with no detail at all
When the picker seeds its open map
Then the four and the doubled-space one start open, "Harbor Lights II" starts closed, and the
     no-detail member is absent from the map — it has no toggle, so nothing about it is "open"

Given a collapsed candidate row that carries detail, in every skin at every width
When its height is measured
Then it is exactly 76px: label + disambiguation + one 24px actions line + py-2 (and, since F64,
     the 60px thumbnail slot beside them — both stacks land on 60). An inline-block button dropped
     straight into the <li> measures 77 — that regression is the reason the bound exists; the
     toggle losing its py-1 is now the text block's own 60px assertion, not this row's; the slot
     losing its `h-15` (HOLODEX-414) balloons the row and fails here
```

**Candidate slot shape follows the entity kind (HOLODEX-414) — unit + geometry**
```
...
Then it is a type error — the prop is required, there is no silently-portrait default

Given the stressed picker on a video page (enrich-picker-open:flood)
When every row's slot width is measured
Then it is exactly 108 on all 25 rows (candidate-slot-is-108-wide-on-every-row); dropping w-27
     fails it, dropping h-15 fails collapsed-detail-row-costs-one-line instead

Given a TMDB movie hit resolved for a video vs. for a film
When the sidecar builds the candidate
Then video → backdrop_path @ w300 (poster @ w185 when there is no backdrop; key absent when
     neither), film → poster @ w185 — search, by-tmdb-id and by-imdb-id alike; dropping the
     entity guard in movieThumbURL fails all three film paths (TestTMDBResolveImageURL)
```

**candidates[].image_url — host gate, slot geometry, fallback (F64, HOLODEX-406) — adversarial**
```
Given a provider whose base_url is http://acme.example:9100 with asset_hosts [cdn.acme.example],
     and candidates carrying image_url on: the base host over http; cdn.acme.example over https;
     cdn.acme.example over http; img.other.example; acme.example.evil.example; ftp://…;
     javascript:alert(1); ""; a 4200-char https URL on the CDN host
When Holodex decodes the /resolve response
Then only the first two survive; every other candidate reaches the client WITHOUT an image_url
     key (not with ""), with its label, profile_url and detail untouched — and the 4200-char
     one is cleared outright, not cut at 4096 into a URL that 404s

Given the same response, with the sanitizeImageURL step deleted from sanitizeCandidates
When the service round-trip test runs
Then the foreign-host row fails — the gate is load-bearing, not decorative (mutation run 2026-09-17)

Given a pictured candidate whose image_url returns 404, beside one with no image_url at all
When the picker renders and the 404 fires
Then both rows show the label's monogram on the plate in a 40 × 60 slot, no broken-image glyph,
     and their labels start at the same x as every pictured row's

Given the picker's slot loses its `w-10`, against a stub whose portraits are 80 × 120
When the geometry harness measures the slot on every flood row
Then every row fails (the box takes the image's intrinsic width). Against a stub whose portraits
     were exactly 40 × 60 the same mutation PASSED — the fixture was the slot's size and hid
     the regression; that is why the stub's portraits are deliberately not the box's own size
```
...
Given a scene already numbered 6, and the owner opens its edit dialog and re-submits 6
     unchanged (HOLODEX-326)
When PATCH /films/{id}/videos/{videoId} is called with scene_number=6
Then the update SUCCEEDS (204) — a test that only checks "editing to a taken number is
     rejected" without also checking "editing to YOUR OWN number is not taken" would miss a
     regression that makes re-saving an unedited scene number spuriously 409 against itself.
     Editing scene 6 to the OTHER occupant's number (i.e. an actual different, already-held
     number) still 409s naming that occupant, identically to attach
```
...
- **Structured resolve hints (ADR-095, HOLODEX-367 — stories 368 request side / 369 caption)**: ADR + contract §2.2/§2.3/§4.9/§4.10/§5 + F54 FR6–FR9 + the caption's design handoff/SVG/QA checklist landed 2026-09-11 in PR #327 (Draft, ADR-069); the plan above (§4 row, §5 row, §9 adversarial block, Critical invariants) is written ahead of implementation — none of it is automated yet. Tracked against `docs/plans/HOLODEX-367.md`'s gate checklist. Three things worth naming now: (1) the **ADR-080 request-body golden is the load-bearing test** for D1 — it must keep passing unchanged for a provider without `resolve_hints`, and a second golden covers the opted-in shape; if the first one is edited to make the second pass, the wire contract broke; (2) the **residue rule's two rejected variants both have plausible-looking tests** — "contains ⇒ drop" (lossy) and "rewrite to residue" (lossy) — so the table must include the residue-present case asserting the *duplicated* render, or a later "cleanup" will quietly reintroduce one of them; (3) the **caption's stressed state is a §12 geometry assertion**, not a screenshot: ten entries expanded, `<ol>` scrolls, dialog ≤ 80 vh, candidates `<ul>` still laid out, no horizontal overflow — **landed** as five assertions under the `enrich-picker-open` preparation ([HOLODEX-372](https://whoiskevinrich.atlassian.net/browse/HOLODEX-372), see §12.4); the trap it found on the way in: a ceiling-only bound on the `<ol>` passes the exact squeeze HOLODEX-369 fixed, so the cap is asserted as an equality. The `providers/tmdb/` sidecar needs **no** change and must be asserted as such (it never lists `resolve_hints`; the golden covers it).
- **`candidates[].detail` (F61, HOLODEX-380)**: all four gates landed 2026-09-13 in PR #333 and the §4/§5 rows above describe **shipped** tests. Two honest gaps: (1) the QA checklist's §2.4–2.7 / 2.9–2.10 were written as `[smoke]` component items before this session confirmed the repo has no component-test harness — they ran as live `[agent]` measurements (recorded in the §5 row) and the pure rule is unit-tested; a future harness would take the checklist's wording verbatim. (2) The **full** `npm run geometry` matrix crashed the Vite dev server twice on 2026-09-13 (native exit `0xC0000409`, no output; 745 `ERR_CONNECTION_REFUSED` loads after the crash) — each assertion passes when run with `--only`, including all six picker assertions, so this is an environment defect in the run, not a layout one; filed as its own ticket rather than absorbed here. The provider sidecar (`providers/tmdb/`) emits no `detail` and needs no change.
- **Provider link badge coverage (F63, HOLODEX-390 — stories 391 sidecar / 392 `_source_url` / 393 film / 394 media)**: testing gate closed 2026-09-17 on PR #344; every row above describes **shipped** tests. Spec P0 → coverage map: P0-1 (contract docs) has no test by nature; P0-2/P0-3 → the sidecar row (`TestDescribeLinkTemplates`, the six `homepage`/`website` assertions — own-site and omitted, for film, studio and person); P0-4/P0-5 → the `_source_url` fallback row (`source_url_test.go` ingest ×2 + `TestProviderLink_Precedence`, `TestExternalLinks_SourceURLFallback` / `_TemplateBeatsSourceURL` end to end); P0-6 → `TestExternalLinks_Film`; P0-7 → `TestExternalLinks_Video` (all four ADR-098 D4 branches + no value); P0-7b (HOLODEX-424) → the same test's six match-input cases incl. the re-match/newest-row rule; P0-8 (three-skin QA) is manual, recorded in the §5 badge row with the measured contrast per skin. ADR-098 invariants: D1/D2 ingest rule (first valid value, garbage clears, absence leaves alone) and D3 precedence + RD3 confinement are Critical invariants above; D4 is proven off the resolver, not `entity_external_ids`, by wiring a mapping store into the external-links env — the first test in the file that makes `getMedia` resolve a field. Honest gaps, unchanged in kind from HOLODEX-266: the component layer (`ProviderLinkBadge`, the film `trailing` mount, the media meta-row mount) has no Vitest/Playwright coverage (standing §0/§11 frontend-automation gap), and the enrich stub's persona split (`alpha` templates / `bravo` `_source_url`) is asserted by `stub.test.mjs` but only *exercised* by a human running the stub. Nothing here blocks the security gate, which is the last one open on the epic.
- **`candidates[].image_url` (F64, HOLODEX-406)**: five gates landed 2026-09-17 on Draft PR #346; the §4/§5 rows above describe **shipped** tests. Honest gaps: (1) the **monogram-row slot is not in the harness** — `flood` pictures every row, and the empty / 404 / foreign-host slots live on `twins`, which the picker preparation could open but whose eight open-by-default `detail` rows would need their own assertion set; the twins rows were measured live (all 40 × 60, label x 98.4 on every row) and that measurement is the record. (2) The harness has **no cross-element metric**, so "every label at the same x" is asserted by construction (every slot 40 wide) rather than directly; a `left` metric plus a two-selector comparison would make it literal. (3) Lazy loading is an attribute, not a behaviour we can assert: Chrome requested all 25 `flood` thumbs at render because its lazy margin covers the whole 1900px list on a tall viewport — recorded, not bounded. (4) The stub's first portraits were exactly the slot's 40 × 60 and **masked the `w-10` mutation**; they are 80 × 120 now, and the fixture's `README` says why — a fixture the size of the thing it tests is a fixture that cannot see it shrink.
...
| `no-horizontal-page-overflow` | **passes** — 270 checks. HOLODEX-355 and HOLODEX-356 were the two halves; both fixed and the `blockedBy` marker retired. |
| `overview-fits-the-rail` | **passes** — 72 checks (HOLODEX-363). Runs under the `visitor-view` preparation on the `text` rungs minus `empty`. Mutation-tested: without `wrap-anywhere` on `ExpandableText` it fails on `text/unbroken` at `lg` in every skin and nowhere else. |
| `field-overview-renders-once` | **passes** — 288 checks (HOLODEX-363). `count <= 1` on every video page; zero is a valid state. |
| `searched-list-scrolls-inside-its-cap` · `searched-list-holds-its-cap` · `enrich-dialog-content-fits-its-cap` · `candidates-list-survives-the-caption` · `enrich-picker-does-not-widen-the-page` | **pass** — 9 checks each (HOLODEX-372, closing the HOLODEX-369 gap). All five run under the `enrich-picker-open:flood` preparation on the one `enrich` rung with `namespaces === 0` (an un-enriched video is the property that keeps the provider's chip a picker rather than a Refresh). `holds-its-cap` is `height >= 96 and <= 96`, not a ceiling: **mutation-tested** — dropping `shrink-0` from the `<ol>` (the HOLODEX-369 fix) lands it at 46–68px on every cell, which a `<= 96` bound waves through; dropping `max-h-24` as well does the same. The other four are the handoff's stressed-state row verbatim. |
| `collapsed-detail-row-costs-one-line` | **pass** — 9 checks (F61, HOLODEX-380). Rides `enrich-picker-open:flood` unchanged: `flood`'s labels are distinct, so every row carries a `details` toggle and starts collapsed. `height >= 76 and <= 76` on `#enrich-opt-2` (**re-based 2026-09-17, F64**: the 60px thumbnail slot makes 76 a floor too, so the bound is an equality; **since HOLODEX-414** the slot is an explicit `h-15`, so this row also catches the slot losing its height — mutation-tested, see the slot-width row) — the ceiling is label (20) + disambiguation (16) + the toggle's line (16 + `py-1` = 24) + `py-2` (16); the `py-1` regression is no longer visible from the row (a 52px text stack still sits beside a 60px slot) and moved to `collapsed-detail-text-block-costs-one-line`. **Mutation-tested both ways**: dropping `py-1` lands the row at 68 in all nine cells; replacing the `flex items-baseline` actions line with a bare `<div>` (the first cut's inline-block-on-the-baseline defect) lands it at 77. Skin-safe because Tailwind's line-heights and paddings are fixed px and the live run measured 76.0 in all three skins. (First landed as [60, 68] before the §4.6 ruling added `py-1`; the bound moved with it, as the invariant said it would.) The open-row invariants (lines in flow inside the scroller, no clipping at 25 × 8 lines) were measured live and are **not** asserted — they would need a preparation that opens toggles, and the in-flow `<ul>` inside the `<li>` has nothing to float (§12.2: not worth a harness change). |
| `collapsed-detail-text-block-costs-one-line` | **pass** — 9 checks (F64, HOLODEX-406, guarding F61's rule). Same prepared state; `height >= 60 and <= 60` on `#enrich-opt-2 > div.min-w-0`, the text block the slot sits beside: label (20) + disambiguation (16) + the toggle's line (24). **Mutation-tested**: dropping the toggle's `py-1` lands it at 52 and this fails while the row assertion (76) passes — exactly the blind spot the split exists for; the bare-`<div>` actions line lands it at 61. |
| `candidate-slot-is-108-wide-on-every-row` | **pass** — 9 checks (F64, HOLODEX-406; **re-keyed 2026-09-18, HOLODEX-414**: the stressed picker opens on a video page, whose slot is the `landscape` kind, `w-27` = 108). Same prepared state; `applies: each`, `atLeast: 25`; `width >= 108 and <= 108` on `[role="listbox"] > li > div[aria-hidden="true"]` — every candidate row's thumbnail slot. This is the handoff's x-offset parity asserted by construction: the `<li>` is `flex items-start gap-3`, so text x = slot width + 12 on every row. **Mutation-tested 2026-09-18**: dropping `w-27` from `SLOT_CLASS.landscape` fails all 9 (the box takes the stub's 80-wide portrait); dropping `h-15` instead passes here but fails `collapsed-detail-row-costs-one-line` on all 9 (the `h-full` image takes its intrinsic height at 108 wide and the row balloons) — the pair covers both axes, which is why the slot is an explicit width/height pair and not an aspect class. The person/film (40) and studio (120) widths are outside the matrix (no stressed picker on those pages); verified live against the stub per the HOLODEX-414 QA checklist §3. |
| `person-card-no-page-overflow` · `person-card-inside-gutter` | **pass** — 6 checks each in the `cinematheque` cells (HOLODEX-439, F68 R3/RD10; the other two skins error on the HOLODEX-460 skin-pin break, like every rung). Both run under `person-card-open` on the `people >= 25` media pages: the right-most tile's 288px card needs a clamp at every width (`translateX` −170 / −159.3 / −112 at wide / lg / narrow) and lands at exactly 16px. **Film pages were rejected as hosts** — a film's Cast grid ends 40px+ short of the clamp zone at every cell, so the rungs would have passed with the clamp deleted. **Mutation-tested**: `placeCard` returning `shiftX: 0` fails all 12 (page overflow 96px at `wide`; gutter −154 / −143.3 / −96). `gutterRight` (viewport right edge minus the element's right edge) is a new probe metric for this. |
...
**The matrix is now three widths** — `wide` 1440, `lg` 1024, `narrow` 768 — and the
`PREPARATIONS` registry has a third kind of step: `visitor-view` flips the header switch
off for one load, because the context pins owner view and anything that renders *only*
for a visitor was invisible to every assertion. Both were forced by HOLODEX-363: the
overview moved into the rail, its visitor render clipped a 62-character token by 34px,
and the clip existed only between 1024 and ~1090 — `wide` has a 570px rail and `narrow`
is one column, so an assertion written against the old matrix passed with the fix
removed. The cell is the `lg` breakpoint edge (the narrowest two-column layout), not an
arbitrary number, and HOLODEX-359's phone-width cell goes on top of it. Full run is now
630 page loads across 9 cells, ~2½–3 minutes (729 checks, 27 known-open, 1 skipped as of
HOLODEX-372).

**The `PREPARATIONS` registry has a fourth kind of step** (HOLODEX-372): `enrich-picker-open:<provider>`
opens a dialog rather than a fold — clicks the provider's Enrich chip, types `stress` (the word the
enrich stub's `searchedFor` keys its ten-entry `searched[]` cascade on), and expands `+9 more`.
It is what made the caption's stressed state measurable at all; the stub is the fixture's
provider registry, so the cascade is the same on every machine.

**A fifth kind is a hover** (HOLODEX-439): `person-card-open` dispatches `pointerenter` on the
right-most `li.curation-chip [data-person-chip]` and waits for the *loaded* card (its Videos
link), past the 250 ms hover-intent delay and the `/card` round trip. It dispatches the event
rather than moving the mouse, because a real hover also lifts the tile, and it does not focus
the link, because keyboard focus opening needs `document.hasFocus()`.
...
- **The monogram slot and any cross-row parity are outside the matrix** (F64, HOLODEX-406). `enrich-picker-open:flood` pictures every row, so the slot assertions see only the `<img>` branch; the monogram branch (absent key, 404, stripped foreign host) lives on the `twins` persona and was measured live in three skins (40 × 60 on all eight rows, label x identical). Opening `twins` in the harness is one preparation argument away, but its eight auto-expanded rows would need their own bounds. Separately, the harness bounds one metric on one selector — "row A's label x equals row B's" is asserted by construction (every slot 40 wide), not measured; a `left` metric and a two-selector comparison would close that.
...
- `TestSharedExternalIDSortsAboveEveryOtherVariation` — P0-8. The pair carrying the shared id is
  ...
  `ListReviewPairs`' name tiebreak. *(Since §18 the person half's `provider-alias` row is no
  longer listed, so the −2-versus-−1 slot is pinned on **film**, against `same-title`.)*
- `TestListReviewPairsDetailScopedToSharedID` — added at the security gate. `detail` is one column
  ...
  *(Since §18 that row is not listed at all; the projection is kept and still pinned, so
  removing the ADR-108 filter cannot start leaking the name.)*
...
## 18. Provider-alias collisions leave the Duplicates queue (HOLODEX-453, ADR-108)

**What changed.** `ListReviewPairs` stops returning `provider-alias` rows. The row is still
written, because it is the skip record behind `skipped_aliases` and the row ADR-107 upgrades in
place. `SkippedAliasesForEntity` now returns `conflict_name`, and the Aliases panel names and links
the holder instead of linking the queue.

**The risk the tests are shaped around.** Only one query changed, but three different things read
the same rows, and each can break in its own way:

1. **The queue must hide the row.** Otherwise nothing changed for the owner.
2. **The skip record must survive.** A fix that stopped *writing* the row (the ticket's option 1
   as filed) would pass the hide test and silently empty the Aliases panel.
3. **The strong evidence must still surface.** A provider-alias pair later upgraded to
   `shared-external-id` must come back into the queue, or ADR-107's best signal is hidden by a
   filter aimed at its weakest.

**Integration — Go (`internal/repo`)**

- `TestReviewQueue_ProviderAliasRowsAreNotListed` (risks 1 and 2). The row is seeded exactly as
  `queueProviderAliasPair` writes it. The listing is empty, **and** the row is still stored.
- `TestProviderAliasRowSurfacesOnceUpgraded` (risk 3). The row starts hidden. Two
  `AttachExternalID` calls on the same provider id upgrade it through the real guard, and the
  pair then lists as `shared-external-id`.
- `TestSkippedAliasesForEntity` now asserts `conflict_name` on **both** holder routes: holder has
  the name as an alias (`Jennifer Lawrence`), and holder's canonical name *is* the name
  (`Katniss`). The rewritten query joins the holder row instead of an `EXISTS`, so the canonical
  route is the one a join mistake would drop.
- `TestSharedExternalIDSortsAboveEveryOtherVariation` gained a film half (see §17): with the person
  `provider-alias` row gone, film `same-title` is the only other non-fuzzy variation left to rank
  against.

**Mutation check, 2026-09-25.** Removing the `q.variation <> 'provider-alias'` clause fails
exactly the three queue tests above (`…AreNotListed`, `…SurfacesOnceUpgraded`, `…SortsAbove…`).
Selecting the skipped name (`p.detail`) in place of the holder's `c.name` fails
`TestSkippedAliasesForEntity` on the alias-route holder. The canonical route cannot catch that
mutant, because there the two values are equal by construction, which is why the alias route
asserts the name too.

**SPA — no unit test, by the harness's limits.** `web/` has no component-test harness (see the
HOLODEX-451 note in §16). The panel's new logic is markup only: one href helper, the list, and its
separator. It was verified live instead, on `testdata/aliasseed` plus a three-collision fixture
person:

- API: the queue lists none of the 4 provider-alias rows, and each `skipped_aliases` entry carries
  the holder's current name.
- Layout, by element geometry at 375 px and 1280 px: no horizontal overflow, a long holder name
  wraps inside its own item, and the holder's own page renders no line.
- Skins, by computed style in Cinémathèque, Broadcast and Brutalist: the link and the left border
  take `--accent`, and the text takes `--ink` on `--surface-2`.

Live QA caught two defects no mockup showed. A wrapped list could start a line with the `·`
separator, and on wide screens items ran together because Svelte's `{#each}` trims whitespace.
Both were fixed. **Standing gap:** nothing automated pins the separator and spacing. It is three
characters of markup, and extracting it only to test it was judged not worth a module.

**Security surface — see the gate's sign-off in the HOLODEX-453 worklog.** No new endpoint or
