...
Then it is exactly 76px: label + disambiguation + one 24px actions line + py-2 (and, since F63,
...
**candidates[].image_url — host gate, slot geometry, fallback (F63, HOLODEX-406) — adversarial**
```
