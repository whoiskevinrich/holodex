...
| [007](ADR-007-docker-structure.md) | Docker — **single multi-stage image** + Vite dev | Accepted |
| [008](ADR-008-caching.md) | Caching — **ristretto** in-process, Redis-ready | Accepted |
