...
**Design package:** [spec](../specs/people-relationship-picker.md) · design handoff: not yet
written · testing-strategy §5: not yet written
...
- [ ] design `design-handoff` → `docs/design/people-relationship-picker-handoff.md`
...
1. [ ] [design] Design handoff for `PersonPicker.svelte`, grounded in `StudioPicker.svelte` as the
   structural precedent, adapted for multi-select + required role choice
2. [ ] [backend] `FindPeopleCollision` + attach/detach endpoint
3. [ ] [frontend] `PersonPicker.svelte` + People-grid wiring (empty-state guard, remove control)
4. [ ] [testing] `docs/testing-strategy.md` §5 row
5. [ ] [security] `/security-review` — new mutation surface, required before Draft → ready
