...
- [x] testing `testing-strategy` → `internal/repo/film_people_roles_test.go`, `internal/api/film_people_roles_test.go` (add/edit/remove + inherited-cast-vs-credited-role distinction)
